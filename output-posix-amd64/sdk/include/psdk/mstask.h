/*** Autogenerated by WIDL <undefined version> from mstask.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IEnumWorkItems_QueryInterface(IEnumWorkItems* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IEnumWorkItems_AddRef(IEnumWorkItems* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IEnumWorkItems_Release(IEnumWorkItems* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumWorkItems methods ***/
FORCEINLINE HRESULT IEnumWorkItems_Next(IEnumWorkItems* This,ULONG celt,LPWSTR **rgpwszNames,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgpwszNames,pceltFetched);
}
FORCEINLINE HRESULT IEnumWorkItems_Skip(IEnumWorkItems* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT IEnumWorkItems_Reset(IEnumWorkItems* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IEnumWorkItems_Clone(IEnumWorkItems* This,IEnumWorkItems **ppEnumWorkItems) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IProvideTaskPage_QueryInterface(IProvideTaskPage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IProvideTaskPage_AddRef(IProvideTaskPage* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IProvideTaskPage_Release(IProvideTaskPage* This) {
    return This->lpVtbl->Release(This);
}
/*** IProvideTaskPage methods ***/
FORCEINLINE HRESULT IProvideTaskPage_GetPage(IProvideTaskPage* This,TASKPAGE tpType,BOOL fPersistChanges,HPROPSHEETPAGE *phPage) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITaskTrigger_QueryInterface(ITaskTrigger* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITaskTrigger_AddRef(ITaskTrigger* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITaskTrigger_Release(ITaskTrigger* This) {
    return This->lpVtbl->Release(This);
}
/*** ITaskTrigger methods ***/
FORCEINLINE HRESULT ITaskTrigger_SetTrigger(ITaskTrigger* This,const PTASK_TRIGGER pTrigger) {
    return This->lpVtbl->SetTrigger(This,pTrigger);
}
FORCEINLINE HRESULT ITaskTrigger_GetTrigger(ITaskTrigger* This,PTASK_TRIGGER pTrigger) {
    return This->lpVtbl->GetTrigger(This,pTrigger);
}
FORCEINLINE HRESULT ITaskTrigger_GetTriggerString(ITaskTrigger* This,LPWSTR *ppwszTrigger) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IScheduledWorkItem_QueryInterface(IScheduledWorkItem* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IScheduledWorkItem_AddRef(IScheduledWorkItem* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IScheduledWorkItem_Release(IScheduledWorkItem* This) {
    return This->lpVtbl->Release(This);
}
/*** IScheduledWorkItem methods ***/
FORCEINLINE HRESULT IScheduledWorkItem_CreateTrigger(IScheduledWorkItem* This,WORD *piNewTrigger,ITaskTrigger **ppTrigger) {
    return This->lpVtbl->CreateTrigger(This,piNewTrigger,ppTrigger);
}
FORCEINLINE HRESULT IScheduledWorkItem_DeleteTrigger(IScheduledWorkItem* This,WORD iTrigger) {
    return This->lpVtbl->DeleteTrigger(This,iTrigger);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetTriggerCount(IScheduledWorkItem* This,WORD *plCount) {
    return This->lpVtbl->GetTriggerCount(This,plCount);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetTrigger(IScheduledWorkItem* This,WORD iTrigger,ITaskTrigger **ppTrigger) {
    return This->lpVtbl->GetTrigger(This,iTrigger,ppTrigger);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetTriggerString(IScheduledWorkItem* This,WORD iTrigger,LPWSTR *ppwszTrigger) {
    return This->lpVtbl->GetTriggerString(This,iTrigger,ppwszTrigger);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetRunTimes(IScheduledWorkItem* This,const LPSYSTEMTIME pstBegin,const LPSYSTEMTIME pstEnd,WORD *pCount,LPSYSTEMTIME *rgstTaskTimes) {
    return This->lpVtbl->GetRunTimes(This,pstBegin,pstEnd,pCount,rgstTaskTimes);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetNextRunTime(IScheduledWorkItem* This,SYSTEMTIME *pstNextRun) {
    return This->lpVtbl->GetNextRunTime(This,pstNextRun);
}
FORCEINLINE HRESULT IScheduledWorkItem_SetIdleWait(IScheduledWorkItem* This,WORD wIdleMinutes,WORD wDeadlineMinutes) {
    return This->lpVtbl->SetIdleWait(This,wIdleMinutes,wDeadlineMinutes);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetIdleWait(IScheduledWorkItem* This,WORD *pwIdleMinutes,WORD *pwDeadlineMinutes) {
    return This->lpVtbl->GetIdleWait(This,pwIdleMinutes,pwDeadlineMinutes);
}
FORCEINLINE HRESULT IScheduledWorkItem_Run(IScheduledWorkItem* This) {
    return This->lpVtbl->Run(This);
}
FORCEINLINE HRESULT IScheduledWorkItem_Terminate(IScheduledWorkItem* This) {
    return This->lpVtbl->Terminate(This);
}
FORCEINLINE HRESULT IScheduledWorkItem_EditWorkItem(IScheduledWorkItem* This,HWND hParent,DWORD dwReserved) {
    return This->lpVtbl->EditWorkItem(This,hParent,dwReserved);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetMostRecentRunTime(IScheduledWorkItem* This,SYSTEMTIME *pstLastRun) {
    return This->lpVtbl->GetMostRecentRunTime(This,pstLastRun);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetStatus(IScheduledWorkItem* This,HRESULT *phrStatus) {
    return This->lpVtbl->GetStatus(This,phrStatus);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetExitCode(IScheduledWorkItem* This,DWORD *pdwExitCode) {
    return This->lpVtbl->GetExitCode(This,pdwExitCode);
}
FORCEINLINE HRESULT IScheduledWorkItem_SetComment(IScheduledWorkItem* This,LPCWSTR pwszComment) {
    return This->lpVtbl->SetComment(This,pwszComment);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetComment(IScheduledWorkItem* This,LPWSTR *ppwszComment) {
    return This->lpVtbl->GetComment(This,ppwszComment);
}
FORCEINLINE HRESULT IScheduledWorkItem_SetCreator(IScheduledWorkItem* This,LPCWSTR pwszCreator) {
    return This->lpVtbl->SetCreator(This,pwszCreator);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetCreator(IScheduledWorkItem* This,LPWSTR *ppwszCreator) {
    return This->lpVtbl->GetCreator(This,ppwszCreator);
}
FORCEINLINE HRESULT IScheduledWorkItem_SetWorkItemData(IScheduledWorkItem* This,WORD cBytes,BYTE rgbData[]) {
    return This->lpVtbl->SetWorkItemData(This,cBytes,rgbData);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetWorkItemData(IScheduledWorkItem* This,WORD *pcBytes,BYTE **ppBytes) {
    return This->lpVtbl->GetWorkItemData(This,pcBytes,ppBytes);
}
FORCEINLINE HRESULT IScheduledWorkItem_SetErrorRetryCount(IScheduledWorkItem* This,WORD wRetryCount) {
    return This->lpVtbl->SetErrorRetryCount(This,wRetryCount);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetErrorRetryCount(IScheduledWorkItem* This,WORD *pwRetryCount) {
    return This->lpVtbl->GetErrorRetryCount(This,pwRetryCount);
}
FORCEINLINE HRESULT IScheduledWorkItem_SetErrorRetryInterval(IScheduledWorkItem* This,WORD wRetryInterval) {
    return This->lpVtbl->SetErrorRetryInterval(This,wRetryInterval);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetErrorRetryInterval(IScheduledWorkItem* This,WORD *pwRetryInterval) {
    return This->lpVtbl->GetErrorRetryInterval(This,pwRetryInterval);
}
FORCEINLINE HRESULT IScheduledWorkItem_SetFlags(IScheduledWorkItem* This,DWORD dwFlags) {
    return This->lpVtbl->SetFlags(This,dwFlags);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetFlags(IScheduledWorkItem* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
FORCEINLINE HRESULT IScheduledWorkItem_SetAccountInformation(IScheduledWorkItem* This,LPCWSTR pwszAccountName,LPCWSTR pwszPassword) {
    return This->lpVtbl->SetAccountInformation(This,pwszAccountName,pwszPassword);
}
FORCEINLINE HRESULT IScheduledWorkItem_GetAccountInformation(IScheduledWorkItem* This,LPWSTR *ppwszAccountName) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITask_QueryInterface(ITask* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITask_AddRef(ITask* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITask_Release(ITask* This) {
    return This->lpVtbl->Release(This);
}
/*** IScheduledWorkItem methods ***/
FORCEINLINE HRESULT ITask_CreateTrigger(ITask* This,WORD *piNewTrigger,ITaskTrigger **ppTrigger) {
    return This->lpVtbl->CreateTrigger(This,piNewTrigger,ppTrigger);
}
FORCEINLINE HRESULT ITask_DeleteTrigger(ITask* This,WORD iTrigger) {
    return This->lpVtbl->DeleteTrigger(This,iTrigger);
}
FORCEINLINE HRESULT ITask_GetTriggerCount(ITask* This,WORD *plCount) {
    return This->lpVtbl->GetTriggerCount(This,plCount);
}
FORCEINLINE HRESULT ITask_GetTrigger(ITask* This,WORD iTrigger,ITaskTrigger **ppTrigger) {
    return This->lpVtbl->GetTrigger(This,iTrigger,ppTrigger);
}
FORCEINLINE HRESULT ITask_GetTriggerString(ITask* This,WORD iTrigger,LPWSTR *ppwszTrigger) {
    return This->lpVtbl->GetTriggerString(This,iTrigger,ppwszTrigger);
}
FORCEINLINE HRESULT ITask_GetRunTimes(ITask* This,const LPSYSTEMTIME pstBegin,const LPSYSTEMTIME pstEnd,WORD *pCount,LPSYSTEMTIME *rgstTaskTimes) {
    return This->lpVtbl->GetRunTimes(This,pstBegin,pstEnd,pCount,rgstTaskTimes);
}
FORCEINLINE HRESULT ITask_GetNextRunTime(ITask* This,SYSTEMTIME *pstNextRun) {
    return This->lpVtbl->GetNextRunTime(This,pstNextRun);
}
FORCEINLINE HRESULT ITask_SetIdleWait(ITask* This,WORD wIdleMinutes,WORD wDeadlineMinutes) {
    return This->lpVtbl->SetIdleWait(This,wIdleMinutes,wDeadlineMinutes);
}
FORCEINLINE HRESULT ITask_GetIdleWait(ITask* This,WORD *pwIdleMinutes,WORD *pwDeadlineMinutes) {
    return This->lpVtbl->GetIdleWait(This,pwIdleMinutes,pwDeadlineMinutes);
}
FORCEINLINE HRESULT ITask_Run(ITask* This) {
    return This->lpVtbl->Run(This);
}
FORCEINLINE HRESULT ITask_Terminate(ITask* This) {
    return This->lpVtbl->Terminate(This);
}
FORCEINLINE HRESULT ITask_EditWorkItem(ITask* This,HWND hParent,DWORD dwReserved) {
    return This->lpVtbl->EditWorkItem(This,hParent,dwReserved);
}
FORCEINLINE HRESULT ITask_GetMostRecentRunTime(ITask* This,SYSTEMTIME *pstLastRun) {
    return This->lpVtbl->GetMostRecentRunTime(This,pstLastRun);
}
FORCEINLINE HRESULT ITask_GetStatus(ITask* This,HRESULT *phrStatus) {
    return This->lpVtbl->GetStatus(This,phrStatus);
}
FORCEINLINE HRESULT ITask_GetExitCode(ITask* This,DWORD *pdwExitCode) {
    return This->lpVtbl->GetExitCode(This,pdwExitCode);
}
FORCEINLINE HRESULT ITask_SetComment(ITask* This,LPCWSTR pwszComment) {
    return This->lpVtbl->SetComment(This,pwszComment);
}
FORCEINLINE HRESULT ITask_GetComment(ITask* This,LPWSTR *ppwszComment) {
    return This->lpVtbl->GetComment(This,ppwszComment);
}
FORCEINLINE HRESULT ITask_SetCreator(ITask* This,LPCWSTR pwszCreator) {
    return This->lpVtbl->SetCreator(This,pwszCreator);
}
FORCEINLINE HRESULT ITask_GetCreator(ITask* This,LPWSTR *ppwszCreator) {
    return This->lpVtbl->GetCreator(This,ppwszCreator);
}
FORCEINLINE HRESULT ITask_SetWorkItemData(ITask* This,WORD cBytes,BYTE rgbData[]) {
    return This->lpVtbl->SetWorkItemData(This,cBytes,rgbData);
}
FORCEINLINE HRESULT ITask_GetWorkItemData(ITask* This,WORD *pcBytes,BYTE **ppBytes) {
    return This->lpVtbl->GetWorkItemData(This,pcBytes,ppBytes);
}
FORCEINLINE HRESULT ITask_SetErrorRetryCount(ITask* This,WORD wRetryCount) {
    return This->lpVtbl->SetErrorRetryCount(This,wRetryCount);
}
FORCEINLINE HRESULT ITask_GetErrorRetryCount(ITask* This,WORD *pwRetryCount) {
    return This->lpVtbl->GetErrorRetryCount(This,pwRetryCount);
}
FORCEINLINE HRESULT ITask_SetErrorRetryInterval(ITask* This,WORD wRetryInterval) {
    return This->lpVtbl->SetErrorRetryInterval(This,wRetryInterval);
}
FORCEINLINE HRESULT ITask_GetErrorRetryInterval(ITask* This,WORD *pwRetryInterval) {
    return This->lpVtbl->GetErrorRetryInterval(This,pwRetryInterval);
}
FORCEINLINE HRESULT ITask_SetFlags(ITask* This,DWORD dwFlags) {
    return This->lpVtbl->SetFlags(This,dwFlags);
}
FORCEINLINE HRESULT ITask_GetFlags(ITask* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
FORCEINLINE HRESULT ITask_SetAccountInformation(ITask* This,LPCWSTR pwszAccountName,LPCWSTR pwszPassword) {
    return This->lpVtbl->SetAccountInformation(This,pwszAccountName,pwszPassword);
}
FORCEINLINE HRESULT ITask_GetAccountInformation(ITask* This,LPWSTR *ppwszAccountName) {
    return This->lpVtbl->GetAccountInformation(This,ppwszAccountName);
}
/*** ITask methods ***/
FORCEINLINE HRESULT ITask_SetApplicationName(ITask* This,LPCWSTR pwszApplicationName) {
    return This->lpVtbl->SetApplicationName(This,pwszApplicationName);
}
FORCEINLINE HRESULT ITask_GetApplicationName(ITask* This,LPWSTR *ppwszApplicationName) {
    return This->lpVtbl->GetApplicationName(This,ppwszApplicationName);
}
FORCEINLINE HRESULT ITask_SetParameters(ITask* This,LPCWSTR pwszParameters) {
    return This->lpVtbl->SetParameters(This,pwszParameters);
}
FORCEINLINE HRESULT ITask_GetParameters(ITask* This,LPWSTR *ppwszParameters) {
    return This->lpVtbl->GetParameters(This,ppwszParameters);
}
FORCEINLINE HRESULT ITask_SetWorkingDirectory(ITask* This,LPCWSTR pwszWorkingDirectory) {
    return This->lpVtbl->SetWorkingDirectory(This,pwszWorkingDirectory);
}
FORCEINLINE HRESULT ITask_GetWorkingDirectory(ITask* This,LPWSTR *ppwszWorkingDirectory) {
...
FORCEINLINE HRESULT ITask_GetPriority(ITask* This,DWORD *pdwPriority) {
    return This->lpVtbl->GetPriority(This,pdwPriority);
}
FORCEINLINE HRESULT ITask_SetTaskFlags(ITask* This,DWORD dwFlags) {
    return This->lpVtbl->SetTaskFlags(This,dwFlags);
}
FORCEINLINE HRESULT ITask_GetTaskFlags(ITask* This,DWORD *pdwFlags) {
...
FORCEINLINE HRESULT ITask_GetMaxRunTime(ITask* This,DWORD *pdwMaxRunTime) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITaskScheduler_QueryInterface(ITaskScheduler* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITaskScheduler_AddRef(ITaskScheduler* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITaskScheduler_Release(ITaskScheduler* This) {
    return This->lpVtbl->Release(This);
}
/*** ITaskScheduler methods ***/
FORCEINLINE HRESULT ITaskScheduler_SetTargetComputer(ITaskScheduler* This,LPCWSTR pwszComputer) {
    return This->lpVtbl->SetTargetComputer(This,pwszComputer);
}
FORCEINLINE HRESULT ITaskScheduler_GetTargetComputer(ITaskScheduler* This,LPWSTR *ppwszComputer) {
    return This->lpVtbl->GetTargetComputer(This,ppwszComputer);
}
FORCEINLINE HRESULT ITaskScheduler_Enum(ITaskScheduler* This,IEnumWorkItems **ppEnumTasks) {
    return This->lpVtbl->Enum(This,ppEnumTasks);
}
FORCEINLINE HRESULT ITaskScheduler_Activate(ITaskScheduler* This,LPCWSTR pwszName,REFIID riid,IUnknown **ppunk) {
    return This->lpVtbl->Activate(This,pwszName,riid,ppunk);
}
FORCEINLINE HRESULT ITaskScheduler_Delete(ITaskScheduler* This,LPCWSTR pwszName) {
    return This->lpVtbl->Delete(This,pwszName);
}
FORCEINLINE HRESULT ITaskScheduler_NewWorkItem(ITaskScheduler* This,LPCWSTR pwszTaskName,REFCLSID rclsid,REFIID riid,IUnknown **ppunk) {
    return This->lpVtbl->NewWorkItem(This,pwszTaskName,rclsid,riid,ppunk);
}
FORCEINLINE HRESULT ITaskScheduler_AddWorkItem(ITaskScheduler* This,LPCWSTR pwszTaskName,IScheduledWorkItem *pWorkItem) {
    return This->lpVtbl->AddWorkItem(This,pwszTaskName,pWorkItem);
}
FORCEINLINE HRESULT ITaskScheduler_IsOfType(ITaskScheduler* This,LPCWSTR pwszName,REFIID riid) {
