/*** Autogenerated by WIDL <undefined version> from richole.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IRichEditOle_QueryInterface(IRichEditOle* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IRichEditOle_AddRef(IRichEditOle* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IRichEditOle_Release(IRichEditOle* This) {
    return This->lpVtbl->Release(This);
}
/*** IRichEditOle methods ***/
FORCEINLINE HRESULT IRichEditOle_GetClientSite(IRichEditOle* This,LPOLECLIENTSITE *lplpolesite) {
    return This->lpVtbl->GetClientSite(This,lplpolesite);
}
FORCEINLINE HRESULT IRichEditOle_GetObjectCount(IRichEditOle* This) {
    return This->lpVtbl->GetObjectCount(This);
}
FORCEINLINE HRESULT IRichEditOle_GetLinkCount(IRichEditOle* This) {
    return This->lpVtbl->GetLinkCount(This);
}
FORCEINLINE HRESULT IRichEditOle_GetObject(IRichEditOle* This,LONG iob,REOBJECT *lpreobject,DWORD dwFlags) {
    return This->lpVtbl->GetObject(This,iob,lpreobject,dwFlags);
}
FORCEINLINE HRESULT IRichEditOle_InsertObject(IRichEditOle* This,REOBJECT *lpreobject) {
    return This->lpVtbl->InsertObject(This,lpreobject);
}
FORCEINLINE HRESULT IRichEditOle_ConvertObject(IRichEditOle* This,LONG iob,REFCLSID rclsidNew,LPCSTR lpstrUserTypeNew) {
    return This->lpVtbl->ConvertObject(This,iob,rclsidNew,lpstrUserTypeNew);
}
FORCEINLINE HRESULT IRichEditOle_ActivateAs(IRichEditOle* This,REFCLSID rclsid,REFCLSID rclsidAs) {
    return This->lpVtbl->ActivateAs(This,rclsid,rclsidAs);
}
FORCEINLINE HRESULT IRichEditOle_SetHostNames(IRichEditOle* This,LPCSTR lpstrContainerApp,LPCSTR lpstrContainerObj) {
    return This->lpVtbl->SetHostNames(This,lpstrContainerApp,lpstrContainerObj);
}
FORCEINLINE HRESULT IRichEditOle_SetLinkAvailable(IRichEditOle* This,LONG iob,BOOL fAvailable) {
    return This->lpVtbl->SetLinkAvailable(This,iob,fAvailable);
}
FORCEINLINE HRESULT IRichEditOle_SetDvaspect(IRichEditOle* This,LONG iob,DWORD dvaspect) {
    return This->lpVtbl->SetDvaspect(This,iob,dvaspect);
}
FORCEINLINE HRESULT IRichEditOle_HandsOffStorage(IRichEditOle* This,LONG iob) {
    return This->lpVtbl->HandsOffStorage(This,iob);
}
FORCEINLINE HRESULT IRichEditOle_SaveCompleted(IRichEditOle* This,LONG iob,LPSTORAGE lpstg) {
    return This->lpVtbl->SaveCompleted(This,iob,lpstg);
}
FORCEINLINE HRESULT IRichEditOle_InPlaceDeactivate(IRichEditOle* This) {
    return This->lpVtbl->InPlaceDeactivate(This);
}
FORCEINLINE HRESULT IRichEditOle_ContextSensitiveHelp(IRichEditOle* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
FORCEINLINE HRESULT IRichEditOle_GetClipboardData(IRichEditOle* This,CHARRANGE *lpchrg,DWORD reco,LPDATAOBJECT *lplpdataobj) {
    return This->lpVtbl->GetClipboardData(This,lpchrg,reco,lplpdataobj);
}
FORCEINLINE HRESULT IRichEditOle_ImportDataObject(IRichEditOle* This,LPDATAOBJECT lpdataobj,CLIPFORMAT cf,HGLOBAL hMetaPict) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IRichEditOleCallback_QueryInterface(IRichEditOleCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IRichEditOleCallback_AddRef(IRichEditOleCallback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IRichEditOleCallback_Release(IRichEditOleCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** IRichEditOleCallback methods ***/
FORCEINLINE HRESULT IRichEditOleCallback_GetNewStorage(IRichEditOleCallback* This,LPSTORAGE *lplpstg) {
    return This->lpVtbl->GetNewStorage(This,lplpstg);
}
FORCEINLINE HRESULT IRichEditOleCallback_GetInPlaceContext(IRichEditOleCallback* This,LPOLEINPLACEFRAME *lplpFrame,LPOLEINPLACEUIWINDOW *lplpDoc,LPOLEINPLACEFRAMEINFO lpFrameInfo) {
    return This->lpVtbl->GetInPlaceContext(This,lplpFrame,lplpDoc,lpFrameInfo);
}
FORCEINLINE HRESULT IRichEditOleCallback_ShowContainerUI(IRichEditOleCallback* This,BOOL fShow) {
    return This->lpVtbl->ShowContainerUI(This,fShow);
}
FORCEINLINE HRESULT IRichEditOleCallback_QueryInsertObject(IRichEditOleCallback* This,LPCLSID lpclsid,LPSTORAGE lpstg,LONG cp) {
    return This->lpVtbl->QueryInsertObject(This,lpclsid,lpstg,cp);
}
FORCEINLINE HRESULT IRichEditOleCallback_DeleteObject(IRichEditOleCallback* This,LPOLEOBJECT lpoleobj) {
    return This->lpVtbl->DeleteObject(This,lpoleobj);
}
FORCEINLINE HRESULT IRichEditOleCallback_QueryAcceptData(IRichEditOleCallback* This,LPDATAOBJECT lpdataobj,CLIPFORMAT *lpcfFormat,DWORD reco,BOOL fReally,HGLOBAL hMetaPict) {
    return This->lpVtbl->QueryAcceptData(This,lpdataobj,lpcfFormat,reco,fReally,hMetaPict);
}
FORCEINLINE HRESULT IRichEditOleCallback_ContextSensitiveHelp(IRichEditOleCallback* This,BOOL fEnterMode) {
    return This->lpVtbl->ContextSensitiveHelp(This,fEnterMode);
}
FORCEINLINE HRESULT IRichEditOleCallback_GetClipboardData(IRichEditOleCallback* This,CHARRANGE *lpchrg,DWORD reco,LPDATAOBJECT *lplpdataobj) {
    return This->lpVtbl->GetClipboardData(This,lpchrg,reco,lplpdataobj);
}
FORCEINLINE HRESULT IRichEditOleCallback_GetDragDropEffect(IRichEditOleCallback* This,BOOL fDrag,DWORD grfKeyState,LPDWORD pdwEffect) {
    return This->lpVtbl->GetDragDropEffect(This,fDrag,grfKeyState,pdwEffect);
}
FORCEINLINE HRESULT IRichEditOleCallback_GetContextMenu(IRichEditOleCallback* This,WORD seltype,LPOLEOBJECT lpoleobj,CHARRANGE *lpchrg,HMENU *lphmenu) {
