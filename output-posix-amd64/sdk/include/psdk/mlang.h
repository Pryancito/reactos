/*** Autogenerated by WIDL <undefined version> from mlang.idl - Do not edit ***/
...
DEFINE_GUID(LIBID_MultiLanguage, 0x275c23e0, 0x3747, 0x11d0, 0x9f,0xea, 0x00,0xaa,0x00,0x3f,0x86,0x46);
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMLangCodePages_QueryInterface(IMLangCodePages* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMLangCodePages_AddRef(IMLangCodePages* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMLangCodePages_Release(IMLangCodePages* This) {
    return This->lpVtbl->Release(This);
}
/*** IMLangCodePages methods ***/
FORCEINLINE HRESULT IMLangCodePages_GetCharCodePages(IMLangCodePages* This,WCHAR chSrc,DWORD *pdwCodePages) {
    return This->lpVtbl->GetCharCodePages(This,chSrc,pdwCodePages);
}
FORCEINLINE HRESULT IMLangCodePages_GetStrCodePages(IMLangCodePages* This,const WCHAR *pszSrc,LONG cchSrc,DWORD dwPriorityCodePages,DWORD *pdwCodePages,LONG *pcchCodePages) {
    return This->lpVtbl->GetStrCodePages(This,pszSrc,cchSrc,dwPriorityCodePages,pdwCodePages,pcchCodePages);
}
FORCEINLINE HRESULT IMLangCodePages_CodePageToCodePages(IMLangCodePages* This,UINT uCodePage,DWORD *pdwCodePages) {
    return This->lpVtbl->CodePageToCodePages(This,uCodePage,pdwCodePages);
}
FORCEINLINE HRESULT IMLangCodePages_CodePagesToCodePage(IMLangCodePages* This,DWORD dwCodePages,UINT uDefaultCodePage,UINT *puCodePage) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMLangFontLink_QueryInterface(IMLangFontLink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMLangFontLink_AddRef(IMLangFontLink* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMLangFontLink_Release(IMLangFontLink* This) {
    return This->lpVtbl->Release(This);
}
/*** IMLangCodePages methods ***/
FORCEINLINE HRESULT IMLangFontLink_GetCharCodePages(IMLangFontLink* This,WCHAR chSrc,DWORD *pdwCodePages) {
    return This->lpVtbl->GetCharCodePages(This,chSrc,pdwCodePages);
}
FORCEINLINE HRESULT IMLangFontLink_GetStrCodePages(IMLangFontLink* This,const WCHAR *pszSrc,LONG cchSrc,DWORD dwPriorityCodePages,DWORD *pdwCodePages,LONG *pcchCodePages) {
    return This->lpVtbl->GetStrCodePages(This,pszSrc,cchSrc,dwPriorityCodePages,pdwCodePages,pcchCodePages);
}
FORCEINLINE HRESULT IMLangFontLink_CodePageToCodePages(IMLangFontLink* This,UINT uCodePage,DWORD *pdwCodePages) {
    return This->lpVtbl->CodePageToCodePages(This,uCodePage,pdwCodePages);
}
FORCEINLINE HRESULT IMLangFontLink_CodePagesToCodePage(IMLangFontLink* This,DWORD dwCodePages,UINT uDefaultCodePage,UINT *puCodePage) {
    return This->lpVtbl->CodePagesToCodePage(This,dwCodePages,uDefaultCodePage,puCodePage);
}
/*** IMLangFontLink methods ***/
FORCEINLINE HRESULT IMLangFontLink_GetFontCodePages(IMLangFontLink* This,HDC hDC,HFONT hFont,DWORD *pdwCodePages) {
    return This->lpVtbl->GetFontCodePages(This,hDC,hFont,pdwCodePages);
}
FORCEINLINE HRESULT IMLangFontLink_MapFont(IMLangFontLink* This,HDC hDC,DWORD dwCodePages,HFONT hSrcFont,HFONT *phDestFont) {
    return This->lpVtbl->MapFont(This,hDC,dwCodePages,hSrcFont,phDestFont);
}
FORCEINLINE HRESULT IMLangFontLink_ReleaseFont(IMLangFontLink* This,HFONT hFont) {
    return This->lpVtbl->ReleaseFont(This,hFont);
}
FORCEINLINE HRESULT IMLangFontLink_ResetFontMapping(IMLangFontLink* This) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IEnumScript_QueryInterface(IEnumScript* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IEnumScript_AddRef(IEnumScript* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IEnumScript_Release(IEnumScript* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumScript methods ***/
FORCEINLINE HRESULT IEnumScript_Clone(IEnumScript* This,IEnumScript **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT IEnumScript_Next(IEnumScript* This,ULONG celt,PSCRIPTINFO rgelt,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgelt,pceltFetched);
}
FORCEINLINE HRESULT IEnumScript_Reset(IEnumScript* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IEnumScript_Skip(IEnumScript* This,ULONG celt) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMLangFontLink2_QueryInterface(IMLangFontLink2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMLangFontLink2_AddRef(IMLangFontLink2* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMLangFontLink2_Release(IMLangFontLink2* This) {
    return This->lpVtbl->Release(This);
}
/*** IMLangCodePages methods ***/
FORCEINLINE HRESULT IMLangFontLink2_GetCharCodePages(IMLangFontLink2* This,WCHAR chSrc,DWORD *pdwCodePages) {
    return This->lpVtbl->GetCharCodePages(This,chSrc,pdwCodePages);
}
FORCEINLINE HRESULT IMLangFontLink2_GetStrCodePages(IMLangFontLink2* This,const WCHAR *pszSrc,LONG cchSrc,DWORD dwPriorityCodePages,DWORD *pdwCodePages,LONG *pcchCodePages) {
    return This->lpVtbl->GetStrCodePages(This,pszSrc,cchSrc,dwPriorityCodePages,pdwCodePages,pcchCodePages);
}
FORCEINLINE HRESULT IMLangFontLink2_CodePageToCodePages(IMLangFontLink2* This,UINT uCodePage,DWORD *pdwCodePages) {
    return This->lpVtbl->CodePageToCodePages(This,uCodePage,pdwCodePages);
}
FORCEINLINE HRESULT IMLangFontLink2_CodePagesToCodePage(IMLangFontLink2* This,DWORD dwCodePages,UINT uDefaultCodePage,UINT *puCodePage) {
    return This->lpVtbl->CodePagesToCodePage(This,dwCodePages,uDefaultCodePage,puCodePage);
}
/*** IMLangFontLink2 methods ***/
FORCEINLINE HRESULT IMLangFontLink2_GetFontCodePages(IMLangFontLink2* This,HDC hDC,HFONT hFont,DWORD *pdwCodePages) {
    return This->lpVtbl->GetFontCodePages(This,hDC,hFont,pdwCodePages);
}
FORCEINLINE HRESULT IMLangFontLink2_ReleaseFont(IMLangFontLink2* This,HFONT hFont) {
    return This->lpVtbl->ReleaseFont(This,hFont);
}
FORCEINLINE HRESULT IMLangFontLink2_ResetFontMapping(IMLangFontLink2* This) {
    return This->lpVtbl->ResetFontMapping(This);
}
FORCEINLINE HRESULT IMLangFontLink2_MapFont(IMLangFontLink2* This,HDC hDC,DWORD dwCodePages,WCHAR chSrc,HFONT *pFont) {
    return This->lpVtbl->MapFont(This,hDC,dwCodePages,chSrc,pFont);
}
FORCEINLINE HRESULT IMLangFontLink2_GetFontUnicodeRanges(IMLangFontLink2* This,HDC hDC,UINT *puiRanges,UNICODERANGE *pUranges) {
    return This->lpVtbl->GetFontUnicodeRanges(This,hDC,puiRanges,pUranges);
}
FORCEINLINE HRESULT IMLangFontLink2_GetScriptFontInfo(IMLangFontLink2* This,SCRIPT_ID sid,DWORD dwFlags,UINT *puiFonts,SCRIPTFONTINFO *pScriptFont) {
    return This->lpVtbl->GetScriptFontInfo(This,sid,dwFlags,puiFonts,pScriptFont);
}
FORCEINLINE HRESULT IMLangFontLink2_CodePageToScriptID(IMLangFontLink2* This,UINT uiCodePage,SCRIPT_ID *pSid) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMLangString_QueryInterface(IMLangString* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMLangString_AddRef(IMLangString* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMLangString_Release(IMLangString* This) {
    return This->lpVtbl->Release(This);
}
/*** IMLangString methods ***/
FORCEINLINE HRESULT IMLangString_Sync(IMLangString* This,BOOL fNoAccess) {
    return This->lpVtbl->Sync(This,fNoAccess);
}
FORCEINLINE HRESULT IMLangString_GetLength(IMLangString* This,LONG *plLen) {
    return This->lpVtbl->GetLength(This,plLen);
}
FORCEINLINE HRESULT IMLangString_SetMLStr(IMLangString* This,LONG lDestPos,LONG lDestLen,IUnknown *pSrcMLStr,LONG lSrcPos,LONG lSrcLen) {
    return This->lpVtbl->SetMLStr(This,lDestPos,lDestLen,pSrcMLStr,lSrcPos,lSrcLen);
}
FORCEINLINE HRESULT IMLangString_GetMLStr(IMLangString* This,LONG lSrcPos,LONG lSrcLen,IUnknown *pUnkOuter,DWORD dwClsContext,const IID *piid,IUnknown **ppDestMLStr,LONG *plDestPos,LONG *plDestLen) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMLangLineBreakConsole_QueryInterface(IMLangLineBreakConsole* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMLangLineBreakConsole_AddRef(IMLangLineBreakConsole* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMLangLineBreakConsole_Release(IMLangLineBreakConsole* This) {
    return This->lpVtbl->Release(This);
}
/*** IMLangLineBreakConsole methods ***/
FORCEINLINE HRESULT IMLangLineBreakConsole_BreakLineML(IMLangLineBreakConsole* This,IMLangString *pSrcMLStr,LONG lSrcPos,LONG lSrcLen,LONG cMinColumns,LONG cMaxColumns,LONG *plLineLen,LONG *plSkipLen) {
    return This->lpVtbl->BreakLineML(This,pSrcMLStr,lSrcPos,lSrcLen,cMinColumns,cMaxColumns,plLineLen,plSkipLen);
}
FORCEINLINE HRESULT IMLangLineBreakConsole_BreakLineW(IMLangLineBreakConsole* This,LCID locale,const WCHAR *pszSrc,LONG cchSrc,LONG cMaxColumns,LONG *pcchLine,LONG *pcchSkip) {
    return This->lpVtbl->BreakLineW(This,locale,pszSrc,cchSrc,cMaxColumns,pcchLine,pcchSkip);
}
FORCEINLINE HRESULT IMLangLineBreakConsole_BreakLineA(IMLangLineBreakConsole* This,LCID locale,UINT uCodePage,const CHAR *pszSrc,LONG cchSrc,LONG cMaxColumns,LONG *pcchLine,LONG *pcchSkip) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IEnumCodePage_QueryInterface(IEnumCodePage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IEnumCodePage_AddRef(IEnumCodePage* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IEnumCodePage_Release(IEnumCodePage* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumCodePage methods ***/
FORCEINLINE HRESULT IEnumCodePage_Clone(IEnumCodePage* This,IEnumCodePage **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT IEnumCodePage_Next(IEnumCodePage* This,ULONG celt,PMIMECPINFO rgelt,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgelt,pceltFetched);
}
FORCEINLINE HRESULT IEnumCodePage_Reset(IEnumCodePage* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IEnumCodePage_Skip(IEnumCodePage* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMLangConvertCharset_QueryInterface(IMLangConvertCharset* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMLangConvertCharset_AddRef(IMLangConvertCharset* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMLangConvertCharset_Release(IMLangConvertCharset* This) {
    return This->lpVtbl->Release(This);
}
/*** IMLangConvertCharset methods ***/
FORCEINLINE HRESULT IMLangConvertCharset_Initialize(IMLangConvertCharset* This,UINT uiSrcCodePage,UINT uiDstCodePage,DWORD dwProperty) {
    return This->lpVtbl->Initialize(This,uiSrcCodePage,uiDstCodePage,dwProperty);
}
FORCEINLINE HRESULT IMLangConvertCharset_GetSourceCodePage(IMLangConvertCharset* This,UINT *puiSrcCodePage) {
    return This->lpVtbl->GetSourceCodePage(This,puiSrcCodePage);
}
FORCEINLINE HRESULT IMLangConvertCharset_GetDestinationCodePage(IMLangConvertCharset* This,UINT *puiDstCodePage) {
    return This->lpVtbl->GetDestinationCodePage(This,puiDstCodePage);
}
FORCEINLINE HRESULT IMLangConvertCharset_GetProperty(IMLangConvertCharset* This,DWORD *pdwProperty) {
    return This->lpVtbl->GetProperty(This,pdwProperty);
}
FORCEINLINE HRESULT IMLangConvertCharset_DoConversion(IMLangConvertCharset* This,BYTE *pSrcStr,UINT *pcSrcSize,BYTE *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->DoConversion(This,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMLangConvertCharset_DoConversionToUnicode(IMLangConvertCharset* This,CHAR *pSrcStr,UINT *pcSrcSize,WCHAR *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->DoConversionToUnicode(This,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMLangConvertCharset_DoConversionFromUnicode(IMLangConvertCharset* This,WCHAR *pSrcStr,UINT *pcSrcSize,CHAR *pDstStr,UINT *pcDstSize) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IEnumRfc1766_QueryInterface(IEnumRfc1766* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IEnumRfc1766_AddRef(IEnumRfc1766* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IEnumRfc1766_Release(IEnumRfc1766* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumRfc1766 methods ***/
FORCEINLINE HRESULT IEnumRfc1766_Clone(IEnumRfc1766* This,IEnumRfc1766 **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT IEnumRfc1766_Next(IEnumRfc1766* This,ULONG celt,PRFC1766INFO rgelt,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgelt,pceltFetched);
}
FORCEINLINE HRESULT IEnumRfc1766_Reset(IEnumRfc1766* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IEnumRfc1766_Skip(IEnumRfc1766* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMultiLanguage_QueryInterface(IMultiLanguage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMultiLanguage_AddRef(IMultiLanguage* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMultiLanguage_Release(IMultiLanguage* This) {
    return This->lpVtbl->Release(This);
}
/*** IMultiLanguage methods ***/
FORCEINLINE HRESULT IMultiLanguage_GetNumberOfCodePageInfo(IMultiLanguage* This,UINT *pcCodePage) {
    return This->lpVtbl->GetNumberOfCodePageInfo(This,pcCodePage);
}
FORCEINLINE HRESULT IMultiLanguage_GetCodePageInfo(IMultiLanguage* This,UINT uiCodePage,PMIMECPINFO pCodePageInfo) {
    return This->lpVtbl->GetCodePageInfo(This,uiCodePage,pCodePageInfo);
}
FORCEINLINE HRESULT IMultiLanguage_GetFamilyCodePage(IMultiLanguage* This,UINT uiCodePage,UINT *puiFamilyCodePage) {
...
FORCEINLINE HRESULT IMultiLanguage_GetCharsetInfo(IMultiLanguage* This,BSTR Charset,PMIMECSETINFO pCharsetInfo) {
    return This->lpVtbl->GetCharsetInfo(This,Charset,pCharsetInfo);
}
FORCEINLINE HRESULT IMultiLanguage_IsConvertible(IMultiLanguage* This,DWORD dwSrcEncoding,DWORD dwDstEncoding) {
    return This->lpVtbl->IsConvertible(This,dwSrcEncoding,dwDstEncoding);
}
FORCEINLINE HRESULT IMultiLanguage_ConvertString(IMultiLanguage* This,DWORD *pdwMode,DWORD dwSrcEncoding,DWORD dwDstEncoding,BYTE *pSrcStr,UINT *pcSrcSize,BYTE *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->ConvertString(This,pdwMode,dwSrcEncoding,dwDstEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMultiLanguage_ConvertStringToUnicode(IMultiLanguage* This,DWORD *pdwMode,DWORD dwEncoding,CHAR *pSrcStr,UINT *pcSrcSize,WCHAR *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->ConvertStringToUnicode(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMultiLanguage_ConvertStringFromUnicode(IMultiLanguage* This,DWORD *pdwMode,DWORD dwEncoding,WCHAR *pSrcStr,UINT *pcSrcSize,CHAR *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->ConvertStringFromUnicode(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMultiLanguage_ConvertStringReset(IMultiLanguage* This) {
    return This->lpVtbl->ConvertStringReset(This);
}
FORCEINLINE HRESULT IMultiLanguage_GetRfc1766FromLcid(IMultiLanguage* This,LCID Locale,BSTR *pbstrRfc1766) {
    return This->lpVtbl->GetRfc1766FromLcid(This,Locale,pbstrRfc1766);
}
FORCEINLINE HRESULT IMultiLanguage_GetLcidFromRfc1766(IMultiLanguage* This,LCID *pLocale,BSTR bstrRfc1766) {
    return This->lpVtbl->GetLcidFromRfc1766(This,pLocale,bstrRfc1766);
}
FORCEINLINE HRESULT IMultiLanguage_EnumRfc1766(IMultiLanguage* This,IEnumRfc1766 **ppEnumRfc1766) {
    return This->lpVtbl->EnumRfc1766(This,ppEnumRfc1766);
}
FORCEINLINE HRESULT IMultiLanguage_GetRfc1766Info(IMultiLanguage* This,LCID Locale,PRFC1766INFO pRfc1766Info) {
    return This->lpVtbl->GetRfc1766Info(This,Locale,pRfc1766Info);
}
FORCEINLINE HRESULT IMultiLanguage_CreateConvertCharset(IMultiLanguage* This,UINT uiSrcCodePage,UINT uiDstCodePage,DWORD dwProperty,IMLangConvertCharset **ppMLangConvertCharset) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMultiLanguage2_QueryInterface(IMultiLanguage2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMultiLanguage2_AddRef(IMultiLanguage2* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMultiLanguage2_Release(IMultiLanguage2* This) {
    return This->lpVtbl->Release(This);
}
/*** IMultiLanguage2 methods ***/
FORCEINLINE HRESULT IMultiLanguage2_GetNumberOfCodePageInfo(IMultiLanguage2* This,UINT *pcCodePage) {
    return This->lpVtbl->GetNumberOfCodePageInfo(This,pcCodePage);
}
FORCEINLINE HRESULT IMultiLanguage2_GetCodePageInfo(IMultiLanguage2* This,UINT uiCodePage,LANGID LangId,PMIMECPINFO pCodePageInfo) {
    return This->lpVtbl->GetCodePageInfo(This,uiCodePage,LangId,pCodePageInfo);
}
FORCEINLINE HRESULT IMultiLanguage2_GetFamilyCodePage(IMultiLanguage2* This,UINT uiCodePage,UINT *puiFamilyCodePage) {
    return This->lpVtbl->GetFamilyCodePage(This,uiCodePage,puiFamilyCodePage);
}
FORCEINLINE HRESULT IMultiLanguage2_EnumCodePages(IMultiLanguage2* This,DWORD grfFlags,LANGID LangId,IEnumCodePage **ppEnumCodePage) {
    return This->lpVtbl->EnumCodePages(This,grfFlags,LangId,ppEnumCodePage);
}
FORCEINLINE HRESULT IMultiLanguage2_GetCharsetInfo(IMultiLanguage2* This,BSTR Charset,PMIMECSETINFO pCharsetInfo) {
    return This->lpVtbl->GetCharsetInfo(This,Charset,pCharsetInfo);
}
FORCEINLINE HRESULT IMultiLanguage2_IsConvertible(IMultiLanguage2* This,DWORD dwSrcEncoding,DWORD dwDstEncoding) {
    return This->lpVtbl->IsConvertible(This,dwSrcEncoding,dwDstEncoding);
}
FORCEINLINE HRESULT IMultiLanguage2_ConvertString(IMultiLanguage2* This,DWORD *pdwMode,DWORD dwSrcEncoding,DWORD dwDstEncoding,BYTE *pSrcStr,UINT *pcSrcSize,BYTE *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->ConvertString(This,pdwMode,dwSrcEncoding,dwDstEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMultiLanguage2_ConvertStringToUnicode(IMultiLanguage2* This,DWORD *pdwMode,DWORD dwEncoding,CHAR *pSrcStr,UINT *pcSrcSize,WCHAR *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->ConvertStringToUnicode(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMultiLanguage2_ConvertStringFromUnicode(IMultiLanguage2* This,DWORD *pdwMode,DWORD dwEncoding,WCHAR *pSrcStr,UINT *pcSrcSize,CHAR *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->ConvertStringFromUnicode(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMultiLanguage2_ConvertStringReset(IMultiLanguage2* This) {
    return This->lpVtbl->ConvertStringReset(This);
}
FORCEINLINE HRESULT IMultiLanguage2_GetRfc1766FromLcid(IMultiLanguage2* This,LCID Locale,BSTR *pbstrRfc1766) {
    return This->lpVtbl->GetRfc1766FromLcid(This,Locale,pbstrRfc1766);
}
FORCEINLINE HRESULT IMultiLanguage2_GetLcidFromRfc1766(IMultiLanguage2* This,LCID *pLocale,BSTR bstrRfc1766) {
    return This->lpVtbl->GetLcidFromRfc1766(This,pLocale,bstrRfc1766);
}
FORCEINLINE HRESULT IMultiLanguage2_EnumRfc1766(IMultiLanguage2* This,LANGID LangId,IEnumRfc1766 **ppEnumRfc1766) {
    return This->lpVtbl->EnumRfc1766(This,LangId,ppEnumRfc1766);
}
FORCEINLINE HRESULT IMultiLanguage2_GetRfc1766Info(IMultiLanguage2* This,LCID Locale,LANGID LangId,PRFC1766INFO pRfc1766Info) {
    return This->lpVtbl->GetRfc1766Info(This,Locale,LangId,pRfc1766Info);
}
FORCEINLINE HRESULT IMultiLanguage2_CreateConvertCharset(IMultiLanguage2* This,UINT uiSrcCodePage,UINT uiDstCodePage,DWORD dwProperty,IMLangConvertCharset **ppMLangConvertCharset) {
    return This->lpVtbl->CreateConvertCharset(This,uiSrcCodePage,uiDstCodePage,dwProperty,ppMLangConvertCharset);
}
FORCEINLINE HRESULT IMultiLanguage2_ConvertStringInIStream(IMultiLanguage2* This,DWORD *pdwMode,DWORD dwFlag,WCHAR *lpFallBack,DWORD dwSrcEncoding,DWORD dwDstEncoding,IStream *pstmIn,IStream *pstmOut) {
    return This->lpVtbl->ConvertStringInIStream(This,pdwMode,dwFlag,lpFallBack,dwSrcEncoding,dwDstEncoding,pstmIn,pstmOut);
}
FORCEINLINE HRESULT IMultiLanguage2_ConvertStringToUnicodeEx(IMultiLanguage2* This,DWORD *pdwMode,DWORD dwEncoding,CHAR *pSrcStr,UINT *pcSrcSize,WCHAR *pDstStr,UINT *pcDstSize,DWORD dwFlag,WCHAR *lpFallBack) {
...
FORCEINLINE HRESULT IMultiLanguage2_ConvertStringFromUnicodeEx(IMultiLanguage2* This,DWORD *pdwMode,DWORD dwEncoding,WCHAR *pSrcStr,UINT *pcSrcSize,CHAR *pDstStr,UINT *pcDstSize,DWORD dwFlag,WCHAR *lpFallBack) {
...
FORCEINLINE HRESULT IMultiLanguage2_DetectCodepageInIStream(IMultiLanguage2* This,DWORD dwFlag,DWORD dwPrefWinCodePage,IStream *pstmIn,DetectEncodingInfo *lpEncoding,INT *pnScores) {
    return This->lpVtbl->DetectCodepageInIStream(This,dwFlag,dwPrefWinCodePage,pstmIn,lpEncoding,pnScores);
}
FORCEINLINE HRESULT IMultiLanguage2_DetectInputCodepage(IMultiLanguage2* This,DWORD dwFlag,DWORD dwPrefWinCodePage,CHAR *pSrcStr,INT *pcSrcSize,DetectEncodingInfo *lpEncoding,INT *pnScores) {
    return This->lpVtbl->DetectInputCodepage(This,dwFlag,dwPrefWinCodePage,pSrcStr,pcSrcSize,lpEncoding,pnScores);
}
FORCEINLINE HRESULT IMultiLanguage2_ValidateCodePage(IMultiLanguage2* This,UINT uiCodePage,HWND hwnd) {
    return This->lpVtbl->ValidateCodePage(This,uiCodePage,hwnd);
}
FORCEINLINE HRESULT IMultiLanguage2_GetCodePageDescription(IMultiLanguage2* This,UINT uiCodePage,LCID lcid,LPWSTR lpWideCharStr,int cchWideChar) {
    return This->lpVtbl->GetCodePageDescription(This,uiCodePage,lcid,lpWideCharStr,cchWideChar);
}
FORCEINLINE HRESULT IMultiLanguage2_IsCodePageInstallable(IMultiLanguage2* This,UINT uiCodePage) {
    return This->lpVtbl->IsCodePageInstallable(This,uiCodePage);
}
FORCEINLINE HRESULT IMultiLanguage2_SetMimeDBSource(IMultiLanguage2* This,MIMECONTF dwSource) {
    return This->lpVtbl->SetMimeDBSource(This,dwSource);
}
FORCEINLINE HRESULT IMultiLanguage2_GetNumberOfScripts(IMultiLanguage2* This,UINT *pnScripts) {
    return This->lpVtbl->GetNumberOfScripts(This,pnScripts);
}
FORCEINLINE HRESULT IMultiLanguage2_EnumScripts(IMultiLanguage2* This,DWORD dwFlags,LANGID LangId,IEnumScript **ppEnumScript) {
    return This->lpVtbl->EnumScripts(This,dwFlags,LangId,ppEnumScript);
}
FORCEINLINE HRESULT IMultiLanguage2_ValidateCodePageEx(IMultiLanguage2* This,UINT uiCodePage,HWND hwnd,DWORD dwfIODControl) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMultiLanguage3_QueryInterface(IMultiLanguage3* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMultiLanguage3_AddRef(IMultiLanguage3* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMultiLanguage3_Release(IMultiLanguage3* This) {
    return This->lpVtbl->Release(This);
}
/*** IMultiLanguage2 methods ***/
FORCEINLINE HRESULT IMultiLanguage3_GetNumberOfCodePageInfo(IMultiLanguage3* This,UINT *pcCodePage) {
    return This->lpVtbl->GetNumberOfCodePageInfo(This,pcCodePage);
}
FORCEINLINE HRESULT IMultiLanguage3_GetCodePageInfo(IMultiLanguage3* This,UINT uiCodePage,LANGID LangId,PMIMECPINFO pCodePageInfo) {
    return This->lpVtbl->GetCodePageInfo(This,uiCodePage,LangId,pCodePageInfo);
}
FORCEINLINE HRESULT IMultiLanguage3_GetFamilyCodePage(IMultiLanguage3* This,UINT uiCodePage,UINT *puiFamilyCodePage) {
    return This->lpVtbl->GetFamilyCodePage(This,uiCodePage,puiFamilyCodePage);
}
...
FORCEINLINE HRESULT IMultiLanguage3_GetCharsetInfo(IMultiLanguage3* This,BSTR Charset,PMIMECSETINFO pCharsetInfo) {
    return This->lpVtbl->GetCharsetInfo(This,Charset,pCharsetInfo);
}
FORCEINLINE HRESULT IMultiLanguage3_IsConvertible(IMultiLanguage3* This,DWORD dwSrcEncoding,DWORD dwDstEncoding) {
    return This->lpVtbl->IsConvertible(This,dwSrcEncoding,dwDstEncoding);
}
FORCEINLINE HRESULT IMultiLanguage3_ConvertString(IMultiLanguage3* This,DWORD *pdwMode,DWORD dwSrcEncoding,DWORD dwDstEncoding,BYTE *pSrcStr,UINT *pcSrcSize,BYTE *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->ConvertString(This,pdwMode,dwSrcEncoding,dwDstEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMultiLanguage3_ConvertStringToUnicode(IMultiLanguage3* This,DWORD *pdwMode,DWORD dwEncoding,CHAR *pSrcStr,UINT *pcSrcSize,WCHAR *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->ConvertStringToUnicode(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMultiLanguage3_ConvertStringFromUnicode(IMultiLanguage3* This,DWORD *pdwMode,DWORD dwEncoding,WCHAR *pSrcStr,UINT *pcSrcSize,CHAR *pDstStr,UINT *pcDstSize) {
    return This->lpVtbl->ConvertStringFromUnicode(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize);
}
FORCEINLINE HRESULT IMultiLanguage3_ConvertStringReset(IMultiLanguage3* This) {
    return This->lpVtbl->ConvertStringReset(This);
}
FORCEINLINE HRESULT IMultiLanguage3_GetRfc1766FromLcid(IMultiLanguage3* This,LCID Locale,BSTR *pbstrRfc1766) {
    return This->lpVtbl->GetRfc1766FromLcid(This,Locale,pbstrRfc1766);
}
FORCEINLINE HRESULT IMultiLanguage3_GetLcidFromRfc1766(IMultiLanguage3* This,LCID *pLocale,BSTR bstrRfc1766) {
    return This->lpVtbl->GetLcidFromRfc1766(This,pLocale,bstrRfc1766);
}
FORCEINLINE HRESULT IMultiLanguage3_EnumRfc1766(IMultiLanguage3* This,LANGID LangId,IEnumRfc1766 **ppEnumRfc1766) {
    return This->lpVtbl->EnumRfc1766(This,LangId,ppEnumRfc1766);
}
FORCEINLINE HRESULT IMultiLanguage3_GetRfc1766Info(IMultiLanguage3* This,LCID Locale,LANGID LangId,PRFC1766INFO pRfc1766Info) {
    return This->lpVtbl->GetRfc1766Info(This,Locale,LangId,pRfc1766Info);
}
FORCEINLINE HRESULT IMultiLanguage3_CreateConvertCharset(IMultiLanguage3* This,UINT uiSrcCodePage,UINT uiDstCodePage,DWORD dwProperty,IMLangConvertCharset **ppMLangConvertCharset) {
    return This->lpVtbl->CreateConvertCharset(This,uiSrcCodePage,uiDstCodePage,dwProperty,ppMLangConvertCharset);
}
FORCEINLINE HRESULT IMultiLanguage3_ConvertStringInIStream(IMultiLanguage3* This,DWORD *pdwMode,DWORD dwFlag,WCHAR *lpFallBack,DWORD dwSrcEncoding,DWORD dwDstEncoding,IStream *pstmIn,IStream *pstmOut) {
    return This->lpVtbl->ConvertStringInIStream(This,pdwMode,dwFlag,lpFallBack,dwSrcEncoding,dwDstEncoding,pstmIn,pstmOut);
}
FORCEINLINE HRESULT IMultiLanguage3_ConvertStringToUnicodeEx(IMultiLanguage3* This,DWORD *pdwMode,DWORD dwEncoding,CHAR *pSrcStr,UINT *pcSrcSize,WCHAR *pDstStr,UINT *pcDstSize,DWORD dwFlag,WCHAR *lpFallBack) {
    return This->lpVtbl->ConvertStringToUnicodeEx(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize,dwFlag,lpFallBack);
}
FORCEINLINE HRESULT IMultiLanguage3_ConvertStringFromUnicodeEx(IMultiLanguage3* This,DWORD *pdwMode,DWORD dwEncoding,WCHAR *pSrcStr,UINT *pcSrcSize,CHAR *pDstStr,UINT *pcDstSize,DWORD dwFlag,WCHAR *lpFallBack) {
    return This->lpVtbl->ConvertStringFromUnicodeEx(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize,dwFlag,lpFallBack);
}
FORCEINLINE HRESULT IMultiLanguage3_DetectCodepageInIStream(IMultiLanguage3* This,DWORD dwFlag,DWORD dwPrefWinCodePage,IStream *pstmIn,DetectEncodingInfo *lpEncoding,INT *pnScores) {
    return This->lpVtbl->DetectCodepageInIStream(This,dwFlag,dwPrefWinCodePage,pstmIn,lpEncoding,pnScores);
}
FORCEINLINE HRESULT IMultiLanguage3_DetectInputCodepage(IMultiLanguage3* This,DWORD dwFlag,DWORD dwPrefWinCodePage,CHAR *pSrcStr,INT *pcSrcSize,DetectEncodingInfo *lpEncoding,INT *pnScores) {
    return This->lpVtbl->DetectInputCodepage(This,dwFlag,dwPrefWinCodePage,pSrcStr,pcSrcSize,lpEncoding,pnScores);
}
FORCEINLINE HRESULT IMultiLanguage3_ValidateCodePage(IMultiLanguage3* This,UINT uiCodePage,HWND hwnd) {
    return This->lpVtbl->ValidateCodePage(This,uiCodePage,hwnd);
}
FORCEINLINE HRESULT IMultiLanguage3_GetCodePageDescription(IMultiLanguage3* This,UINT uiCodePage,LCID lcid,LPWSTR lpWideCharStr,int cchWideChar) {
    return This->lpVtbl->GetCodePageDescription(This,uiCodePage,lcid,lpWideCharStr,cchWideChar);
}
FORCEINLINE HRESULT IMultiLanguage3_IsCodePageInstallable(IMultiLanguage3* This,UINT uiCodePage) {
    return This->lpVtbl->IsCodePageInstallable(This,uiCodePage);
}
FORCEINLINE HRESULT IMultiLanguage3_SetMimeDBSource(IMultiLanguage3* This,MIMECONTF dwSource) {
    return This->lpVtbl->SetMimeDBSource(This,dwSource);
}
FORCEINLINE HRESULT IMultiLanguage3_GetNumberOfScripts(IMultiLanguage3* This,UINT *pnScripts) {
    return This->lpVtbl->GetNumberOfScripts(This,pnScripts);
}
FORCEINLINE HRESULT IMultiLanguage3_EnumScripts(IMultiLanguage3* This,DWORD dwFlags,LANGID LangId,IEnumScript **ppEnumScript) {
    return This->lpVtbl->EnumScripts(This,dwFlags,LangId,ppEnumScript);
}
FORCEINLINE HRESULT IMultiLanguage3_ValidateCodePageEx(IMultiLanguage3* This,UINT uiCodePage,HWND hwnd,DWORD dwfIODControl) {
    return This->lpVtbl->ValidateCodePageEx(This,uiCodePage,hwnd,dwfIODControl);
}
/*** IMultiLanguage3 methods ***/
FORCEINLINE HRESULT IMultiLanguage3_DetectOutboundCodePage(IMultiLanguage3* This,DWORD dwFlags,LPCWSTR lpWideCharStr,UINT cchWideChar,UINT *puiPreferredCodePages,UINT nPreferredCodePages,UINT *puiDetectedCodePages,UINT *pnDetectedCodePages,WCHAR *lpSpecialChar) {
...
FORCEINLINE HRESULT IMultiLanguage3_DetectOutboundCodePageInIStream(IMultiLanguage3* This,DWORD dwFlags,IStream *pStrIn,UINT *puiPreferredCodePages,UINT nPreferredCodePages,UINT *puiDetectedCodePages,UINT *pnDetectedCodePages,WCHAR *lpSpecialChar) {
