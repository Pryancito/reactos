/*** Autogenerated by WIDL <undefined version> from oleacc.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IAccessible_QueryInterface(IAccessible* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IAccessible_AddRef(IAccessible* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IAccessible_Release(IAccessible* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT IAccessible_GetTypeInfoCount(IAccessible* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT IAccessible_GetTypeInfo(IAccessible* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT IAccessible_GetIDsOfNames(IAccessible* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT IAccessible_Invoke(IAccessible* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IAccessible methods ***/
FORCEINLINE HRESULT IAccessible_get_accParent(IAccessible* This,IDispatch **ppdispParent) {
    return This->lpVtbl->get_accParent(This,ppdispParent);
}
FORCEINLINE HRESULT IAccessible_get_accChildCount(IAccessible* This,LONG *pcountChildren) {
    return This->lpVtbl->get_accChildCount(This,pcountChildren);
}
FORCEINLINE HRESULT IAccessible_get_accChild(IAccessible* This,VARIANT varChildID,IDispatch **ppdispChild) {
    return This->lpVtbl->get_accChild(This,varChildID,ppdispChild);
}
FORCEINLINE HRESULT IAccessible_get_accName(IAccessible* This,VARIANT varID,BSTR *pszName) {
    return This->lpVtbl->get_accName(This,varID,pszName);
}
FORCEINLINE HRESULT IAccessible_get_accValue(IAccessible* This,VARIANT varID,BSTR *pszValue) {
    return This->lpVtbl->get_accValue(This,varID,pszValue);
}
FORCEINLINE HRESULT IAccessible_get_accDescription(IAccessible* This,VARIANT varID,BSTR *description) {
    return This->lpVtbl->get_accDescription(This,varID,description);
}
FORCEINLINE HRESULT IAccessible_get_accRole(IAccessible* This,VARIANT varID,VARIANT *role) {
    return This->lpVtbl->get_accRole(This,varID,role);
}
FORCEINLINE HRESULT IAccessible_get_accState(IAccessible* This,VARIANT varID,VARIANT *state) {
    return This->lpVtbl->get_accState(This,varID,state);
}
FORCEINLINE HRESULT IAccessible_get_accHelp(IAccessible* This,VARIANT varID,BSTR *help) {
    return This->lpVtbl->get_accHelp(This,varID,help);
}
FORCEINLINE HRESULT IAccessible_get_accHelpTopic(IAccessible* This,BSTR *helpfile,VARIANT varID,LONG *pidTopic) {
    return This->lpVtbl->get_accHelpTopic(This,helpfile,varID,pidTopic);
}
FORCEINLINE HRESULT IAccessible_get_accKeyboardShortcut(IAccessible* This,VARIANT varID,BSTR *shortcut) {
    return This->lpVtbl->get_accKeyboardShortcut(This,varID,shortcut);
}
FORCEINLINE HRESULT IAccessible_get_accFocus(IAccessible* This,VARIANT *pvarID) {
    return This->lpVtbl->get_accFocus(This,pvarID);
}
FORCEINLINE HRESULT IAccessible_get_accSelection(IAccessible* This,VARIANT *pvarID) {
    return This->lpVtbl->get_accSelection(This,pvarID);
}
FORCEINLINE HRESULT IAccessible_get_accDefaultAction(IAccessible* This,VARIANT varID,BSTR *action) {
    return This->lpVtbl->get_accDefaultAction(This,varID,action);
}
FORCEINLINE HRESULT IAccessible_accSelect(IAccessible* This,LONG flagsSelect,VARIANT varID) {
    return This->lpVtbl->accSelect(This,flagsSelect,varID);
}
FORCEINLINE HRESULT IAccessible_accLocation(IAccessible* This,LONG *left,LONG *top,LONG *width,LONG *height,VARIANT varID) {
    return This->lpVtbl->accLocation(This,left,top,width,height,varID);
}
FORCEINLINE HRESULT IAccessible_accNavigate(IAccessible* This,LONG dir,VARIANT varStart,VARIANT *pvarEnd) {
    return This->lpVtbl->accNavigate(This,dir,varStart,pvarEnd);
}
FORCEINLINE HRESULT IAccessible_accHitTest(IAccessible* This,LONG left,LONG top,VARIANT *pvarID) {
    return This->lpVtbl->accHitTest(This,left,top,pvarID);
}
FORCEINLINE HRESULT IAccessible_accDoDefaultAction(IAccessible* This,VARIANT varID) {
    return This->lpVtbl->accDoDefaultAction(This,varID);
}
FORCEINLINE HRESULT IAccessible_put_accName(IAccessible* This,VARIANT varID,BSTR name) {
    return This->lpVtbl->put_accName(This,varID,name);
}
FORCEINLINE HRESULT IAccessible_put_accValue(IAccessible* This,VARIANT varID,BSTR value) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IAccessibleHandler_QueryInterface(IAccessibleHandler* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IAccessibleHandler_AddRef(IAccessibleHandler* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IAccessibleHandler_Release(IAccessibleHandler* This) {
    return This->lpVtbl->Release(This);
}
/*** IAccessibleHandler methods ***/
FORCEINLINE HRESULT IAccessibleHandler_AccessibleObjectFromID(IAccessibleHandler* This,LONG hwnd,LONG lObjectID,LPACCESSIBLE *pIAccessible) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IAccIdentity_QueryInterface(IAccIdentity* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IAccIdentity_AddRef(IAccIdentity* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IAccIdentity_Release(IAccIdentity* This) {
    return This->lpVtbl->Release(This);
}
/*** IAccIdentity methods ***/
FORCEINLINE HRESULT IAccIdentity_GetIdentityString(IAccIdentity* This,DWORD idchild,BYTE **str,DWORD *string_len) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IAccPropServer_QueryInterface(IAccPropServer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IAccPropServer_AddRef(IAccPropServer* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IAccPropServer_Release(IAccPropServer* This) {
    return This->lpVtbl->Release(This);
}
/*** IAccPropServer methods ***/
FORCEINLINE HRESULT IAccPropServer_GetPropValue(IAccPropServer* This,const BYTE *str,DWORD string_len,MSAAPROPID idProp,VARIANT *value,BOOL *has_prop) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IAccPropServices_QueryInterface(IAccPropServices* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IAccPropServices_AddRef(IAccPropServices* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IAccPropServices_Release(IAccPropServices* This) {
    return This->lpVtbl->Release(This);
}
/*** IAccPropServices methods ***/
FORCEINLINE HRESULT IAccPropServices_SetPropValue(IAccPropServices* This,const BYTE *str,DWORD string_len,MSAAPROPID idProp,VARIANT var) {
    return This->lpVtbl->SetPropValue(This,str,string_len,idProp,var);
}
FORCEINLINE HRESULT IAccPropServices_SetPropServer(IAccPropServices* This,const BYTE *str,DWORD string_len,const MSAAPROPID *props,int cProps,IAccPropServer *pServer,AnnoScope AnnoScope) {
    return This->lpVtbl->SetPropServer(This,str,string_len,props,cProps,pServer,AnnoScope);
}
FORCEINLINE HRESULT IAccPropServices_ClearProps(IAccPropServices* This,const BYTE *str,DWORD string_len,const MSAAPROPID *props,int cProps) {
    return This->lpVtbl->ClearProps(This,str,string_len,props,cProps);
}
FORCEINLINE HRESULT IAccPropServices_SetHwndProp(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,MSAAPROPID idProp,VARIANT var) {
    return This->lpVtbl->SetHwndProp(This,hwnd,idObject,idChild,idProp,var);
}
FORCEINLINE HRESULT IAccPropServices_SetHwndPropStr(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,MSAAPROPID idProp,LPWSTR str) {
    return This->lpVtbl->SetHwndPropStr(This,hwnd,idObject,idChild,idProp,str);
}
FORCEINLINE HRESULT IAccPropServices_SetHwndPropServer(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,const MSAAPROPID *props,int cProps,IAccPropServer *server,AnnoScope scope) {
    return This->lpVtbl->SetHwndPropServer(This,hwnd,idObject,idChild,props,cProps,server,scope);
}
FORCEINLINE HRESULT IAccPropServices_ClearHwndProps(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,const MSAAPROPID *props,int cProps) {
    return This->lpVtbl->ClearHwndProps(This,hwnd,idObject,idChild,props,cProps);
}
FORCEINLINE HRESULT IAccPropServices_ComposeHwndIdentityString(IAccPropServices* This,HWND hwnd,DWORD idObject,DWORD idChild,BYTE **str,DWORD *string_len) {
    return This->lpVtbl->ComposeHwndIdentityString(This,hwnd,idObject,idChild,str,string_len);
}
FORCEINLINE HRESULT IAccPropServices_DecomposeHwndIdentityString(IAccPropServices* This,const BYTE *str,DWORD string_len,HWND *phwnd,DWORD *pidObject,DWORD *pidChild) {
    return This->lpVtbl->DecomposeHwndIdentityString(This,str,string_len,phwnd,pidObject,pidChild);
}
FORCEINLINE HRESULT IAccPropServices_SetHmenuProp(IAccPropServices* This,HMENU hmenu,DWORD idChild,MSAAPROPID idProp,VARIANT var) {
    return This->lpVtbl->SetHmenuProp(This,hmenu,idChild,idProp,var);
}
FORCEINLINE HRESULT IAccPropServices_SetHmenuPropStr(IAccPropServices* This,HMENU hmenu,DWORD idChild,MSAAPROPID idProp,LPWSTR str) {
    return This->lpVtbl->SetHmenuPropStr(This,hmenu,idChild,idProp,str);
}
FORCEINLINE HRESULT IAccPropServices_SetHmenuPropServer(IAccPropServices* This,HMENU hmenu,DWORD idChild,const MSAAPROPID *props,int cProps,IAccPropServer *server,AnnoScope scope) {
    return This->lpVtbl->SetHmenuPropServer(This,hmenu,idChild,props,cProps,server,scope);
}
FORCEINLINE HRESULT IAccPropServices_ClearHmenuProps(IAccPropServices* This,HMENU hmenu,DWORD idChild,const MSAAPROPID *props,int cProps) {
    return This->lpVtbl->ClearHmenuProps(This,hmenu,idChild,props,cProps);
}
FORCEINLINE HRESULT IAccPropServices_ComposeHmenuIdentityString(IAccPropServices* This,HMENU hmenu,DWORD idChild,BYTE **str,DWORD *string_len) {
    return This->lpVtbl->ComposeHmenuIdentityString(This,hmenu,idChild,str,string_len);
}
FORCEINLINE HRESULT IAccPropServices_DecomposeHmenuIdentityString(IAccPropServices* This,const BYTE *str,DWORD string_len,HMENU *phmenu,DWORD *pidChild) {
