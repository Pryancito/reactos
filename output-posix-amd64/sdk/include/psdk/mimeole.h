/*** Autogenerated by WIDL <undefined version> from mimeole.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeInternational_QueryInterface(IMimeInternational* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeInternational_AddRef(IMimeInternational* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeInternational_Release(IMimeInternational* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeInternational methods ***/
FORCEINLINE HRESULT IMimeInternational_SetDefaultCharset(IMimeInternational* This,HCHARSET hCharset) {
    return This->lpVtbl->SetDefaultCharset(This,hCharset);
}
FORCEINLINE HRESULT IMimeInternational_GetDefaultCharset(IMimeInternational* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetDefaultCharset(This,phCharset);
}
FORCEINLINE HRESULT IMimeInternational_GetCodePageCharset(IMimeInternational* This,CODEPAGEID cpiCodePage,CHARSETTYPE ctCsetType,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCodePageCharset(This,cpiCodePage,ctCsetType,phCharset);
}
FORCEINLINE HRESULT IMimeInternational_FindCharset(IMimeInternational* This,LPCSTR pszCharset,LPHCHARSET phCharset) {
    return This->lpVtbl->FindCharset(This,pszCharset,phCharset);
}
FORCEINLINE HRESULT IMimeInternational_GetCharsetInfo(IMimeInternational* This,HCHARSET hCharset,LPINETCSETINFO pCsetInfo) {
    return This->lpVtbl->GetCharsetInfo(This,hCharset,pCsetInfo);
}
FORCEINLINE HRESULT IMimeInternational_GetCodePageInfo(IMimeInternational* This,CODEPAGEID cpiCodePage,LPCODEPAGEINFO pCodePageInfo) {
    return This->lpVtbl->GetCodePageInfo(This,cpiCodePage,pCodePageInfo);
}
FORCEINLINE HRESULT IMimeInternational_CanConvertCodePages(IMimeInternational* This,CODEPAGEID cpiSource,CODEPAGEID cpiDest) {
    return This->lpVtbl->CanConvertCodePages(This,cpiSource,cpiDest);
}
FORCEINLINE HRESULT IMimeInternational_DecodeHeader(IMimeInternational* This,HCHARSET hCharset,LPCSTR pszData,LPPROPVARIANT pDecoded,LPRFC1522INFO pRfc1522Info) {
    return This->lpVtbl->DecodeHeader(This,hCharset,pszData,pDecoded,pRfc1522Info);
}
FORCEINLINE HRESULT IMimeInternational_EncodeHeader(IMimeInternational* This,HCHARSET hCharset,LPPROPVARIANT pData,LPSTR *ppszEncoded,LPRFC1522INFO pRfc1522Info) {
    return This->lpVtbl->EncodeHeader(This,hCharset,pData,ppszEncoded,pRfc1522Info);
}
FORCEINLINE HRESULT IMimeInternational_ConvertBuffer(IMimeInternational* This,CODEPAGEID cpiSource,CODEPAGEID cpiDest,LPBLOB pIn,LPBLOB pOut,ULONG *pcbRead) {
    return This->lpVtbl->ConvertBuffer(This,cpiSource,cpiDest,pIn,pOut,pcbRead);
}
FORCEINLINE HRESULT IMimeInternational_ConvertString(IMimeInternational* This,CODEPAGEID cpiSource,CODEPAGEID cpiDest,LPPROPVARIANT pIn,LPPROPVARIANT pOut) {
    return This->lpVtbl->ConvertString(This,cpiSource,cpiDest,pIn,pOut);
}
FORCEINLINE HRESULT IMimeInternational_MLANG_ConvertInetReset(IMimeInternational* This) {
    return This->lpVtbl->MLANG_ConvertInetReset(This);
}
FORCEINLINE HRESULT IMimeInternational_MLANG_ConvertInetString(IMimeInternational* This,CODEPAGEID cpiSource,CODEPAGEID cpiDest,LPCSTR pSource,int *pnSizeOfSource,LPSTR pDestination,int *pnDstSize) {
    return This->lpVtbl->MLANG_ConvertInetString(This,cpiSource,cpiDest,pSource,pnSizeOfSource,pDestination,pnDstSize);
}
FORCEINLINE HRESULT IMimeInternational_Rfc1522Decode(IMimeInternational* This,LPCSTR pszValue,LPSTR pszCharset,ULONG cchmax,LPSTR *ppszDecoded) {
    return This->lpVtbl->Rfc1522Decode(This,pszValue,pszCharset,cchmax,ppszDecoded);
}
FORCEINLINE HRESULT IMimeInternational_Rfc1522Encode(IMimeInternational* This,LPCSTR pszValue,HCHARSET hCharset,LPSTR *ppszEncoded) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeSecurity_QueryInterface(IMimeSecurity* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeSecurity_AddRef(IMimeSecurity* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeSecurity_Release(IMimeSecurity* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeSecurity methods ***/
FORCEINLINE HRESULT IMimeSecurity_InitNew(IMimeSecurity* This) {
    return This->lpVtbl->InitNew(This);
}
FORCEINLINE HRESULT IMimeSecurity_CheckInit(IMimeSecurity* This) {
    return This->lpVtbl->CheckInit(This);
}
FORCEINLINE HRESULT IMimeSecurity_EncodeMessage(IMimeSecurity* This,IMimeMessageTree *pTree,DWORD dwFlags) {
    return This->lpVtbl->EncodeMessage(This,pTree,dwFlags);
}
FORCEINLINE HRESULT IMimeSecurity_EncodeBody(IMimeSecurity* This,IMimeMessageTree *pTree,HBODY hEncodeRoot,DWORD dwFlags) {
    return This->lpVtbl->EncodeBody(This,pTree,hEncodeRoot,dwFlags);
}
FORCEINLINE HRESULT IMimeSecurity_DecodeMessage(IMimeSecurity* This,IMimeMessageTree *pTree,DWORD dwFlags) {
    return This->lpVtbl->DecodeMessage(This,pTree,dwFlags);
}
FORCEINLINE HRESULT IMimeSecurity_DecodeBody(IMimeSecurity* This,IMimeMessageTree *pTree,HBODY hDecodeRoot,DWORD dwFlags) {
    return This->lpVtbl->DecodeBody(This,pTree,hDecodeRoot,dwFlags);
}
FORCEINLINE HRESULT IMimeSecurity_EnumCertificates(IMimeSecurity* This,HCAPICERTSTORE hc,DWORD dwUsage,PCX509CERT pPrev,PCX509CERT *ppCert) {
    return This->lpVtbl->EnumCertificates(This,hc,dwUsage,pPrev,ppCert);
}
FORCEINLINE HRESULT IMimeSecurity_GetCertificateName(IMimeSecurity* This,const PCX509CERT pX509Cert,const CERTNAMETYPE cn,LPSTR *ppszName) {
    return This->lpVtbl->GetCertificateName(This,pX509Cert,cn,ppszName);
}
FORCEINLINE HRESULT IMimeSecurity_GetMessageType(IMimeSecurity* This,const HWND hwndParent,IMimeBody *pBody,DWORD *pdwSecType) {
    return This->lpVtbl->GetMessageType(This,hwndParent,pBody,pdwSecType);
}
FORCEINLINE HRESULT IMimeSecurity_GetCertData(IMimeSecurity* This,const PCX509CERT pX509Cert,const CERTDATAID dataid,LPPROPVARIANT pValue) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeHeaderTable_QueryInterface(IMimeHeaderTable* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeHeaderTable_AddRef(IMimeHeaderTable* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeHeaderTable_Release(IMimeHeaderTable* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
FORCEINLINE HRESULT IMimeHeaderTable_GetClassID(IMimeHeaderTable* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStream methods ***/
FORCEINLINE HRESULT IMimeHeaderTable_IsDirty(IMimeHeaderTable* This) {
    return This->lpVtbl->IsDirty(This);
}
FORCEINLINE HRESULT IMimeHeaderTable_Load(IMimeHeaderTable* This,IStream *pStm) {
    return This->lpVtbl->Load(This,pStm);
}
FORCEINLINE HRESULT IMimeHeaderTable_Save(IMimeHeaderTable* This,IStream *pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
FORCEINLINE HRESULT IMimeHeaderTable_GetSizeMax(IMimeHeaderTable* This,ULARGE_INTEGER *pcbSize) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimePropertySchema_QueryInterface(IMimePropertySchema* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimePropertySchema_AddRef(IMimePropertySchema* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimePropertySchema_Release(IMimePropertySchema* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimePropertySchema methods ***/
FORCEINLINE HRESULT IMimePropertySchema_RegisterProperty(IMimePropertySchema* This,const char *name,DWORD flags,DWORD rownumber,VARTYPE vtdefault,DWORD *propid) {
    return This->lpVtbl->RegisterProperty(This,name,flags,rownumber,vtdefault,propid);
}
FORCEINLINE HRESULT IMimePropertySchema_ModifyProperty(IMimePropertySchema* This,const char *name,DWORD flags,DWORD rownumber,VARTYPE vtdefault) {
    return This->lpVtbl->ModifyProperty(This,name,flags,rownumber,vtdefault);
}
FORCEINLINE HRESULT IMimePropertySchema_GetPropertyId(IMimePropertySchema* This,const char *name,DWORD *propid) {
    return This->lpVtbl->GetPropertyId(This,name,propid);
}
FORCEINLINE HRESULT IMimePropertySchema_GetPropertyName(IMimePropertySchema* This,DWORD propid,char **name) {
    return This->lpVtbl->GetPropertyName(This,propid,name);
}
FORCEINLINE HRESULT IMimePropertySchema_RegisterAddressType(IMimePropertySchema* This,const char *name,DWORD *adrtype) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimePropertySet_QueryInterface(IMimePropertySet* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimePropertySet_AddRef(IMimePropertySet* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimePropertySet_Release(IMimePropertySet* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
FORCEINLINE HRESULT IMimePropertySet_GetClassID(IMimePropertySet* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStreamInit methods ***/
FORCEINLINE HRESULT IMimePropertySet_IsDirty(IMimePropertySet* This) {
    return This->lpVtbl->IsDirty(This);
}
FORCEINLINE HRESULT IMimePropertySet_Load(IMimePropertySet* This,LPSTREAM pStm) {
    return This->lpVtbl->Load(This,pStm);
}
FORCEINLINE HRESULT IMimePropertySet_Save(IMimePropertySet* This,LPSTREAM pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
FORCEINLINE HRESULT IMimePropertySet_GetSizeMax(IMimePropertySet* This,ULARGE_INTEGER *pcbSize) {
    return This->lpVtbl->GetSizeMax(This,pcbSize);
}
FORCEINLINE HRESULT IMimePropertySet_InitNew(IMimePropertySet* This) {
    return This->lpVtbl->InitNew(This);
}
/*** IMimePropertySet methods ***/
FORCEINLINE HRESULT IMimePropertySet_GetPropInfo(IMimePropertySet* This,LPCSTR pszName,LPMIMEPROPINFO pInfo) {
    return This->lpVtbl->GetPropInfo(This,pszName,pInfo);
}
FORCEINLINE HRESULT IMimePropertySet_SetPropInfo(IMimePropertySet* This,LPCSTR pszName,LPCMIMEPROPINFO pInfo) {
    return This->lpVtbl->SetPropInfo(This,pszName,pInfo);
}
FORCEINLINE HRESULT IMimePropertySet_GetProp(IMimePropertySet* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetProp(This,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimePropertySet_SetProp(IMimePropertySet* This,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetProp(This,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimePropertySet_AppendProp(IMimePropertySet* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->AppendProp(This,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimePropertySet_DeleteProp(IMimePropertySet* This,LPCSTR pszName) {
    return This->lpVtbl->DeleteProp(This,pszName);
}
FORCEINLINE HRESULT IMimePropertySet_CopyProps(IMimePropertySet* This,ULONG cNames,LPCSTR *prgszName,IMimePropertySet *pPropertySet) {
    return This->lpVtbl->CopyProps(This,cNames,prgszName,pPropertySet);
}
FORCEINLINE HRESULT IMimePropertySet_MoveProps(IMimePropertySet* This,ULONG cNames,LPCSTR *prgszName,IMimePropertySet *pPropertySet) {
    return This->lpVtbl->MoveProps(This,cNames,prgszName,pPropertySet);
}
FORCEINLINE HRESULT IMimePropertySet_DeleteExcept(IMimePropertySet* This,ULONG cNames,LPCSTR *prgszName) {
    return This->lpVtbl->DeleteExcept(This,cNames,prgszName);
}
FORCEINLINE HRESULT IMimePropertySet_QueryProp(IMimePropertySet* This,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryProp(This,pszName,pszCriteria,fSubString,fCaseSensitive);
}
FORCEINLINE HRESULT IMimePropertySet_GetCharset(IMimePropertySet* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCharset(This,phCharset);
}
FORCEINLINE HRESULT IMimePropertySet_SetCharset(IMimePropertySet* This,HCHARSET hCharset,CSETAPPLYTYPE applytype) {
    return This->lpVtbl->SetCharset(This,hCharset,applytype);
}
FORCEINLINE HRESULT IMimePropertySet_GetParameters(IMimePropertySet* This,LPCSTR pszName,ULONG *pcParams,LPMIMEPARAMINFO *pprgParam) {
    return This->lpVtbl->GetParameters(This,pszName,pcParams,pprgParam);
}
FORCEINLINE HRESULT IMimePropertySet_IsContentType(IMimePropertySet* This,LPCSTR pszPriType,LPCSTR pszSubType) {
    return This->lpVtbl->IsContentType(This,pszPriType,pszSubType);
}
FORCEINLINE HRESULT IMimePropertySet_BindToObject(IMimePropertySet* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->BindToObject(This,riid,ppvObject);
}
FORCEINLINE HRESULT IMimePropertySet_Clone(IMimePropertySet* This,IMimePropertySet **ppPropertySet) {
    return This->lpVtbl->Clone(This,ppPropertySet);
}
FORCEINLINE HRESULT IMimePropertySet_SetOption(IMimePropertySet* This,const TYPEDID oid,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetOption(This,oid,pValue);
}
FORCEINLINE HRESULT IMimePropertySet_GetOption(IMimePropertySet* This,const TYPEDID oid,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetOption(This,oid,pValue);
}
FORCEINLINE HRESULT IMimePropertySet_EnumProps(IMimePropertySet* This,DWORD dwFlags,IMimeEnumProperties **ppEnum) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeAddressTable_QueryInterface(IMimeAddressTable* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeAddressTable_AddRef(IMimeAddressTable* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeAddressTable_Release(IMimeAddressTable* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeAddressTable methods ***/
FORCEINLINE HRESULT IMimeAddressTable_Append(IMimeAddressTable* This,DWORD addrtype,ENCODINGTYPE encoding,const char *friendly,const char *email,HADDRESS *address) {
    return This->lpVtbl->Append(This,addrtype,encoding,friendly,email,address);
}
FORCEINLINE HRESULT IMimeAddressTable_Insert(IMimeAddressTable* This,ADDRESSPROPS *addressprop,HADDRESS *address) {
    return This->lpVtbl->Insert(This,addressprop,address);
}
FORCEINLINE HRESULT IMimeAddressTable_SetProps(IMimeAddressTable* This,HADDRESS address,ADDRESSPROPS *addressprop) {
    return This->lpVtbl->SetProps(This,address,addressprop);
}
FORCEINLINE HRESULT IMimeAddressTable_GetProps(IMimeAddressTable* This,HADDRESS address,ADDRESSPROPS *addressprop) {
    return This->lpVtbl->GetProps(This,address,addressprop);
}
FORCEINLINE HRESULT IMimeAddressTable_GetSender(IMimeAddressTable* This,ADDRESSPROPS *addressprop) {
    return This->lpVtbl->GetSender(This,addressprop);
}
FORCEINLINE HRESULT IMimeAddressTable_CountTypes(IMimeAddressTable* This,DWORD addrtype,ULONG *count) {
    return This->lpVtbl->CountTypes(This,addrtype,count);
}
FORCEINLINE HRESULT IMimeAddressTable_GetTypes(IMimeAddressTable* This,DWORD addrtype,DWORD dwProps,ADDRESSLIST *list) {
    return This->lpVtbl->GetTypes(This,addrtype,dwProps,list);
}
FORCEINLINE HRESULT IMimeAddressTable_EnumTypes(IMimeAddressTable* This,DWORD addrtype,DWORD props,IMimeEnumAddressTypes **types) {
    return This->lpVtbl->EnumTypes(This,addrtype,props,types);
}
FORCEINLINE HRESULT IMimeAddressTable_Delete(IMimeAddressTable* This,HADDRESS hAddress) {
    return This->lpVtbl->Delete(This,hAddress);
}
FORCEINLINE HRESULT IMimeAddressTable_DeleteTypes(IMimeAddressTable* This,DWORD addrtype) {
    return This->lpVtbl->DeleteTypes(This,addrtype);
}
FORCEINLINE HRESULT IMimeAddressTable_GetFormat(IMimeAddressTable* This,DWORD addrtype,ADDRESSFORMAT addrformat,char **format) {
    return This->lpVtbl->GetFormat(This,addrtype,addrformat,format);
}
FORCEINLINE HRESULT IMimeAddressTable_AppendRfc822(IMimeAddressTable* This,DWORD addrtype,ENCODINGTYPE encoding,const char *rfcaddr) {
    return This->lpVtbl->AppendRfc822(This,addrtype,encoding,rfcaddr);
}
FORCEINLINE HRESULT IMimeAddressTable_ParseRfc822(IMimeAddressTable* This,DWORD addrtype,ENCODINGTYPE encoding,const char *rfcaddr,ADDRESSLIST *list) {
    return This->lpVtbl->ParseRfc822(This,addrtype,encoding,rfcaddr,list);
}
FORCEINLINE HRESULT IMimeAddressTable_Clone(IMimeAddressTable* This,IMimeAddressTable **table) {
    return This->lpVtbl->Clone(This,table);
}
FORCEINLINE HRESULT IMimeAddressTable_BindToObject(IMimeAddressTable* This,REFIID riid,void **obj) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeWebDocument_QueryInterface(IMimeWebDocument* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeWebDocument_AddRef(IMimeWebDocument* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeWebDocument_Release(IMimeWebDocument* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeBody_QueryInterface(IMimeBody* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeBody_AddRef(IMimeBody* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeBody_Release(IMimeBody* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
FORCEINLINE HRESULT IMimeBody_GetClassID(IMimeBody* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStreamInit methods ***/
FORCEINLINE HRESULT IMimeBody_IsDirty(IMimeBody* This) {
    return This->lpVtbl->IsDirty(This);
}
FORCEINLINE HRESULT IMimeBody_Load(IMimeBody* This,LPSTREAM pStm) {
    return This->lpVtbl->Load(This,pStm);
}
FORCEINLINE HRESULT IMimeBody_Save(IMimeBody* This,LPSTREAM pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
FORCEINLINE HRESULT IMimeBody_GetSizeMax(IMimeBody* This,ULARGE_INTEGER *pcbSize) {
    return This->lpVtbl->GetSizeMax(This,pcbSize);
}
FORCEINLINE HRESULT IMimeBody_InitNew(IMimeBody* This) {
    return This->lpVtbl->InitNew(This);
}
/*** IMimePropertySet methods ***/
FORCEINLINE HRESULT IMimeBody_GetPropInfo(IMimeBody* This,LPCSTR pszName,LPMIMEPROPINFO pInfo) {
    return This->lpVtbl->GetPropInfo(This,pszName,pInfo);
}
FORCEINLINE HRESULT IMimeBody_SetPropInfo(IMimeBody* This,LPCSTR pszName,LPCMIMEPROPINFO pInfo) {
    return This->lpVtbl->SetPropInfo(This,pszName,pInfo);
}
FORCEINLINE HRESULT IMimeBody_GetProp(IMimeBody* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetProp(This,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimeBody_SetProp(IMimeBody* This,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetProp(This,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimeBody_AppendProp(IMimeBody* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->AppendProp(This,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimeBody_DeleteProp(IMimeBody* This,LPCSTR pszName) {
    return This->lpVtbl->DeleteProp(This,pszName);
}
FORCEINLINE HRESULT IMimeBody_CopyProps(IMimeBody* This,ULONG cNames,LPCSTR *prgszName,IMimePropertySet *pPropertySet) {
    return This->lpVtbl->CopyProps(This,cNames,prgszName,pPropertySet);
}
FORCEINLINE HRESULT IMimeBody_MoveProps(IMimeBody* This,ULONG cNames,LPCSTR *prgszName,IMimePropertySet *pPropertySet) {
    return This->lpVtbl->MoveProps(This,cNames,prgszName,pPropertySet);
}
FORCEINLINE HRESULT IMimeBody_DeleteExcept(IMimeBody* This,ULONG cNames,LPCSTR *prgszName) {
    return This->lpVtbl->DeleteExcept(This,cNames,prgszName);
}
FORCEINLINE HRESULT IMimeBody_QueryProp(IMimeBody* This,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryProp(This,pszName,pszCriteria,fSubString,fCaseSensitive);
}
FORCEINLINE HRESULT IMimeBody_GetCharset(IMimeBody* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCharset(This,phCharset);
}
FORCEINLINE HRESULT IMimeBody_SetCharset(IMimeBody* This,HCHARSET hCharset,CSETAPPLYTYPE applytype) {
    return This->lpVtbl->SetCharset(This,hCharset,applytype);
}
FORCEINLINE HRESULT IMimeBody_GetParameters(IMimeBody* This,LPCSTR pszName,ULONG *pcParams,LPMIMEPARAMINFO *pprgParam) {
    return This->lpVtbl->GetParameters(This,pszName,pcParams,pprgParam);
}
FORCEINLINE HRESULT IMimeBody_IsContentType(IMimeBody* This,LPCSTR pszPriType,LPCSTR pszSubType) {
    return This->lpVtbl->IsContentType(This,pszPriType,pszSubType);
}
FORCEINLINE HRESULT IMimeBody_BindToObject(IMimeBody* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->BindToObject(This,riid,ppvObject);
}
FORCEINLINE HRESULT IMimeBody_Clone(IMimeBody* This,IMimePropertySet **ppPropertySet) {
    return This->lpVtbl->Clone(This,ppPropertySet);
}
FORCEINLINE HRESULT IMimeBody_SetOption(IMimeBody* This,const TYPEDID oid,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetOption(This,oid,pValue);
}
FORCEINLINE HRESULT IMimeBody_GetOption(IMimeBody* This,const TYPEDID oid,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetOption(This,oid,pValue);
}
FORCEINLINE HRESULT IMimeBody_EnumProps(IMimeBody* This,DWORD dwFlags,IMimeEnumProperties **ppEnum) {
    return This->lpVtbl->EnumProps(This,dwFlags,ppEnum);
}
/*** IMimeBody methods ***/
FORCEINLINE HRESULT IMimeBody_IsType(IMimeBody* This,IMSGBODYTYPE bodytype) {
    return This->lpVtbl->IsType(This,bodytype);
}
FORCEINLINE HRESULT IMimeBody_SetDisplayName(IMimeBody* This,LPCSTR pszDisplay) {
    return This->lpVtbl->SetDisplayName(This,pszDisplay);
}
FORCEINLINE HRESULT IMimeBody_GetDisplayName(IMimeBody* This,LPSTR *ppszDisplay) {
    return This->lpVtbl->GetDisplayName(This,ppszDisplay);
}
FORCEINLINE HRESULT IMimeBody_GetOffsets(IMimeBody* This,LPBODYOFFSETS pOffsets) {
    return This->lpVtbl->GetOffsets(This,pOffsets);
}
FORCEINLINE HRESULT IMimeBody_GetCurrentEncoding(IMimeBody* This,ENCODINGTYPE *pietEncoding) {
    return This->lpVtbl->GetCurrentEncoding(This,pietEncoding);
}
FORCEINLINE HRESULT IMimeBody_SetCurrentEncoding(IMimeBody* This,ENCODINGTYPE ietEncoding) {
    return This->lpVtbl->SetCurrentEncoding(This,ietEncoding);
}
FORCEINLINE HRESULT IMimeBody_GetEstimatedSize(IMimeBody* This,ENCODINGTYPE ietEncoding,ULONG *pcbSize) {
    return This->lpVtbl->GetEstimatedSize(This,ietEncoding,pcbSize);
}
FORCEINLINE HRESULT IMimeBody_GetDataHere(IMimeBody* This,ENCODINGTYPE ietEncoding,IStream *pStream) {
    return This->lpVtbl->GetDataHere(This,ietEncoding,pStream);
}
FORCEINLINE HRESULT IMimeBody_GetData(IMimeBody* This,ENCODINGTYPE ietEncoding,IStream **ppStream) {
    return This->lpVtbl->GetData(This,ietEncoding,ppStream);
}
FORCEINLINE HRESULT IMimeBody_SetData(IMimeBody* This,ENCODINGTYPE ietEncoding,LPCSTR pszPriType,LPCSTR pszSubType,REFIID riid,LPVOID pvObject) {
    return This->lpVtbl->SetData(This,ietEncoding,pszPriType,pszSubType,riid,pvObject);
}
FORCEINLINE HRESULT IMimeBody_EmptyData(IMimeBody* This) {
    return This->lpVtbl->EmptyData(This);
}
FORCEINLINE HRESULT IMimeBody_CopyTo(IMimeBody* This,IMimeBody *pBody) {
    return This->lpVtbl->CopyTo(This,pBody);
}
FORCEINLINE HRESULT IMimeBody_GetTransmitInfo(IMimeBody* This,LPTRANSMITINFO pTransmitInfo) {
    return This->lpVtbl->GetTransmitInfo(This,pTransmitInfo);
}
FORCEINLINE HRESULT IMimeBody_SaveToFile(IMimeBody* This,ENCODINGTYPE ietEncoding,LPCSTR pszFilePath) {
    return This->lpVtbl->SaveToFile(This,ietEncoding,pszFilePath);
}
FORCEINLINE HRESULT IMimeBody_GetHandle(IMimeBody* This,LPHBODY phBody) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeMessageTree_QueryInterface(IMimeMessageTree* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeMessageTree_AddRef(IMimeMessageTree* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeMessageTree_Release(IMimeMessageTree* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
FORCEINLINE HRESULT IMimeMessageTree_GetClassID(IMimeMessageTree* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStreamInit methods ***/
FORCEINLINE HRESULT IMimeMessageTree_IsDirty(IMimeMessageTree* This) {
    return This->lpVtbl->IsDirty(This);
}
FORCEINLINE HRESULT IMimeMessageTree_Load(IMimeMessageTree* This,LPSTREAM pStm) {
    return This->lpVtbl->Load(This,pStm);
}
FORCEINLINE HRESULT IMimeMessageTree_Save(IMimeMessageTree* This,LPSTREAM pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
FORCEINLINE HRESULT IMimeMessageTree_GetSizeMax(IMimeMessageTree* This,ULARGE_INTEGER *pcbSize) {
    return This->lpVtbl->GetSizeMax(This,pcbSize);
}
FORCEINLINE HRESULT IMimeMessageTree_InitNew(IMimeMessageTree* This) {
    return This->lpVtbl->InitNew(This);
}
/*** IMimeMessageTree methods ***/
FORCEINLINE HRESULT IMimeMessageTree_GetMessageSource(IMimeMessageTree* This,IStream **ppStream,DWORD dwFlags) {
    return This->lpVtbl->GetMessageSource(This,ppStream,dwFlags);
}
FORCEINLINE HRESULT IMimeMessageTree_GetMessageSize(IMimeMessageTree* This,ULONG *pcbSize,DWORD dwFlags) {
    return This->lpVtbl->GetMessageSize(This,pcbSize,dwFlags);
}
FORCEINLINE HRESULT IMimeMessageTree_LoadOffsetTable(IMimeMessageTree* This,IStream *pStream) {
    return This->lpVtbl->LoadOffsetTable(This,pStream);
}
FORCEINLINE HRESULT IMimeMessageTree_SaveOffsetTable(IMimeMessageTree* This,IStream *pStream,DWORD dwFlags) {
    return This->lpVtbl->SaveOffsetTable(This,pStream,dwFlags);
}
FORCEINLINE HRESULT IMimeMessageTree_GetFlags(IMimeMessageTree* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
FORCEINLINE HRESULT IMimeMessageTree_Commit(IMimeMessageTree* This,DWORD dwFlags) {
    return This->lpVtbl->Commit(This,dwFlags);
}
FORCEINLINE HRESULT IMimeMessageTree_HandsOffStorage(IMimeMessageTree* This) {
    return This->lpVtbl->HandsOffStorage(This);
}
FORCEINLINE HRESULT IMimeMessageTree_BindToObject(IMimeMessageTree* This,const HBODY hBody,REFIID riid,void **ppvObject) {
    return This->lpVtbl->BindToObject(This,hBody,riid,ppvObject);
}
FORCEINLINE HRESULT IMimeMessageTree_SaveBody(IMimeMessageTree* This,HBODY hBody,DWORD dwFlags,IStream *pStream) {
    return This->lpVtbl->SaveBody(This,hBody,dwFlags,pStream);
}
FORCEINLINE HRESULT IMimeMessageTree_InsertBody(IMimeMessageTree* This,BODYLOCATION location,HBODY hPivot,LPHBODY phBody) {
    return This->lpVtbl->InsertBody(This,location,hPivot,phBody);
}
FORCEINLINE HRESULT IMimeMessageTree_GetBody(IMimeMessageTree* This,BODYLOCATION location,HBODY hPivot,LPHBODY phBody) {
    return This->lpVtbl->GetBody(This,location,hPivot,phBody);
}
FORCEINLINE HRESULT IMimeMessageTree_DeleteBody(IMimeMessageTree* This,HBODY hBody,DWORD dwFlags) {
    return This->lpVtbl->DeleteBody(This,hBody,dwFlags);
}
FORCEINLINE HRESULT IMimeMessageTree_MoveBody(IMimeMessageTree* This,HBODY hBody,BODYLOCATION location) {
    return This->lpVtbl->MoveBody(This,hBody,location);
}
FORCEINLINE HRESULT IMimeMessageTree_CountBodies(IMimeMessageTree* This,HBODY hParent,boolean fRecurse,ULONG *pcBodies) {
    return This->lpVtbl->CountBodies(This,hParent,fRecurse,pcBodies);
}
FORCEINLINE HRESULT IMimeMessageTree_FindFirst(IMimeMessageTree* This,LPFINDBODY pFindBody,LPHBODY phBody) {
    return This->lpVtbl->FindFirst(This,pFindBody,phBody);
}
FORCEINLINE HRESULT IMimeMessageTree_FindNext(IMimeMessageTree* This,LPFINDBODY pFindBody,LPHBODY phBody) {
    return This->lpVtbl->FindNext(This,pFindBody,phBody);
}
FORCEINLINE HRESULT IMimeMessageTree_ResolveURL(IMimeMessageTree* This,HBODY hRelated,LPCSTR pszBase,LPCSTR pszURL,DWORD dwFlags,LPHBODY phBody) {
    return This->lpVtbl->ResolveURL(This,hRelated,pszBase,pszURL,dwFlags,phBody);
}
FORCEINLINE HRESULT IMimeMessageTree_ToMultipart(IMimeMessageTree* This,HBODY hBody,LPCSTR pszSubType,LPHBODY phMultipart) {
    return This->lpVtbl->ToMultipart(This,hBody,pszSubType,phMultipart);
}
FORCEINLINE HRESULT IMimeMessageTree_GetBodyOffsets(IMimeMessageTree* This,HBODY hBody,LPBODYOFFSETS pOffsets) {
    return This->lpVtbl->GetBodyOffsets(This,hBody,pOffsets);
}
FORCEINLINE HRESULT IMimeMessageTree_GetCharset(IMimeMessageTree* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCharset(This,phCharset);
}
FORCEINLINE HRESULT IMimeMessageTree_SetCharset(IMimeMessageTree* This,HCHARSET hCharset,CSETAPPLYTYPE applytype) {
    return This->lpVtbl->SetCharset(This,hCharset,applytype);
}
FORCEINLINE HRESULT IMimeMessageTree_IsBodyType(IMimeMessageTree* This,HBODY hBody,IMSGBODYTYPE bodytype) {
    return This->lpVtbl->IsBodyType(This,hBody,bodytype);
}
FORCEINLINE HRESULT IMimeMessageTree_IsContentType(IMimeMessageTree* This,HBODY hBody,LPCSTR pszPriType,LPCSTR pszSubType) {
    return This->lpVtbl->IsContentType(This,hBody,pszPriType,pszSubType);
}
FORCEINLINE HRESULT IMimeMessageTree_QueryBodyProp(IMimeMessageTree* This,HBODY hBody,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryBodyProp(This,hBody,pszName,pszCriteria,fSubString,fCaseSensitive);
}
FORCEINLINE HRESULT IMimeMessageTree_GetBodyProp(IMimeMessageTree* This,HBODY hBody,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetBodyProp(This,hBody,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimeMessageTree_SetBodyProp(IMimeMessageTree* This,HBODY hBody,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetBodyProp(This,hBody,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimeMessageTree_DeleteBodyProp(IMimeMessageTree* This,HBODY hBody,LPCSTR pszName) {
    return This->lpVtbl->DeleteBodyProp(This,hBody,pszName);
}
FORCEINLINE HRESULT IMimeMessageTree_SetOption(IMimeMessageTree* This,const TYPEDID oid,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetOption(This,oid,pValue);
}
FORCEINLINE HRESULT IMimeMessageTree_GetOption(IMimeMessageTree* This,const TYPEDID oid,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetOption(This,oid,pValue);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeMessage_QueryInterface(IMimeMessage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeMessage_AddRef(IMimeMessage* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeMessage_Release(IMimeMessage* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
FORCEINLINE HRESULT IMimeMessage_GetClassID(IMimeMessage* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistStreamInit methods ***/
FORCEINLINE HRESULT IMimeMessage_IsDirty(IMimeMessage* This) {
    return This->lpVtbl->IsDirty(This);
}
FORCEINLINE HRESULT IMimeMessage_Load(IMimeMessage* This,LPSTREAM pStm) {
    return This->lpVtbl->Load(This,pStm);
}
FORCEINLINE HRESULT IMimeMessage_Save(IMimeMessage* This,LPSTREAM pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
FORCEINLINE HRESULT IMimeMessage_GetSizeMax(IMimeMessage* This,ULARGE_INTEGER *pcbSize) {
    return This->lpVtbl->GetSizeMax(This,pcbSize);
}
FORCEINLINE HRESULT IMimeMessage_InitNew(IMimeMessage* This) {
    return This->lpVtbl->InitNew(This);
}
/*** IMimeMessageTree methods ***/
FORCEINLINE HRESULT IMimeMessage_GetMessageSource(IMimeMessage* This,IStream **ppStream,DWORD dwFlags) {
    return This->lpVtbl->GetMessageSource(This,ppStream,dwFlags);
}
FORCEINLINE HRESULT IMimeMessage_GetMessageSize(IMimeMessage* This,ULONG *pcbSize,DWORD dwFlags) {
    return This->lpVtbl->GetMessageSize(This,pcbSize,dwFlags);
}
FORCEINLINE HRESULT IMimeMessage_LoadOffsetTable(IMimeMessage* This,IStream *pStream) {
    return This->lpVtbl->LoadOffsetTable(This,pStream);
}
FORCEINLINE HRESULT IMimeMessage_SaveOffsetTable(IMimeMessage* This,IStream *pStream,DWORD dwFlags) {
    return This->lpVtbl->SaveOffsetTable(This,pStream,dwFlags);
}
FORCEINLINE HRESULT IMimeMessage_GetFlags(IMimeMessage* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFlags(This,pdwFlags);
}
FORCEINLINE HRESULT IMimeMessage_Commit(IMimeMessage* This,DWORD dwFlags) {
    return This->lpVtbl->Commit(This,dwFlags);
}
FORCEINLINE HRESULT IMimeMessage_HandsOffStorage(IMimeMessage* This) {
    return This->lpVtbl->HandsOffStorage(This);
}
FORCEINLINE HRESULT IMimeMessage_BindToObject(IMimeMessage* This,const HBODY hBody,REFIID riid,void **ppvObject) {
    return This->lpVtbl->BindToObject(This,hBody,riid,ppvObject);
}
FORCEINLINE HRESULT IMimeMessage_SaveBody(IMimeMessage* This,HBODY hBody,DWORD dwFlags,IStream *pStream) {
    return This->lpVtbl->SaveBody(This,hBody,dwFlags,pStream);
}
FORCEINLINE HRESULT IMimeMessage_InsertBody(IMimeMessage* This,BODYLOCATION location,HBODY hPivot,LPHBODY phBody) {
    return This->lpVtbl->InsertBody(This,location,hPivot,phBody);
}
FORCEINLINE HRESULT IMimeMessage_GetBody(IMimeMessage* This,BODYLOCATION location,HBODY hPivot,LPHBODY phBody) {
    return This->lpVtbl->GetBody(This,location,hPivot,phBody);
}
FORCEINLINE HRESULT IMimeMessage_DeleteBody(IMimeMessage* This,HBODY hBody,DWORD dwFlags) {
    return This->lpVtbl->DeleteBody(This,hBody,dwFlags);
}
FORCEINLINE HRESULT IMimeMessage_MoveBody(IMimeMessage* This,HBODY hBody,BODYLOCATION location) {
    return This->lpVtbl->MoveBody(This,hBody,location);
}
FORCEINLINE HRESULT IMimeMessage_CountBodies(IMimeMessage* This,HBODY hParent,boolean fRecurse,ULONG *pcBodies) {
    return This->lpVtbl->CountBodies(This,hParent,fRecurse,pcBodies);
}
FORCEINLINE HRESULT IMimeMessage_FindFirst(IMimeMessage* This,LPFINDBODY pFindBody,LPHBODY phBody) {
    return This->lpVtbl->FindFirst(This,pFindBody,phBody);
}
FORCEINLINE HRESULT IMimeMessage_FindNext(IMimeMessage* This,LPFINDBODY pFindBody,LPHBODY phBody) {
    return This->lpVtbl->FindNext(This,pFindBody,phBody);
}
FORCEINLINE HRESULT IMimeMessage_ResolveURL(IMimeMessage* This,HBODY hRelated,LPCSTR pszBase,LPCSTR pszURL,DWORD dwFlags,LPHBODY phBody) {
    return This->lpVtbl->ResolveURL(This,hRelated,pszBase,pszURL,dwFlags,phBody);
}
FORCEINLINE HRESULT IMimeMessage_ToMultipart(IMimeMessage* This,HBODY hBody,LPCSTR pszSubType,LPHBODY phMultipart) {
    return This->lpVtbl->ToMultipart(This,hBody,pszSubType,phMultipart);
}
FORCEINLINE HRESULT IMimeMessage_GetBodyOffsets(IMimeMessage* This,HBODY hBody,LPBODYOFFSETS pOffsets) {
    return This->lpVtbl->GetBodyOffsets(This,hBody,pOffsets);
}
FORCEINLINE HRESULT IMimeMessage_GetCharset(IMimeMessage* This,LPHCHARSET phCharset) {
    return This->lpVtbl->GetCharset(This,phCharset);
}
FORCEINLINE HRESULT IMimeMessage_SetCharset(IMimeMessage* This,HCHARSET hCharset,CSETAPPLYTYPE applytype) {
    return This->lpVtbl->SetCharset(This,hCharset,applytype);
}
FORCEINLINE HRESULT IMimeMessage_IsBodyType(IMimeMessage* This,HBODY hBody,IMSGBODYTYPE bodytype) {
    return This->lpVtbl->IsBodyType(This,hBody,bodytype);
}
FORCEINLINE HRESULT IMimeMessage_IsContentType(IMimeMessage* This,HBODY hBody,LPCSTR pszPriType,LPCSTR pszSubType) {
    return This->lpVtbl->IsContentType(This,hBody,pszPriType,pszSubType);
}
FORCEINLINE HRESULT IMimeMessage_QueryBodyProp(IMimeMessage* This,HBODY hBody,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryBodyProp(This,hBody,pszName,pszCriteria,fSubString,fCaseSensitive);
}
FORCEINLINE HRESULT IMimeMessage_GetBodyProp(IMimeMessage* This,HBODY hBody,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetBodyProp(This,hBody,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimeMessage_SetBodyProp(IMimeMessage* This,HBODY hBody,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetBodyProp(This,hBody,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimeMessage_DeleteBodyProp(IMimeMessage* This,HBODY hBody,LPCSTR pszName) {
    return This->lpVtbl->DeleteBodyProp(This,hBody,pszName);
}
FORCEINLINE HRESULT IMimeMessage_SetOption(IMimeMessage* This,const TYPEDID oid,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetOption(This,oid,pValue);
}
FORCEINLINE HRESULT IMimeMessage_GetOption(IMimeMessage* This,const TYPEDID oid,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetOption(This,oid,pValue);
}
/*** IMimeMessage methods ***/
FORCEINLINE HRESULT IMimeMessage_CreateWebPage(IMimeMessage* This,IStream *pRootStm,LPWEBPAGEOPTIONS pOptions,IMimeMessageCallback *pCallback,IMoniker **ppMoniker) {
    return This->lpVtbl->CreateWebPage(This,pRootStm,pOptions,pCallback,ppMoniker);
}
FORCEINLINE HRESULT IMimeMessage_GetProp(IMimeMessage* This,LPCSTR pszName,DWORD dwFlags,LPPROPVARIANT pValue) {
    return This->lpVtbl->GetProp(This,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimeMessage_SetProp(IMimeMessage* This,LPCSTR pszName,DWORD dwFlags,LPCPROPVARIANT pValue) {
    return This->lpVtbl->SetProp(This,pszName,dwFlags,pValue);
}
FORCEINLINE HRESULT IMimeMessage_DeleteProp(IMimeMessage* This,LPCSTR pszName) {
    return This->lpVtbl->DeleteProp(This,pszName);
}
FORCEINLINE HRESULT IMimeMessage_QueryProp(IMimeMessage* This,LPCSTR pszName,LPCSTR pszCriteria,boolean fSubString,boolean fCaseSensitive) {
    return This->lpVtbl->QueryProp(This,pszName,pszCriteria,fSubString,fCaseSensitive);
}
FORCEINLINE HRESULT IMimeMessage_GetTextBody(IMimeMessage* This,DWORD dwTxtType,ENCODINGTYPE ietEncoding,IStream **pStream,LPHBODY phBody) {
    return This->lpVtbl->GetTextBody(This,dwTxtType,ietEncoding,pStream,phBody);
}
FORCEINLINE HRESULT IMimeMessage_SetTextBody(IMimeMessage* This,DWORD dwTxtType,ENCODINGTYPE ietEncoding,HBODY hAlternative,IStream *pStream,LPHBODY phBody) {
    return This->lpVtbl->SetTextBody(This,dwTxtType,ietEncoding,hAlternative,pStream,phBody);
}
FORCEINLINE HRESULT IMimeMessage_AttachObject(IMimeMessage* This,REFIID riid,void *pvObject,LPHBODY phBody) {
    return This->lpVtbl->AttachObject(This,riid,pvObject,phBody);
}
FORCEINLINE HRESULT IMimeMessage_AttachFile(IMimeMessage* This,LPCSTR pszFilePath,IStream *pstmFile,LPHBODY phBody) {
    return This->lpVtbl->AttachFile(This,pszFilePath,pstmFile,phBody);
}
FORCEINLINE HRESULT IMimeMessage_AttachURL(IMimeMessage* This,LPCSTR pszBase,LPCSTR pszURL,DWORD dwFlags,IStream *pstmURL,LPSTR *ppszCIDURL,LPHBODY phBody) {
    return This->lpVtbl->AttachURL(This,pszBase,pszURL,dwFlags,pstmURL,ppszCIDURL,phBody);
}
FORCEINLINE HRESULT IMimeMessage_GetAttachments(IMimeMessage* This,ULONG *pcAttach,LPHBODY *pprghAttach) {
    return This->lpVtbl->GetAttachments(This,pcAttach,pprghAttach);
}
FORCEINLINE HRESULT IMimeMessage_GetAddressTable(IMimeMessage* This,IMimeAddressTable **ppTable) {
    return This->lpVtbl->GetAddressTable(This,ppTable);
}
FORCEINLINE HRESULT IMimeMessage_GetSender(IMimeMessage* This,LPADDRESSPROPS pAddress) {
    return This->lpVtbl->GetSender(This,pAddress);
}
FORCEINLINE HRESULT IMimeMessage_GetAddressTypes(IMimeMessage* This,DWORD dwAdrTypes,DWORD dwProps,LPADDRESSLIST pList) {
    return This->lpVtbl->GetAddressTypes(This,dwAdrTypes,dwProps,pList);
}
FORCEINLINE HRESULT IMimeMessage_GetAddressFormat(IMimeMessage* This,DWORD dwAdrTypes,ADDRESSFORMAT format,LPSTR *ppszFormat) {
    return This->lpVtbl->GetAddressFormat(This,dwAdrTypes,format,ppszFormat);
}
FORCEINLINE HRESULT IMimeMessage_EnumAddressTypes(IMimeMessage* This,DWORD dwAdrTypes,DWORD dwProps,IMimeEnumAddressTypes **ppEnum) {
    return This->lpVtbl->EnumAddressTypes(This,dwAdrTypes,dwProps,ppEnum);
}
FORCEINLINE HRESULT IMimeMessage_SplitMessage(IMimeMessage* This,ULONG cbMaxPart,IMimeMessageParts **ppParts) {
    return This->lpVtbl->SplitMessage(This,cbMaxPart,ppParts);
}
FORCEINLINE HRESULT IMimeMessage_GetRootMoniker(IMimeMessage* This,IMoniker **ppMoniker) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeMessageCallback_QueryInterface(IMimeMessageCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeMessageCallback_AddRef(IMimeMessageCallback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeMessageCallback_Release(IMimeMessageCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeMessageCallback methods ***/
FORCEINLINE HRESULT IMimeMessageCallback_OnWebPageSplitter(IMimeMessageCallback* This,DWORD cInlined,IStream *ppStream) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IPersistMime_QueryInterface(IPersistMime* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IPersistMime_AddRef(IPersistMime* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IPersistMime_Release(IPersistMime* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
FORCEINLINE HRESULT IPersistMime_GetClassID(IPersistMime* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeMessageParts_QueryInterface(IMimeMessageParts* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeMessageParts_AddRef(IMimeMessageParts* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeMessageParts_Release(IMimeMessageParts* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeEnumHeaderRows_QueryInterface(IMimeEnumHeaderRows* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeEnumHeaderRows_AddRef(IMimeEnumHeaderRows* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeEnumHeaderRows_Release(IMimeEnumHeaderRows* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeEnumProperties_QueryInterface(IMimeEnumProperties* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeEnumProperties_AddRef(IMimeEnumProperties* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeEnumProperties_Release(IMimeEnumProperties* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeEnumProperties methods ***/
FORCEINLINE HRESULT IMimeEnumProperties_Next(IMimeEnumProperties* This,ULONG cFetch,LPENUMPROPERTY prgProp,ULONG *pcFetched) {
    return This->lpVtbl->Next(This,cFetch,prgProp,pcFetched);
}
FORCEINLINE HRESULT IMimeEnumProperties_Skip(IMimeEnumProperties* This,ULONG cItems) {
    return This->lpVtbl->Skip(This,cItems);
}
FORCEINLINE HRESULT IMimeEnumProperties_Reset(IMimeEnumProperties* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IMimeEnumProperties_Clone(IMimeEnumProperties* This,IMimeEnumProperties **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT IMimeEnumProperties_Count(IMimeEnumProperties* This,ULONG *pcItems) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeEnumAddressTypes_QueryInterface(IMimeEnumAddressTypes* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeEnumAddressTypes_AddRef(IMimeEnumAddressTypes* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeEnumAddressTypes_Release(IMimeEnumAddressTypes* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeEnumMessageParts_QueryInterface(IMimeEnumMessageParts* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeEnumMessageParts_AddRef(IMimeEnumMessageParts* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeEnumMessageParts_Release(IMimeEnumMessageParts* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IHashTable_QueryInterface(IHashTable* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IHashTable_AddRef(IHashTable* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IHashTable_Release(IHashTable* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeAllocator_QueryInterface(IMimeAllocator* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeAllocator_AddRef(IMimeAllocator* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeAllocator_Release(IMimeAllocator* This) {
    return This->lpVtbl->Release(This);
}
/*** IMalloc methods ***/
FORCEINLINE LPVOID IMimeAllocator_Alloc(IMimeAllocator* This,SIZE_T cb) {
    return This->lpVtbl->Alloc(This,cb);
}
FORCEINLINE LPVOID IMimeAllocator_Realloc(IMimeAllocator* This,LPVOID pv,SIZE_T cb) {
    return This->lpVtbl->Realloc(This,pv,cb);
}
FORCEINLINE void IMimeAllocator_Free(IMimeAllocator* This,LPVOID pv) {
    This->lpVtbl->Free(This,pv);
}
FORCEINLINE SIZE_T IMimeAllocator_GetSize(IMimeAllocator* This,LPVOID pv) {
    return This->lpVtbl->GetSize(This,pv);
}
FORCEINLINE int IMimeAllocator_DidAlloc(IMimeAllocator* This,LPVOID pv) {
    return This->lpVtbl->DidAlloc(This,pv);
}
FORCEINLINE void IMimeAllocator_HeapMinimize(IMimeAllocator* This) {
    This->lpVtbl->HeapMinimize(This);
}
/*** IMimeAllocator methods ***/
FORCEINLINE HRESULT IMimeAllocator_FreeParamInfoArray(IMimeAllocator* This,ULONG cParams,LPMIMEPARAMINFO prgParam,boolean fFreeArray) {
    return This->lpVtbl->FreeParamInfoArray(This,cParams,prgParam,fFreeArray);
}
FORCEINLINE HRESULT IMimeAllocator_FreeAddressList(IMimeAllocator* This,LPADDRESSLIST pList) {
    return This->lpVtbl->FreeAddressList(This,pList);
}
FORCEINLINE HRESULT IMimeAllocator_FreeAddressProps(IMimeAllocator* This,LPADDRESSPROPS pAddress) {
    return This->lpVtbl->FreeAddressProps(This,pAddress);
}
FORCEINLINE HRESULT IMimeAllocator_ReleaseObjects(IMimeAllocator* This,ULONG cObjects,IUnknown **prgpUnknown,boolean fFreeArray) {
    return This->lpVtbl->ReleaseObjects(This,cObjects,prgpUnknown,fFreeArray);
}
FORCEINLINE HRESULT IMimeAllocator_FreeEnumHeaderRowArray(IMimeAllocator* This,ULONG cRows,LPENUMHEADERROW prgRow,boolean fFreeArray) {
    return This->lpVtbl->FreeEnumHeaderRowArray(This,cRows,prgRow,fFreeArray);
}
FORCEINLINE HRESULT IMimeAllocator_FreeEnumPropertyArray(IMimeAllocator* This,ULONG cProps,LPENUMPROPERTY prgProp,boolean fFreeArray) {
    return This->lpVtbl->FreeEnumPropertyArray(This,cProps,prgProp,fFreeArray);
}
FORCEINLINE HRESULT IMimeAllocator_FreeThumbprint(IMimeAllocator* This,THUMBBLOB *pthumbprint) {
    return This->lpVtbl->FreeThumbprint(This,pthumbprint);
}
FORCEINLINE HRESULT IMimeAllocator_PropVariantClear(IMimeAllocator* This,LPPROPVARIANT pProp) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeObjResolver_QueryInterface(IMimeObjResolver* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeObjResolver_AddRef(IMimeObjResolver* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeObjResolver_Release(IMimeObjResolver* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IFontCache_QueryInterface(IFontCache* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IFontCache_AddRef(IFontCache* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IFontCache_Release(IFontCache* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IFontCacheNotify_QueryInterface(IFontCacheNotify* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IFontCacheNotify_AddRef(IFontCacheNotify* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IFontCacheNotify_Release(IFontCacheNotify* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeEditTag_QueryInterface(IMimeEditTag* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeEditTag_AddRef(IMimeEditTag* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeEditTag_Release(IMimeEditTag* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeEditTagCollection_QueryInterface(IMimeEditTagCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeEditTagCollection_AddRef(IMimeEditTagCollection* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeEditTagCollection_Release(IMimeEditTagCollection* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeSecurityCallback_QueryInterface(IMimeSecurityCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeSecurityCallback_AddRef(IMimeSecurityCallback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeSecurityCallback_Release(IMimeSecurityCallback* This) {
    return This->lpVtbl->Release(This);
}
#endif
#endif
