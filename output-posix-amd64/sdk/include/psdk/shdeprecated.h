/*** Autogenerated by WIDL <undefined version> from shdeprecated.idl - Do not edit ***/
...
FORCEINLINE HRESULT ITravelEntry_GetPidl(ITravelEntry* This,PIDLIST_ABSOLUTE *ppidl) {
...
FORCEINLINE HRESULT ITravelLog_FindTravelEntry(ITravelLog* This,IUnknown *punk,PCIDLIST_ABSOLUTE pidl,ITravelEntry **ppte) {
...
FORCEINLINE HRESULT IBrowserService2__NavigateToPidl(IBrowserService2* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF,DWORD dwFlags) {
    return This->lpVtbl->_NavigateToPidl(This,pidl,grfHLNF,dwFlags);
}
FORCEINLINE HRESULT IBrowserService2__TryShell2Rename(IBrowserService2* This,IShellView *psv,PCIDLIST_ABSOLUTE pidlNew) {
...
FORCEINLINE IStream * IBrowserService2_v_GetViewStream(IBrowserService2* This,PCIDLIST_ABSOLUTE pidl,DWORD grfMode,LPCWSTR pwszName) {
...
FORCEINLINE HRESULT IBrowserService2_v_CheckZoneCrossing(IBrowserService2* This,PCIDLIST_ABSOLUTE pidl) {
...
FORCEINLINE HRESULT IBrowserService3__NavigateToPidl(IBrowserService3* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF,DWORD dwFlags) {
    return This->lpVtbl->_NavigateToPidl(This,pidl,grfHLNF,dwFlags);
}
FORCEINLINE HRESULT IBrowserService3__TryShell2Rename(IBrowserService3* This,IShellView *psv,PCIDLIST_ABSOLUTE pidlNew) {
    return This->lpVtbl->_TryShell2Rename(This,psv,pidlNew);
}
...
FORCEINLINE IStream * IBrowserService3_v_GetViewStream(IBrowserService3* This,PCIDLIST_ABSOLUTE pidl,DWORD grfMode,LPCWSTR pwszName) {
    return This->lpVtbl->v_GetViewStream(This,pidl,grfMode,pwszName);
}
...
FORCEINLINE HRESULT IBrowserService3_v_CheckZoneCrossing(IBrowserService3* This,PCIDLIST_ABSOLUTE pidl) {
    return This->lpVtbl->v_CheckZoneCrossing(This,pidl);
}
/*** IBrowserService3 methods ***/
...
FORCEINLINE HRESULT IBrowserService3_IEParseDisplayNameEx(IBrowserService3* This,UINT uiCP,LPCWSTR pwszPath,DWORD dwFlags,PIDLIST_ABSOLUTE *ppidlOut) {
...
FORCEINLINE HRESULT IBrowserService4__NavigateToPidl(IBrowserService4* This,PCIDLIST_ABSOLUTE pidl,DWORD grfHLNF,DWORD dwFlags) {
    return This->lpVtbl->_NavigateToPidl(This,pidl,grfHLNF,dwFlags);
}
FORCEINLINE HRESULT IBrowserService4__TryShell2Rename(IBrowserService4* This,IShellView *psv,PCIDLIST_ABSOLUTE pidlNew) {
    return This->lpVtbl->_TryShell2Rename(This,psv,pidlNew);
}
...
FORCEINLINE IStream * IBrowserService4_v_GetViewStream(IBrowserService4* This,PCIDLIST_ABSOLUTE pidl,DWORD grfMode,LPCWSTR pwszName) {
    return This->lpVtbl->v_GetViewStream(This,pidl,grfMode,pwszName);
}
...
FORCEINLINE HRESULT IBrowserService4_v_CheckZoneCrossing(IBrowserService4* This,PCIDLIST_ABSOLUTE pidl) {
    return This->lpVtbl->v_CheckZoneCrossing(This,pidl);
}
/*** IBrowserService3 methods ***/
...
FORCEINLINE HRESULT IBrowserService4_IEParseDisplayNameEx(IBrowserService4* This,UINT uiCP,LPCWSTR pwszPath,DWORD dwFlags,PIDLIST_ABSOLUTE *ppidlOut) {
    return This->lpVtbl->IEParseDisplayNameEx(This,uiCP,pwszPath,dwFlags,ppidlOut);
}
/*** IBrowserService4 methods ***/
