/*** Autogenerated by WIDL <undefined version> from indexsrv.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IWordSink_QueryInterface(IWordSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IWordSink_AddRef(IWordSink* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IWordSink_Release(IWordSink* This) {
    return This->lpVtbl->Release(This);
}
/*** IWordSink methods ***/
FORCEINLINE HRESULT IWordSink_PutWord(IWordSink* This,ULONG cwc,const WCHAR *pwcInBuf,ULONG cwcSrcLen,ULONG cwcSrcPos) {
    return This->lpVtbl->PutWord(This,cwc,pwcInBuf,cwcSrcLen,cwcSrcPos);
}
FORCEINLINE HRESULT IWordSink_PutAltWord(IWordSink* This,ULONG cwc,const WCHAR *pwcInBuf,ULONG cwcSrcLen,ULONG cwcSrcPos) {
    return This->lpVtbl->PutAltWord(This,cwc,pwcInBuf,cwcSrcLen,cwcSrcPos);
}
FORCEINLINE HRESULT IWordSink_StartAltPhrase(IWordSink* This) {
    return This->lpVtbl->StartAltPhrase(This);
}
FORCEINLINE HRESULT IWordSink_EndAltPhrase(IWordSink* This) {
    return This->lpVtbl->EndAltPhrase(This);
}
FORCEINLINE HRESULT IWordSink_PutBreak(IWordSink* This,WORDREP_BREAK_TYPE breakType) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IPhraseSink_QueryInterface(IPhraseSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IPhraseSink_AddRef(IPhraseSink* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IPhraseSink_Release(IPhraseSink* This) {
    return This->lpVtbl->Release(This);
}
/*** IPhraseSink methods ***/
FORCEINLINE HRESULT IPhraseSink_PutSmallPhrase(IPhraseSink* This,const WCHAR *pwcNoun,ULONG cwcNoun,const WCHAR *pwcModifier,ULONG cwcModifier,ULONG ulAttachmentType) {
    return This->lpVtbl->PutSmallPhrase(This,pwcNoun,cwcNoun,pwcModifier,cwcModifier,ulAttachmentType);
}
FORCEINLINE HRESULT IPhraseSink_PutPhrase(IPhraseSink* This,const WCHAR *pwcPhrase,ULONG cwcPhrase) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IWordBreaker_QueryInterface(IWordBreaker* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IWordBreaker_AddRef(IWordBreaker* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IWordBreaker_Release(IWordBreaker* This) {
    return This->lpVtbl->Release(This);
}
/*** IWordBreaker methods ***/
FORCEINLINE HRESULT IWordBreaker_Init(IWordBreaker* This,BOOL fQuery,ULONG ulMaxTokenSize,BOOL *pfLicense) {
    return This->lpVtbl->Init(This,fQuery,ulMaxTokenSize,pfLicense);
}
FORCEINLINE HRESULT IWordBreaker_BreakText(IWordBreaker* This,TEXT_SOURCE *pTextSource,IWordSink *pWordSink,IPhraseSink *pPhraseSink) {
    return This->lpVtbl->BreakText(This,pTextSource,pWordSink,pPhraseSink);
}
FORCEINLINE HRESULT IWordBreaker_ComposePhrase(IWordBreaker* This,const WCHAR *pwcNoun,ULONG cwcNoun,const WCHAR *pwcModifier,ULONG cwcModifier,ULONG ulAttachmentType,WCHAR *pwcPhrase,ULONG *pcwcPhrase) {
    return This->lpVtbl->ComposePhrase(This,pwcNoun,cwcNoun,pwcModifier,cwcModifier,ulAttachmentType,pwcPhrase,pcwcPhrase);
}
FORCEINLINE HRESULT IWordBreaker_GetLicenseToUse(IWordBreaker* This,const WCHAR **ppwcsLicense) {
