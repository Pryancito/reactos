/*** Autogenerated by WIDL <undefined version> from cordebug.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugValue_QueryInterface(ICorDebugValue* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugValue_AddRef(ICorDebugValue* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugValue_Release(ICorDebugValue* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugValue methods ***/
FORCEINLINE HRESULT ICorDebugValue_GetType(ICorDebugValue* This,CorElementType *pType) {
    return This->lpVtbl->GetType(This,pType);
}
FORCEINLINE HRESULT ICorDebugValue_GetSize(ICorDebugValue* This,ULONG32 *pSize) {
    return This->lpVtbl->GetSize(This,pSize);
}
FORCEINLINE HRESULT ICorDebugValue_GetAddress(ICorDebugValue* This,CORDB_ADDRESS *pAddress) {
    return This->lpVtbl->GetAddress(This,pAddress);
}
FORCEINLINE HRESULT ICorDebugValue_CreateBreakpoint(ICorDebugValue* This,ICorDebugValueBreakpoint **ppBreakpoint) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugThread_QueryInterface(ICorDebugThread* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugThread_AddRef(ICorDebugThread* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugThread_Release(ICorDebugThread* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugThread methods ***/
FORCEINLINE HRESULT ICorDebugThread_GetProcess(ICorDebugThread* This,ICorDebugProcess **ppProcess) {
    return This->lpVtbl->GetProcess(This,ppProcess);
}
FORCEINLINE HRESULT ICorDebugThread_GetID(ICorDebugThread* This,DWORD *pdwThreadId) {
    return This->lpVtbl->GetID(This,pdwThreadId);
}
FORCEINLINE HRESULT ICorDebugThread_GetHandle(ICorDebugThread* This,HTHREAD *phThreadHandle) {
    return This->lpVtbl->GetHandle(This,phThreadHandle);
}
FORCEINLINE HRESULT ICorDebugThread_GetAppDomain(ICorDebugThread* This,ICorDebugAppDomain **ppAppDomain) {
    return This->lpVtbl->GetAppDomain(This,ppAppDomain);
}
FORCEINLINE HRESULT ICorDebugThread_SetDebugState(ICorDebugThread* This,CorDebugThreadState state) {
    return This->lpVtbl->SetDebugState(This,state);
}
FORCEINLINE HRESULT ICorDebugThread_GetDebugState(ICorDebugThread* This,CorDebugThreadState *pState) {
    return This->lpVtbl->GetDebugState(This,pState);
}
FORCEINLINE HRESULT ICorDebugThread_GetUserState(ICorDebugThread* This,CorDebugUserState *pState) {
    return This->lpVtbl->GetUserState(This,pState);
}
FORCEINLINE HRESULT ICorDebugThread_GetCurrentException(ICorDebugThread* This,ICorDebugValue **ppExceptionObject) {
    return This->lpVtbl->GetCurrentException(This,ppExceptionObject);
}
FORCEINLINE HRESULT ICorDebugThread_ClearCurrentException(ICorDebugThread* This) {
    return This->lpVtbl->ClearCurrentException(This);
}
FORCEINLINE HRESULT ICorDebugThread_CreateStepper(ICorDebugThread* This,ICorDebugStepper **ppStepper) {
    return This->lpVtbl->CreateStepper(This,ppStepper);
}
FORCEINLINE HRESULT ICorDebugThread_EnumerateChains(ICorDebugThread* This,ICorDebugChainEnum **ppChains) {
    return This->lpVtbl->EnumerateChains(This,ppChains);
}
FORCEINLINE HRESULT ICorDebugThread_GetActiveChain(ICorDebugThread* This,ICorDebugChain **ppChain) {
    return This->lpVtbl->GetActiveChain(This,ppChain);
}
FORCEINLINE HRESULT ICorDebugThread_GetActiveFrame(ICorDebugThread* This,ICorDebugFrame **ppFrame) {
    return This->lpVtbl->GetActiveFrame(This,ppFrame);
}
FORCEINLINE HRESULT ICorDebugThread_GetRegisterSet(ICorDebugThread* This,ICorDebugRegisterSet **ppRegisters) {
    return This->lpVtbl->GetRegisterSet(This,ppRegisters);
}
FORCEINLINE HRESULT ICorDebugThread_CreateEval(ICorDebugThread* This,ICorDebugEval **ppEval) {
    return This->lpVtbl->CreateEval(This,ppEval);
}
FORCEINLINE HRESULT ICorDebugThread_GetObject(ICorDebugThread* This,ICorDebugValue **ppObject) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugController_QueryInterface(ICorDebugController* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugController_AddRef(ICorDebugController* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugController_Release(ICorDebugController* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugController methods ***/
FORCEINLINE HRESULT ICorDebugController_Stop(ICorDebugController* This,DWORD dwTimeoutIgnored) {
    return This->lpVtbl->Stop(This,dwTimeoutIgnored);
}
FORCEINLINE HRESULT ICorDebugController_Continue(ICorDebugController* This,BOOL fIsOutOfBand) {
    return This->lpVtbl->Continue(This,fIsOutOfBand);
}
FORCEINLINE HRESULT ICorDebugController_IsRunning(ICorDebugController* This,BOOL *pbRunning) {
    return This->lpVtbl->IsRunning(This,pbRunning);
}
FORCEINLINE HRESULT ICorDebugController_HasQueuedCallbacks(ICorDebugController* This,ICorDebugThread *pThread,BOOL *pbQueued) {
    return This->lpVtbl->HasQueuedCallbacks(This,pThread,pbQueued);
}
FORCEINLINE HRESULT ICorDebugController_EnumerateThreads(ICorDebugController* This,ICorDebugThreadEnum **ppThreads) {
    return This->lpVtbl->EnumerateThreads(This,ppThreads);
}
FORCEINLINE HRESULT ICorDebugController_SetAllThreadsDebugState(ICorDebugController* This,CorDebugThreadState state,ICorDebugThread *pExceptThisThread) {
...
FORCEINLINE HRESULT ICorDebugController_Terminate(ICorDebugController* This,UINT exitCode) {
    return This->lpVtbl->Terminate(This,exitCode);
}
FORCEINLINE HRESULT ICorDebugController_CanCommitChanges(ICorDebugController* This,ULONG cSnapshots,ICorDebugEditAndContinueSnapshot * pSnapshots[],ICorDebugErrorInfoEnum **pError) {
    return This->lpVtbl->CanCommitChanges(This,cSnapshots,pSnapshots,pError);
}
FORCEINLINE HRESULT ICorDebugController_CommitChanges(ICorDebugController* This,ULONG cSnapshots,ICorDebugEditAndContinueSnapshot * pSnapshots[],ICorDebugErrorInfoEnum **pError) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugProcess_QueryInterface(ICorDebugProcess* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugProcess_AddRef(ICorDebugProcess* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugProcess_Release(ICorDebugProcess* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugController methods ***/
FORCEINLINE HRESULT ICorDebugProcess_Stop(ICorDebugProcess* This,DWORD dwTimeoutIgnored) {
    return This->lpVtbl->Stop(This,dwTimeoutIgnored);
}
FORCEINLINE HRESULT ICorDebugProcess_Continue(ICorDebugProcess* This,BOOL fIsOutOfBand) {
    return This->lpVtbl->Continue(This,fIsOutOfBand);
}
FORCEINLINE HRESULT ICorDebugProcess_IsRunning(ICorDebugProcess* This,BOOL *pbRunning) {
    return This->lpVtbl->IsRunning(This,pbRunning);
}
FORCEINLINE HRESULT ICorDebugProcess_HasQueuedCallbacks(ICorDebugProcess* This,ICorDebugThread *pThread,BOOL *pbQueued) {
    return This->lpVtbl->HasQueuedCallbacks(This,pThread,pbQueued);
}
FORCEINLINE HRESULT ICorDebugProcess_EnumerateThreads(ICorDebugProcess* This,ICorDebugThreadEnum **ppThreads) {
    return This->lpVtbl->EnumerateThreads(This,ppThreads);
}
FORCEINLINE HRESULT ICorDebugProcess_SetAllThreadsDebugState(ICorDebugProcess* This,CorDebugThreadState state,ICorDebugThread *pExceptThisThread) {
    return This->lpVtbl->SetAllThreadsDebugState(This,state,pExceptThisThread);
}
FORCEINLINE HRESULT ICorDebugProcess_Detach(ICorDebugProcess* This) {
    return This->lpVtbl->Detach(This);
}
FORCEINLINE HRESULT ICorDebugProcess_Terminate(ICorDebugProcess* This,UINT exitCode) {
    return This->lpVtbl->Terminate(This,exitCode);
}
FORCEINLINE HRESULT ICorDebugProcess_CanCommitChanges(ICorDebugProcess* This,ULONG cSnapshots,ICorDebugEditAndContinueSnapshot * pSnapshots[],ICorDebugErrorInfoEnum **pError) {
    return This->lpVtbl->CanCommitChanges(This,cSnapshots,pSnapshots,pError);
}
FORCEINLINE HRESULT ICorDebugProcess_CommitChanges(ICorDebugProcess* This,ULONG cSnapshots,ICorDebugEditAndContinueSnapshot * pSnapshots[],ICorDebugErrorInfoEnum **pError) {
    return This->lpVtbl->CommitChanges(This,cSnapshots,pSnapshots,pError);
}
/*** ICorDebugProcess methods ***/
FORCEINLINE HRESULT ICorDebugProcess_GetID(ICorDebugProcess* This,DWORD *pdwProcessId) {
    return This->lpVtbl->GetID(This,pdwProcessId);
}
FORCEINLINE HRESULT ICorDebugProcess_GetHandle(ICorDebugProcess* This,HPROCESS *phProcessHandle) {
    return This->lpVtbl->GetHandle(This,phProcessHandle);
}
FORCEINLINE HRESULT ICorDebugProcess_GetThread(ICorDebugProcess* This,DWORD dwThreadId,ICorDebugThread **ppThread) {
    return This->lpVtbl->GetThread(This,dwThreadId,ppThread);
}
FORCEINLINE HRESULT ICorDebugProcess_EnumerateObjects(ICorDebugProcess* This,ICorDebugObjectEnum **ppObjects) {
    return This->lpVtbl->EnumerateObjects(This,ppObjects);
}
FORCEINLINE HRESULT ICorDebugProcess_IsTransitionStub(ICorDebugProcess* This,CORDB_ADDRESS address,BOOL *pbTransitionStub) {
    return This->lpVtbl->IsTransitionStub(This,address,pbTransitionStub);
}
FORCEINLINE HRESULT ICorDebugProcess_IsOSSuspended(ICorDebugProcess* This,DWORD threadID,BOOL *pbSuspended) {
    return This->lpVtbl->IsOSSuspended(This,threadID,pbSuspended);
}
FORCEINLINE HRESULT ICorDebugProcess_GetThreadContext(ICorDebugProcess* This,DWORD threadID,ULONG32 contextSize,BYTE context[]) {
    return This->lpVtbl->GetThreadContext(This,threadID,contextSize,context);
}
FORCEINLINE HRESULT ICorDebugProcess_SetThreadContext(ICorDebugProcess* This,DWORD threadID,ULONG32 contextSize,BYTE context[]) {
    return This->lpVtbl->SetThreadContext(This,threadID,contextSize,context);
}
FORCEINLINE HRESULT ICorDebugProcess_ReadMemory(ICorDebugProcess* This,CORDB_ADDRESS address,DWORD size,BYTE buffer[],SIZE_T *read) {
    return This->lpVtbl->ReadMemory(This,address,size,buffer,read);
}
FORCEINLINE HRESULT ICorDebugProcess_WriteMemory(ICorDebugProcess* This,CORDB_ADDRESS address,DWORD size,BYTE buffer[],SIZE_T *written) {
    return This->lpVtbl->WriteMemory(This,address,size,buffer,written);
}
FORCEINLINE HRESULT ICorDebugProcess_ClearCurrentException(ICorDebugProcess* This,DWORD threadID) {
    return This->lpVtbl->ClearCurrentException(This,threadID);
}
FORCEINLINE HRESULT ICorDebugProcess_EnableLogMessages(ICorDebugProcess* This,BOOL fOnOff) {
    return This->lpVtbl->EnableLogMessages(This,fOnOff);
}
FORCEINLINE HRESULT ICorDebugProcess_ModifyLogSwitch(ICorDebugProcess* This,WCHAR *pLogSwitchName,LONG lLevel) {
    return This->lpVtbl->ModifyLogSwitch(This,pLogSwitchName,lLevel);
}
FORCEINLINE HRESULT ICorDebugProcess_EnumerateAppDomains(ICorDebugProcess* This,ICorDebugAppDomainEnum **ppAppDomains) {
    return This->lpVtbl->EnumerateAppDomains(This,ppAppDomains);
}
FORCEINLINE HRESULT ICorDebugProcess_GetObject(ICorDebugProcess* This,ICorDebugValue **ppObject) {
    return This->lpVtbl->GetObject(This,ppObject);
}
FORCEINLINE HRESULT ICorDebugProcess_ThreadForFiberCookie(ICorDebugProcess* This,DWORD fiberCookie,ICorDebugThread **ppThread) {
    return This->lpVtbl->ThreadForFiberCookie(This,fiberCookie,ppThread);
}
FORCEINLINE HRESULT ICorDebugProcess_GetHelperThreadID(ICorDebugProcess* This,DWORD *pThreadID) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugAppDomain_QueryInterface(ICorDebugAppDomain* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugAppDomain_AddRef(ICorDebugAppDomain* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugAppDomain_Release(ICorDebugAppDomain* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugController methods ***/
FORCEINLINE HRESULT ICorDebugAppDomain_Stop(ICorDebugAppDomain* This,DWORD dwTimeoutIgnored) {
    return This->lpVtbl->Stop(This,dwTimeoutIgnored);
}
FORCEINLINE HRESULT ICorDebugAppDomain_Continue(ICorDebugAppDomain* This,BOOL fIsOutOfBand) {
    return This->lpVtbl->Continue(This,fIsOutOfBand);
}
FORCEINLINE HRESULT ICorDebugAppDomain_IsRunning(ICorDebugAppDomain* This,BOOL *pbRunning) {
    return This->lpVtbl->IsRunning(This,pbRunning);
}
FORCEINLINE HRESULT ICorDebugAppDomain_HasQueuedCallbacks(ICorDebugAppDomain* This,ICorDebugThread *pThread,BOOL *pbQueued) {
    return This->lpVtbl->HasQueuedCallbacks(This,pThread,pbQueued);
}
FORCEINLINE HRESULT ICorDebugAppDomain_EnumerateThreads(ICorDebugAppDomain* This,ICorDebugThreadEnum **ppThreads) {
    return This->lpVtbl->EnumerateThreads(This,ppThreads);
}
FORCEINLINE HRESULT ICorDebugAppDomain_SetAllThreadsDebugState(ICorDebugAppDomain* This,CorDebugThreadState state,ICorDebugThread *pExceptThisThread) {
    return This->lpVtbl->SetAllThreadsDebugState(This,state,pExceptThisThread);
}
FORCEINLINE HRESULT ICorDebugAppDomain_Detach(ICorDebugAppDomain* This) {
    return This->lpVtbl->Detach(This);
}
FORCEINLINE HRESULT ICorDebugAppDomain_Terminate(ICorDebugAppDomain* This,UINT exitCode) {
    return This->lpVtbl->Terminate(This,exitCode);
}
FORCEINLINE HRESULT ICorDebugAppDomain_CanCommitChanges(ICorDebugAppDomain* This,ULONG cSnapshots,ICorDebugEditAndContinueSnapshot * pSnapshots[],ICorDebugErrorInfoEnum **pError) {
    return This->lpVtbl->CanCommitChanges(This,cSnapshots,pSnapshots,pError);
}
FORCEINLINE HRESULT ICorDebugAppDomain_CommitChanges(ICorDebugAppDomain* This,ULONG cSnapshots,ICorDebugEditAndContinueSnapshot * pSnapshots[],ICorDebugErrorInfoEnum **pError) {
    return This->lpVtbl->CommitChanges(This,cSnapshots,pSnapshots,pError);
}
/*** ICorDebugAppDomain methods ***/
FORCEINLINE HRESULT ICorDebugAppDomain_GetProcess(ICorDebugAppDomain* This,ICorDebugProcess **ppProcess) {
    return This->lpVtbl->GetProcess(This,ppProcess);
}
FORCEINLINE HRESULT ICorDebugAppDomain_EnumerateAssemblies(ICorDebugAppDomain* This,ICorDebugAssemblyEnum **ppAssemblies) {
    return This->lpVtbl->EnumerateAssemblies(This,ppAssemblies);
}
FORCEINLINE HRESULT ICorDebugAppDomain_GetModuleFromMetaDataInterface(ICorDebugAppDomain* This,IUnknown *pIMetaData,ICorDebugModule **ppModule) {
    return This->lpVtbl->GetModuleFromMetaDataInterface(This,pIMetaData,ppModule);
}
FORCEINLINE HRESULT ICorDebugAppDomain_EnumerateBreakpoints(ICorDebugAppDomain* This,ICorDebugBreakpointEnum **ppBreakpoints) {
    return This->lpVtbl->EnumerateBreakpoints(This,ppBreakpoints);
}
FORCEINLINE HRESULT ICorDebugAppDomain_EnumerateSteppers(ICorDebugAppDomain* This,ICorDebugStepperEnum **ppSteppers) {
    return This->lpVtbl->EnumerateSteppers(This,ppSteppers);
}
FORCEINLINE HRESULT ICorDebugAppDomain_IsAttached(ICorDebugAppDomain* This,BOOL *pbAttached) {
    return This->lpVtbl->IsAttached(This,pbAttached);
}
FORCEINLINE HRESULT ICorDebugAppDomain_GetName(ICorDebugAppDomain* This,ULONG32 cchName,ULONG32 *pcchName,WCHAR szName[]) {
    return This->lpVtbl->GetName(This,cchName,pcchName,szName);
}
FORCEINLINE HRESULT ICorDebugAppDomain_GetObject(ICorDebugAppDomain* This,ICorDebugValue **ppObject) {
    return This->lpVtbl->GetObject(This,ppObject);
}
FORCEINLINE HRESULT ICorDebugAppDomain_Attach(ICorDebugAppDomain* This) {
    return This->lpVtbl->Attach(This);
}
FORCEINLINE HRESULT ICorDebugAppDomain_GetID(ICorDebugAppDomain* This,ULONG32 *pId) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugManagedCallback_QueryInterface(ICorDebugManagedCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugManagedCallback_AddRef(ICorDebugManagedCallback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugManagedCallback_Release(ICorDebugManagedCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugManagedCallback methods ***/
FORCEINLINE HRESULT ICorDebugManagedCallback_Breakpoint(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,ICorDebugBreakpoint *pBreakpoint) {
    return This->lpVtbl->Breakpoint(This,pAppDomain,pThread,pBreakpoint);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_StepComplete(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,ICorDebugStepper *pStepper,CorDebugStepReason reason) {
    return This->lpVtbl->StepComplete(This,pAppDomain,pThread,pStepper,reason);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_Break(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *thread) {
    return This->lpVtbl->Break(This,pAppDomain,thread);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_Exception(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,BOOL unhandled) {
    return This->lpVtbl->Exception(This,pAppDomain,pThread,unhandled);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_EvalComplete(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,ICorDebugEval *pEval) {
    return This->lpVtbl->EvalComplete(This,pAppDomain,pThread,pEval);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_EvalException(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,ICorDebugEval *pEval) {
    return This->lpVtbl->EvalException(This,pAppDomain,pThread,pEval);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_CreateProcess(ICorDebugManagedCallback* This,ICorDebugProcess *pProcess) {
    return This->lpVtbl->CreateProcess(This,pProcess);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_ExitProcess(ICorDebugManagedCallback* This,ICorDebugProcess *pProcess) {
    return This->lpVtbl->ExitProcess(This,pProcess);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_CreateThread(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *thread) {
    return This->lpVtbl->CreateThread(This,pAppDomain,thread);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_ExitThread(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *thread) {
    return This->lpVtbl->ExitThread(This,pAppDomain,thread);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_LoadModule(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugModule *pModule) {
    return This->lpVtbl->LoadModule(This,pAppDomain,pModule);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_UnloadModule(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugModule *pModule) {
    return This->lpVtbl->UnloadModule(This,pAppDomain,pModule);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_LoadClass(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugClass *c) {
    return This->lpVtbl->LoadClass(This,pAppDomain,c);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_UnloadClass(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugClass *c) {
    return This->lpVtbl->UnloadClass(This,pAppDomain,c);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_DebuggerError(ICorDebugManagedCallback* This,ICorDebugProcess *pProcess,HRESULT errorHR,DWORD errorCode) {
    return This->lpVtbl->DebuggerError(This,pProcess,errorHR,errorCode);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_LogMessage(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,LONG lLevel,WCHAR *pLogSwitchName,WCHAR *pMessage) {
    return This->lpVtbl->LogMessage(This,pAppDomain,pThread,lLevel,pLogSwitchName,pMessage);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_LogSwitch(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,LONG lLevel,ULONG ulReason,WCHAR *pLogSwitchName,WCHAR *pParentName) {
    return This->lpVtbl->LogSwitch(This,pAppDomain,pThread,lLevel,ulReason,pLogSwitchName,pParentName);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_CreateAppDomain(ICorDebugManagedCallback* This,ICorDebugProcess *pProcess,ICorDebugAppDomain *pAppDomain) {
    return This->lpVtbl->CreateAppDomain(This,pProcess,pAppDomain);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_ExitAppDomain(ICorDebugManagedCallback* This,ICorDebugProcess *pProcess,ICorDebugAppDomain *pAppDomain) {
    return This->lpVtbl->ExitAppDomain(This,pProcess,pAppDomain);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_LoadAssembly(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugAssembly *pAssembly) {
    return This->lpVtbl->LoadAssembly(This,pAppDomain,pAssembly);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_UnloadAssembly(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugAssembly *pAssembly) {
    return This->lpVtbl->UnloadAssembly(This,pAppDomain,pAssembly);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_ControlCTrap(ICorDebugManagedCallback* This,ICorDebugProcess *pProcess) {
    return This->lpVtbl->ControlCTrap(This,pProcess);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_NameChange(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread) {
    return This->lpVtbl->NameChange(This,pAppDomain,pThread);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_UpdateModuleSymbols(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugModule *pModule,IStream *pSymbolStream) {
    return This->lpVtbl->UpdateModuleSymbols(This,pAppDomain,pModule,pSymbolStream);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_EditAndContinueRemap(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,ICorDebugFunction *pFunction,BOOL fAccurate) {
    return This->lpVtbl->EditAndContinueRemap(This,pAppDomain,pThread,pFunction,fAccurate);
}
FORCEINLINE HRESULT ICorDebugManagedCallback_BreakpointSetError(ICorDebugManagedCallback* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,ICorDebugBreakpoint *pBreakpoint,DWORD dwError) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugManagedCallback2_QueryInterface(ICorDebugManagedCallback2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugManagedCallback2_AddRef(ICorDebugManagedCallback2* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugManagedCallback2_Release(ICorDebugManagedCallback2* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugManagedCallback2 methods ***/
FORCEINLINE HRESULT ICorDebugManagedCallback2_FunctionRemapOpportunity(ICorDebugManagedCallback2* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,ICorDebugFunction *pOldFunction,ICorDebugFunction *pNewFunction,ULONG32 oldILOffset) {
    return This->lpVtbl->FunctionRemapOpportunity(This,pAppDomain,pThread,pOldFunction,pNewFunction,oldILOffset);
}
FORCEINLINE HRESULT ICorDebugManagedCallback2_CreateConnection(ICorDebugManagedCallback2* This,ICorDebugProcess *pProcess,CONNID dwConnectionId,WCHAR *pConnName) {
    return This->lpVtbl->CreateConnection(This,pProcess,dwConnectionId,pConnName);
}
FORCEINLINE HRESULT ICorDebugManagedCallback2_ChangeConnection(ICorDebugManagedCallback2* This,ICorDebugProcess *pProcess,CONNID dwConnectionId) {
    return This->lpVtbl->ChangeConnection(This,pProcess,dwConnectionId);
}
FORCEINLINE HRESULT ICorDebugManagedCallback2_DestroyConnection(ICorDebugManagedCallback2* This,ICorDebugProcess *pProcess,CONNID dwConnectionId) {
    return This->lpVtbl->DestroyConnection(This,pProcess,dwConnectionId);
}
FORCEINLINE HRESULT ICorDebugManagedCallback2_Exception(ICorDebugManagedCallback2* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,ICorDebugFrame *pFrame,ULONG32 nOffset,CorDebugExceptionCallbackType dwEventType,DWORD dwFlags) {
    return This->lpVtbl->Exception(This,pAppDomain,pThread,pFrame,nOffset,dwEventType,dwFlags);
}
FORCEINLINE HRESULT ICorDebugManagedCallback2_ExceptionUnwind(ICorDebugManagedCallback2* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,CorDebugExceptionUnwindCallbackType dwEventType,DWORD dwFlags) {
    return This->lpVtbl->ExceptionUnwind(This,pAppDomain,pThread,dwEventType,dwFlags);
}
FORCEINLINE HRESULT ICorDebugManagedCallback2_FunctionRemapComplete(ICorDebugManagedCallback2* This,ICorDebugAppDomain *pAppDomain,ICorDebugThread *pThread,ICorDebugFunction *pFunction) {
    return This->lpVtbl->FunctionRemapComplete(This,pAppDomain,pThread,pFunction);
}
FORCEINLINE HRESULT ICorDebugManagedCallback2_MDANotification(ICorDebugManagedCallback2* This,ICorDebugController *pController,ICorDebugThread *pThread,ICorDebugMDA *pMDA) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebug_QueryInterface(ICorDebug* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebug_AddRef(ICorDebug* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebug_Release(ICorDebug* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebug methods ***/
FORCEINLINE HRESULT ICorDebug_Initialize(ICorDebug* This) {
    return This->lpVtbl->Initialize(This);
}
FORCEINLINE HRESULT ICorDebug_Terminate(ICorDebug* This) {
    return This->lpVtbl->Terminate(This);
}
FORCEINLINE HRESULT ICorDebug_SetManagedHandler(ICorDebug* This,ICorDebugManagedCallback *pCallback) {
    return This->lpVtbl->SetManagedHandler(This,pCallback);
}
FORCEINLINE HRESULT ICorDebug_SetUnmanagedHandler(ICorDebug* This,ICorDebugUnmanagedCallback *pCallback) {
    return This->lpVtbl->SetUnmanagedHandler(This,pCallback);
}
FORCEINLINE HRESULT ICorDebug_CreateProcess(ICorDebug* This,LPCWSTR lpApplicationName,LPWSTR lpCommandLine,LPSECURITY_ATTRIBUTES lpProcessAttributes,LPSECURITY_ATTRIBUTES lpThreadAttributes,BOOL bInheritHandles,DWORD dwCreationFlags,PVOID lpEnvironment,LPCWSTR lpCurrentDirectory,LPSTARTUPINFOW lpStartupInfo,LPPROCESS_INFORMATION lpProcessInformation,CorDebugCreateProcessFlags debuggingFlags,ICorDebugProcess **ppProcess) {
...
FORCEINLINE HRESULT ICorDebug_DebugActiveProcess(ICorDebug* This,DWORD id,BOOL win32Attach,ICorDebugProcess **ppProcess) {
    return This->lpVtbl->DebugActiveProcess(This,id,win32Attach,ppProcess);
}
FORCEINLINE HRESULT ICorDebug_EnumerateProcesses(ICorDebug* This,ICorDebugProcessEnum **ppProcess) {
    return This->lpVtbl->EnumerateProcesses(This,ppProcess);
}
FORCEINLINE HRESULT ICorDebug_GetProcess(ICorDebug* This,DWORD dwProcessId,ICorDebugProcess **ppProcess) {
    return This->lpVtbl->GetProcess(This,dwProcessId,ppProcess);
}
FORCEINLINE HRESULT ICorDebug_CanLaunchOrAttach(ICorDebug* This,DWORD dwProcessId,BOOL win32DebuggingEnabled) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugBreakpoint_QueryInterface(ICorDebugBreakpoint* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugBreakpoint_AddRef(ICorDebugBreakpoint* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugBreakpoint_Release(ICorDebugBreakpoint* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugBreakpoint methods ***/
FORCEINLINE HRESULT ICorDebugBreakpoint_Activate(ICorDebugBreakpoint* This,BOOL bActive) {
    return This->lpVtbl->Activate(This,bActive);
}
FORCEINLINE HRESULT ICorDebugBreakpoint_IsActive(ICorDebugBreakpoint* This,BOOL *pbActive) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugFunctionBreakpoint_QueryInterface(ICorDebugFunctionBreakpoint* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugFunctionBreakpoint_AddRef(ICorDebugFunctionBreakpoint* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugFunctionBreakpoint_Release(ICorDebugFunctionBreakpoint* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugBreakpoint methods ***/
FORCEINLINE HRESULT ICorDebugFunctionBreakpoint_Activate(ICorDebugFunctionBreakpoint* This,BOOL bActive) {
    return This->lpVtbl->Activate(This,bActive);
}
FORCEINLINE HRESULT ICorDebugFunctionBreakpoint_IsActive(ICorDebugFunctionBreakpoint* This,BOOL *pbActive) {
    return This->lpVtbl->IsActive(This,pbActive);
}
/*** ICorDebugFunctionBreakpoint methods ***/
FORCEINLINE HRESULT ICorDebugFunctionBreakpoint_GetFunction(ICorDebugFunctionBreakpoint* This,ICorDebugFunction **ppFunction) {
    return This->lpVtbl->GetFunction(This,ppFunction);
}
FORCEINLINE HRESULT ICorDebugFunctionBreakpoint_GetOffset(ICorDebugFunctionBreakpoint* This,ULONG32 *pnOffset) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugModuleBreakpoint_QueryInterface(ICorDebugModuleBreakpoint* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugModuleBreakpoint_AddRef(ICorDebugModuleBreakpoint* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugModuleBreakpoint_Release(ICorDebugModuleBreakpoint* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugBreakpoint methods ***/
FORCEINLINE HRESULT ICorDebugModuleBreakpoint_Activate(ICorDebugModuleBreakpoint* This,BOOL bActive) {
    return This->lpVtbl->Activate(This,bActive);
}
FORCEINLINE HRESULT ICorDebugModuleBreakpoint_IsActive(ICorDebugModuleBreakpoint* This,BOOL *pbActive) {
    return This->lpVtbl->IsActive(This,pbActive);
}
/*** ICorDebugModuleBreakpoint methods ***/
FORCEINLINE HRESULT ICorDebugModuleBreakpoint_GetModule(ICorDebugModuleBreakpoint* This,ICorDebugModule **ppModule) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugValueBreakpoint_QueryInterface(ICorDebugValueBreakpoint* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugValueBreakpoint_AddRef(ICorDebugValueBreakpoint* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugValueBreakpoint_Release(ICorDebugValueBreakpoint* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugBreakpoint methods ***/
FORCEINLINE HRESULT ICorDebugValueBreakpoint_Activate(ICorDebugValueBreakpoint* This,BOOL bActive) {
    return This->lpVtbl->Activate(This,bActive);
}
FORCEINLINE HRESULT ICorDebugValueBreakpoint_IsActive(ICorDebugValueBreakpoint* This,BOOL *pbActive) {
    return This->lpVtbl->IsActive(This,pbActive);
}
/*** ICorDebugValueBreakpoint methods ***/
FORCEINLINE HRESULT ICorDebugValueBreakpoint_GetValue(ICorDebugValueBreakpoint* This,ICorDebugValue **ppValue) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugStepper_QueryInterface(ICorDebugStepper* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugStepper_AddRef(ICorDebugStepper* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugStepper_Release(ICorDebugStepper* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugStepper methods ***/
FORCEINLINE HRESULT ICorDebugStepper_IsActive(ICorDebugStepper* This,BOOL *pbActive) {
    return This->lpVtbl->IsActive(This,pbActive);
}
FORCEINLINE HRESULT ICorDebugStepper_Deactivate(ICorDebugStepper* This) {
    return This->lpVtbl->Deactivate(This);
}
FORCEINLINE HRESULT ICorDebugStepper_SetInterceptMask(ICorDebugStepper* This,CorDebugIntercept mask) {
    return This->lpVtbl->SetInterceptMask(This,mask);
}
FORCEINLINE HRESULT ICorDebugStepper_SetUnmappedStopMask(ICorDebugStepper* This,CorDebugUnmappedStop mask) {
    return This->lpVtbl->SetUnmappedStopMask(This,mask);
}
FORCEINLINE HRESULT ICorDebugStepper_Step(ICorDebugStepper* This,BOOL bStepIn) {
    return This->lpVtbl->Step(This,bStepIn);
}
FORCEINLINE HRESULT ICorDebugStepper_StepRange(ICorDebugStepper* This,BOOL bStepIn,COR_DEBUG_STEP_RANGE ranges[],ULONG32 cRangeCount) {
    return This->lpVtbl->StepRange(This,bStepIn,ranges,cRangeCount);
}
FORCEINLINE HRESULT ICorDebugStepper_StepOut(ICorDebugStepper* This) {
    return This->lpVtbl->StepOut(This);
}
FORCEINLINE HRESULT ICorDebugStepper_SetRangeIL(ICorDebugStepper* This,BOOL bIL) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugEnum_QueryInterface(ICorDebugEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugEnum_AddRef(ICorDebugEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugEnum_Release(ICorDebugEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugEnum_Skip(ICorDebugEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugEnum_Reset(ICorDebugEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugEnum_Clone(ICorDebugEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugEnum_GetCount(ICorDebugEnum* This,ULONG *pcelt) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugAppDomainEnum_QueryInterface(ICorDebugAppDomainEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugAppDomainEnum_AddRef(ICorDebugAppDomainEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugAppDomainEnum_Release(ICorDebugAppDomainEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugAppDomainEnum_Skip(ICorDebugAppDomainEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugAppDomainEnum_Reset(ICorDebugAppDomainEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugAppDomainEnum_Clone(ICorDebugAppDomainEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugAppDomainEnum_GetCount(ICorDebugAppDomainEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugAppDomainEnum methods ***/
FORCEINLINE HRESULT ICorDebugAppDomainEnum_Next(ICorDebugAppDomainEnum* This,ULONG celt,ICorDebugAppDomain * values[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugAssemblyEnum_QueryInterface(ICorDebugAssemblyEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugAssemblyEnum_AddRef(ICorDebugAssemblyEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugAssemblyEnum_Release(ICorDebugAssemblyEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugAssemblyEnum_Skip(ICorDebugAssemblyEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugAssemblyEnum_Reset(ICorDebugAssemblyEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugAssemblyEnum_Clone(ICorDebugAssemblyEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugAssemblyEnum_GetCount(ICorDebugAssemblyEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugAssemblyEnum methods ***/
FORCEINLINE HRESULT ICorDebugAssemblyEnum_Next(ICorDebugAssemblyEnum* This,ULONG celt,ICorDebugAssembly * values[],ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,values,pceltFetched);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugBreakpointEnum_QueryInterface(ICorDebugBreakpointEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugBreakpointEnum_AddRef(ICorDebugBreakpointEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugBreakpointEnum_Release(ICorDebugBreakpointEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugBreakpointEnum_Skip(ICorDebugBreakpointEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugBreakpointEnum_Reset(ICorDebugBreakpointEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugBreakpointEnum_Clone(ICorDebugBreakpointEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugBreakpointEnum_GetCount(ICorDebugBreakpointEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugBreakpointEnum methods ***/
FORCEINLINE HRESULT ICorDebugBreakpointEnum_Next(ICorDebugBreakpointEnum* This,ULONG celt,ICorDebugBreakpoint * breakpoints[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugChainEnum_QueryInterface(ICorDebugChainEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugChainEnum_AddRef(ICorDebugChainEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugChainEnum_Release(ICorDebugChainEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugChainEnum_Skip(ICorDebugChainEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugChainEnum_Reset(ICorDebugChainEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugChainEnum_Clone(ICorDebugChainEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugChainEnum_GetCount(ICorDebugChainEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugChainEnum methods ***/
FORCEINLINE HRESULT ICorDebugChainEnum_Next(ICorDebugChainEnum* This,ULONG celt,ICorDebugChain * chains[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugErrorInfoEnum_QueryInterface(ICorDebugErrorInfoEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugErrorInfoEnum_AddRef(ICorDebugErrorInfoEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugErrorInfoEnum_Release(ICorDebugErrorInfoEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugErrorInfoEnum_Skip(ICorDebugErrorInfoEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugErrorInfoEnum_Reset(ICorDebugErrorInfoEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugErrorInfoEnum_Clone(ICorDebugErrorInfoEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugErrorInfoEnum_GetCount(ICorDebugErrorInfoEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugErrorInfoEnum methods ***/
FORCEINLINE HRESULT ICorDebugErrorInfoEnum_Next(ICorDebugErrorInfoEnum* This,ULONG celt,ICorDebugEditAndContinueErrorInfo * errors[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugFrameEnum_QueryInterface(ICorDebugFrameEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugFrameEnum_AddRef(ICorDebugFrameEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugFrameEnum_Release(ICorDebugFrameEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugFrameEnum_Skip(ICorDebugFrameEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugFrameEnum_Reset(ICorDebugFrameEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugFrameEnum_Clone(ICorDebugFrameEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugFrameEnum_GetCount(ICorDebugFrameEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugFrameEnum methods ***/
FORCEINLINE HRESULT ICorDebugFrameEnum_Next(ICorDebugFrameEnum* This,ULONG celt,ICorDebugFrame * frames[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugModuleEnum_QueryInterface(ICorDebugModuleEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugModuleEnum_AddRef(ICorDebugModuleEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugModuleEnum_Release(ICorDebugModuleEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugModuleEnum_Skip(ICorDebugModuleEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugModuleEnum_Reset(ICorDebugModuleEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugModuleEnum_Clone(ICorDebugModuleEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugModuleEnum_GetCount(ICorDebugModuleEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugModuleEnum methods ***/
FORCEINLINE HRESULT ICorDebugModuleEnum_Next(ICorDebugModuleEnum* This,ULONG celt,ICorDebugModule * modules[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugObjectEnum_QueryInterface(ICorDebugObjectEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugObjectEnum_AddRef(ICorDebugObjectEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugObjectEnum_Release(ICorDebugObjectEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugObjectEnum_Skip(ICorDebugObjectEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugObjectEnum_Reset(ICorDebugObjectEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugObjectEnum_Clone(ICorDebugObjectEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugObjectEnum_GetCount(ICorDebugObjectEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugObjectEnum methods ***/
FORCEINLINE HRESULT ICorDebugObjectEnum_Next(ICorDebugObjectEnum* This,ULONG celt,CORDB_ADDRESS objects[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugProcessEnum_QueryInterface(ICorDebugProcessEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugProcessEnum_AddRef(ICorDebugProcessEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugProcessEnum_Release(ICorDebugProcessEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugProcessEnum_Skip(ICorDebugProcessEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugProcessEnum_Reset(ICorDebugProcessEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugProcessEnum_Clone(ICorDebugProcessEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugProcessEnum_GetCount(ICorDebugProcessEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugProcessEnum methods ***/
FORCEINLINE HRESULT ICorDebugProcessEnum_Next(ICorDebugProcessEnum* This,ULONG celt,ICorDebugProcess * processes[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugStepperEnum_QueryInterface(ICorDebugStepperEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugStepperEnum_AddRef(ICorDebugStepperEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugStepperEnum_Release(ICorDebugStepperEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugStepperEnum_Skip(ICorDebugStepperEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugStepperEnum_Reset(ICorDebugStepperEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugStepperEnum_Clone(ICorDebugStepperEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugStepperEnum_GetCount(ICorDebugStepperEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugStepperEnum methods ***/
FORCEINLINE HRESULT ICorDebugStepperEnum_Next(ICorDebugStepperEnum* This,ULONG celt,ICorDebugStepper * steppers[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugThreadEnum_QueryInterface(ICorDebugThreadEnum* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugThreadEnum_AddRef(ICorDebugThreadEnum* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugThreadEnum_Release(ICorDebugThreadEnum* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEnum methods ***/
FORCEINLINE HRESULT ICorDebugThreadEnum_Skip(ICorDebugThreadEnum* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT ICorDebugThreadEnum_Reset(ICorDebugThreadEnum* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT ICorDebugThreadEnum_Clone(ICorDebugThreadEnum* This,ICorDebugEnum **ppEnum) {
    return This->lpVtbl->Clone(This,ppEnum);
}
FORCEINLINE HRESULT ICorDebugThreadEnum_GetCount(ICorDebugThreadEnum* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
/*** ICorDebugThreadEnum methods ***/
FORCEINLINE HRESULT ICorDebugThreadEnum_Next(ICorDebugThreadEnum* This,ULONG celt,ICorDebugThread * threads[],ULONG *pceltFetched) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugChain_QueryInterface(ICorDebugChain* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugChain_AddRef(ICorDebugChain* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugChain_Release(ICorDebugChain* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugChain methods ***/
FORCEINLINE HRESULT ICorDebugChain_GetThread(ICorDebugChain* This,ICorDebugThread **ppThread) {
    return This->lpVtbl->GetThread(This,ppThread);
}
FORCEINLINE HRESULT ICorDebugChain_GetStackRange(ICorDebugChain* This,CORDB_ADDRESS *pStart,CORDB_ADDRESS *pEnd) {
    return This->lpVtbl->GetStackRange(This,pStart,pEnd);
}
FORCEINLINE HRESULT ICorDebugChain_GetContext(ICorDebugChain* This,ICorDebugContext **ppContext) {
    return This->lpVtbl->GetContext(This,ppContext);
}
FORCEINLINE HRESULT ICorDebugChain_GetCaller(ICorDebugChain* This,ICorDebugChain **ppChain) {
    return This->lpVtbl->GetCaller(This,ppChain);
}
FORCEINLINE HRESULT ICorDebugChain_GetCallee(ICorDebugChain* This,ICorDebugChain **ppChain) {
    return This->lpVtbl->GetCallee(This,ppChain);
}
FORCEINLINE HRESULT ICorDebugChain_GetPrevious(ICorDebugChain* This,ICorDebugChain **ppChain) {
    return This->lpVtbl->GetPrevious(This,ppChain);
}
FORCEINLINE HRESULT ICorDebugChain_GetNext(ICorDebugChain* This,ICorDebugChain **ppChain) {
    return This->lpVtbl->GetNext(This,ppChain);
}
FORCEINLINE HRESULT ICorDebugChain_IsManaged(ICorDebugChain* This,BOOL *pManaged) {
    return This->lpVtbl->IsManaged(This,pManaged);
}
FORCEINLINE HRESULT ICorDebugChain_EnumerateFrames(ICorDebugChain* This,ICorDebugFrameEnum **ppFrames) {
    return This->lpVtbl->EnumerateFrames(This,ppFrames);
}
FORCEINLINE HRESULT ICorDebugChain_GetActiveFrame(ICorDebugChain* This,ICorDebugFrame **ppFrame) {
    return This->lpVtbl->GetActiveFrame(This,ppFrame);
}
FORCEINLINE HRESULT ICorDebugChain_GetRegisterSet(ICorDebugChain* This,ICorDebugRegisterSet **ppRegisters) {
    return This->lpVtbl->GetRegisterSet(This,ppRegisters);
}
FORCEINLINE HRESULT ICorDebugChain_GetReason(ICorDebugChain* This,CorDebugChainReason *pReason) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugFrame_QueryInterface(ICorDebugFrame* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugFrame_AddRef(ICorDebugFrame* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugFrame_Release(ICorDebugFrame* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugFrame methods ***/
FORCEINLINE HRESULT ICorDebugFrame_GetChain(ICorDebugFrame* This,ICorDebugChain **ppChain) {
    return This->lpVtbl->GetChain(This,ppChain);
}
FORCEINLINE HRESULT ICorDebugFrame_GetCode(ICorDebugFrame* This,ICorDebugCode **ppCode) {
    return This->lpVtbl->GetCode(This,ppCode);
}
FORCEINLINE HRESULT ICorDebugFrame_GetFunction(ICorDebugFrame* This,ICorDebugFunction **ppFunction) {
    return This->lpVtbl->GetFunction(This,ppFunction);
}
FORCEINLINE HRESULT ICorDebugFrame_GetFunctionToken(ICorDebugFrame* This,mdMethodDef *pToken) {
    return This->lpVtbl->GetFunctionToken(This,pToken);
}
FORCEINLINE HRESULT ICorDebugFrame_GetStackRange(ICorDebugFrame* This,CORDB_ADDRESS *pStart,CORDB_ADDRESS *pEnd) {
    return This->lpVtbl->GetStackRange(This,pStart,pEnd);
}
FORCEINLINE HRESULT ICorDebugFrame_GetCaller(ICorDebugFrame* This,ICorDebugFrame **ppFrame) {
    return This->lpVtbl->GetCaller(This,ppFrame);
}
FORCEINLINE HRESULT ICorDebugFrame_GetCallee(ICorDebugFrame* This,ICorDebugFrame **ppFrame) {
    return This->lpVtbl->GetCallee(This,ppFrame);
}
FORCEINLINE HRESULT ICorDebugFrame_CreateStepper(ICorDebugFrame* This,ICorDebugStepper **ppStepper) {
    return This->lpVtbl->CreateStepper(This,ppStepper);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugRegisterSet_QueryInterface(ICorDebugRegisterSet* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugRegisterSet_AddRef(ICorDebugRegisterSet* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugRegisterSet_Release(ICorDebugRegisterSet* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugRegisterSet methods ***/
FORCEINLINE HRESULT ICorDebugRegisterSet_GetRegistersAvailable(ICorDebugRegisterSet* This,ULONG64 *pAvailable) {
    return This->lpVtbl->GetRegistersAvailable(This,pAvailable);
}
FORCEINLINE HRESULT ICorDebugRegisterSet_GetRegisters(ICorDebugRegisterSet* This,ULONG64 mask,ULONG32 regCount,CORDB_REGISTER regBuffer[]) {
    return This->lpVtbl->GetRegisters(This,mask,regCount,regBuffer);
}
FORCEINLINE HRESULT ICorDebugRegisterSet_SetRegisters(ICorDebugRegisterSet* This,ULONG64 mask,ULONG32 regCount,CORDB_REGISTER regBuffer[]) {
    return This->lpVtbl->SetRegisters(This,mask,regCount,regBuffer);
}
FORCEINLINE HRESULT ICorDebugRegisterSet_GetThreadContext(ICorDebugRegisterSet* This,ULONG32 contextSize,BYTE context[]) {
    return This->lpVtbl->GetThreadContext(This,contextSize,context);
}
FORCEINLINE HRESULT ICorDebugRegisterSet_SetThreadContext(ICorDebugRegisterSet* This,ULONG32 contextSize,BYTE context[]) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugEval_QueryInterface(ICorDebugEval* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugEval_AddRef(ICorDebugEval* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugEval_Release(ICorDebugEval* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEval methods ***/
FORCEINLINE HRESULT ICorDebugEval_CallFunction(ICorDebugEval* This,ICorDebugFunction *pFunction,ULONG32 nArgs,ICorDebugValue * ppArgs[]) {
    return This->lpVtbl->CallFunction(This,pFunction,nArgs,ppArgs);
}
FORCEINLINE HRESULT ICorDebugEval_NewObject(ICorDebugEval* This,ICorDebugFunction *pConstructor,ULONG32 nArgs,ICorDebugValue * ppArgs[]) {
    return This->lpVtbl->NewObject(This,pConstructor,nArgs,ppArgs);
}
FORCEINLINE HRESULT ICorDebugEval_NewObjectNoConstructor(ICorDebugEval* This,ICorDebugClass *pClass) {
    return This->lpVtbl->NewObjectNoConstructor(This,pClass);
}
FORCEINLINE HRESULT ICorDebugEval_NewString(ICorDebugEval* This,LPCWSTR string) {
    return This->lpVtbl->NewString(This,string);
}
FORCEINLINE HRESULT ICorDebugEval_NewArray(ICorDebugEval* This,CorElementType elementType,ICorDebugClass *pElementClass,ULONG32 rank,ULONG32 dims[],ULONG32 lowBounds[]) {
    return This->lpVtbl->NewArray(This,elementType,pElementClass,rank,dims,lowBounds);
}
FORCEINLINE HRESULT ICorDebugEval_IsActive(ICorDebugEval* This,BOOL *pbActive) {
    return This->lpVtbl->IsActive(This,pbActive);
}
FORCEINLINE HRESULT ICorDebugEval_Abort(ICorDebugEval* This) {
    return This->lpVtbl->Abort(This);
}
FORCEINLINE HRESULT ICorDebugEval_GetResult(ICorDebugEval* This,ICorDebugValue **ppResult) {
    return This->lpVtbl->GetResult(This,ppResult);
}
FORCEINLINE HRESULT ICorDebugEval_GetThread(ICorDebugEval* This,ICorDebugThread **ppThread) {
    return This->lpVtbl->GetThread(This,ppThread);
}
FORCEINLINE HRESULT ICorDebugEval_CreateValue(ICorDebugEval* This,CorElementType elementType,ICorDebugClass *pElementClass,ICorDebugValue **ppValue) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugEditAndContinueSnapshot_QueryInterface(ICorDebugEditAndContinueSnapshot* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugEditAndContinueSnapshot_AddRef(ICorDebugEditAndContinueSnapshot* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugEditAndContinueSnapshot_Release(ICorDebugEditAndContinueSnapshot* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEditAndContinueSnapshot methods ***/
FORCEINLINE HRESULT ICorDebugEditAndContinueSnapshot_CopyMetaData(ICorDebugEditAndContinueSnapshot* This,IStream *pIStream,GUID *pMvid) {
    return This->lpVtbl->CopyMetaData(This,pIStream,pMvid);
}
FORCEINLINE HRESULT ICorDebugEditAndContinueSnapshot_GetMvid(ICorDebugEditAndContinueSnapshot* This,GUID *pMvid) {
    return This->lpVtbl->GetMvid(This,pMvid);
}
FORCEINLINE HRESULT ICorDebugEditAndContinueSnapshot_GetRoDataRVA(ICorDebugEditAndContinueSnapshot* This,ULONG32 *pRoDataRVA) {
    return This->lpVtbl->GetRoDataRVA(This,pRoDataRVA);
}
FORCEINLINE HRESULT ICorDebugEditAndContinueSnapshot_GetRwDataRVA(ICorDebugEditAndContinueSnapshot* This,ULONG32 *pRwDataRVA) {
    return This->lpVtbl->GetRwDataRVA(This,pRwDataRVA);
}
FORCEINLINE HRESULT ICorDebugEditAndContinueSnapshot_SetPEBytes(ICorDebugEditAndContinueSnapshot* This,IStream *pIStream) {
    return This->lpVtbl->SetPEBytes(This,pIStream);
}
FORCEINLINE HRESULT ICorDebugEditAndContinueSnapshot_SetILMap(ICorDebugEditAndContinueSnapshot* This,mdToken mdFunction,ULONG cMapSize,COR_IL_MAP map[]) {
    return This->lpVtbl->SetILMap(This,mdFunction,cMapSize,map);
}
FORCEINLINE HRESULT ICorDebugEditAndContinueSnapshot_SetPESymbolBytes(ICorDebugEditAndContinueSnapshot* This,IStream *pIStream) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugModule_QueryInterface(ICorDebugModule* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugModule_AddRef(ICorDebugModule* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugModule_Release(ICorDebugModule* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugModule methods ***/
FORCEINLINE HRESULT ICorDebugModule_GetProcess(ICorDebugModule* This,ICorDebugProcess **ppProcess) {
    return This->lpVtbl->GetProcess(This,ppProcess);
}
FORCEINLINE HRESULT ICorDebugModule_GetBaseAddress(ICorDebugModule* This,CORDB_ADDRESS *pAddress) {
    return This->lpVtbl->GetBaseAddress(This,pAddress);
}
FORCEINLINE HRESULT ICorDebugModule_GetAssembly(ICorDebugModule* This,ICorDebugAssembly **ppAssembly) {
    return This->lpVtbl->GetAssembly(This,ppAssembly);
}
FORCEINLINE HRESULT ICorDebugModule_GetName(ICorDebugModule* This,ULONG32 cchName,ULONG32 *pcchName,WCHAR szName[]) {
    return This->lpVtbl->GetName(This,cchName,pcchName,szName);
}
FORCEINLINE HRESULT ICorDebugModule_EnableJITDebugging(ICorDebugModule* This,BOOL bTrackJITInfo,BOOL bAllowJitOpts) {
    return This->lpVtbl->EnableJITDebugging(This,bTrackJITInfo,bAllowJitOpts);
}
FORCEINLINE HRESULT ICorDebugModule_EnableClassLoadCallbacks(ICorDebugModule* This,BOOL bClassLoadCallbacks) {
    return This->lpVtbl->EnableClassLoadCallbacks(This,bClassLoadCallbacks);
}
FORCEINLINE HRESULT ICorDebugModule_GetFunctionFromToken(ICorDebugModule* This,mdMethodDef methodDef,ICorDebugFunction **ppFunction) {
    return This->lpVtbl->GetFunctionFromToken(This,methodDef,ppFunction);
}
FORCEINLINE HRESULT ICorDebugModule_GetFunctionFromRVA(ICorDebugModule* This,CORDB_ADDRESS rva,ICorDebugFunction **ppFunction) {
    return This->lpVtbl->GetFunctionFromRVA(This,rva,ppFunction);
}
FORCEINLINE HRESULT ICorDebugModule_GetClassFromToken(ICorDebugModule* This,mdTypeDef typeDef,ICorDebugClass **ppClass) {
    return This->lpVtbl->GetClassFromToken(This,typeDef,ppClass);
}
FORCEINLINE HRESULT ICorDebugModule_CreateBreakpoint(ICorDebugModule* This,ICorDebugModuleBreakpoint **ppBreakpoint) {
    return This->lpVtbl->CreateBreakpoint(This,ppBreakpoint);
}
FORCEINLINE HRESULT ICorDebugModule_GetEditAndContinueSnapshot(ICorDebugModule* This,ICorDebugEditAndContinueSnapshot **ppEditAndContinueSnapshot) {
    return This->lpVtbl->GetEditAndContinueSnapshot(This,ppEditAndContinueSnapshot);
}
FORCEINLINE HRESULT ICorDebugModule_GetMetaDataInterface(ICorDebugModule* This,REFIID riid,IUnknown **ppObj) {
    return This->lpVtbl->GetMetaDataInterface(This,riid,ppObj);
}
FORCEINLINE HRESULT ICorDebugModule_GetToken(ICorDebugModule* This,mdModule *pToken) {
    return This->lpVtbl->GetToken(This,pToken);
}
FORCEINLINE HRESULT ICorDebugModule_IsDynamic(ICorDebugModule* This,BOOL *pDynamic) {
    return This->lpVtbl->IsDynamic(This,pDynamic);
}
FORCEINLINE HRESULT ICorDebugModule_GetGlobalVariableValue(ICorDebugModule* This,mdFieldDef fieldDef,ICorDebugValue **ppValue) {
    return This->lpVtbl->GetGlobalVariableValue(This,fieldDef,ppValue);
}
FORCEINLINE HRESULT ICorDebugModule_GetSize(ICorDebugModule* This,ULONG32 *pcBytes) {
    return This->lpVtbl->GetSize(This,pcBytes);
}
FORCEINLINE HRESULT ICorDebugModule_IsInMemory(ICorDebugModule* This,BOOL *pInMemory) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugClass_QueryInterface(ICorDebugClass* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugClass_AddRef(ICorDebugClass* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugClass_Release(ICorDebugClass* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugClass methods ***/
FORCEINLINE HRESULT ICorDebugClass_GetModule(ICorDebugClass* This,ICorDebugModule **pModule) {
    return This->lpVtbl->GetModule(This,pModule);
}
FORCEINLINE HRESULT ICorDebugClass_GetToken(ICorDebugClass* This,mdTypeDef *pTypeDef) {
    return This->lpVtbl->GetToken(This,pTypeDef);
}
FORCEINLINE HRESULT ICorDebugClass_GetStaticFieldValue(ICorDebugClass* This,mdFieldDef fieldDef,ICorDebugFrame *pFrame,ICorDebugValue **ppValue) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugAssembly_QueryInterface(ICorDebugAssembly* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugAssembly_AddRef(ICorDebugAssembly* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugAssembly_Release(ICorDebugAssembly* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugAssembly methods ***/
FORCEINLINE HRESULT ICorDebugAssembly_GetProcess(ICorDebugAssembly* This,ICorDebugProcess **ppProcess) {
    return This->lpVtbl->GetProcess(This,ppProcess);
}
FORCEINLINE HRESULT ICorDebugAssembly_GetAppDomain(ICorDebugAssembly* This,ICorDebugAppDomain **ppAppDomain) {
    return This->lpVtbl->GetAppDomain(This,ppAppDomain);
}
FORCEINLINE HRESULT ICorDebugAssembly_EnumerateModules(ICorDebugAssembly* This,ICorDebugModuleEnum **ppModules) {
    return This->lpVtbl->EnumerateModules(This,ppModules);
}
FORCEINLINE HRESULT ICorDebugAssembly_GetCodeBase(ICorDebugAssembly* This,ULONG32 cchName,ULONG32 *pcchName,WCHAR szName[]) {
    return This->lpVtbl->GetCodeBase(This,cchName,pcchName,szName);
}
FORCEINLINE HRESULT ICorDebugAssembly_GetName(ICorDebugAssembly* This,ULONG32 cchName,ULONG32 *pcchName,WCHAR szName[]) {
    return This->lpVtbl->GetName(This,cchName,pcchName,szName);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugFunction_QueryInterface(ICorDebugFunction* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugFunction_AddRef(ICorDebugFunction* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugFunction_Release(ICorDebugFunction* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugFunction methods ***/
FORCEINLINE HRESULT ICorDebugFunction_GetModule(ICorDebugFunction* This,ICorDebugModule **ppModule) {
    return This->lpVtbl->GetModule(This,ppModule);
}
FORCEINLINE HRESULT ICorDebugFunction_GetClass(ICorDebugFunction* This,ICorDebugClass **ppClass) {
    return This->lpVtbl->GetClass(This,ppClass);
}
FORCEINLINE HRESULT ICorDebugFunction_GetToken(ICorDebugFunction* This,mdMethodDef *pMethodDef) {
    return This->lpVtbl->GetToken(This,pMethodDef);
}
FORCEINLINE HRESULT ICorDebugFunction_GetILCode(ICorDebugFunction* This,ICorDebugCode **ppCode) {
    return This->lpVtbl->GetILCode(This,ppCode);
}
FORCEINLINE HRESULT ICorDebugFunction_GetNativeCode(ICorDebugFunction* This,ICorDebugCode **ppCode) {
    return This->lpVtbl->GetNativeCode(This,ppCode);
}
FORCEINLINE HRESULT ICorDebugFunction_CreateBreakpoint(ICorDebugFunction* This,ICorDebugFunctionBreakpoint **ppBreakpoint) {
    return This->lpVtbl->CreateBreakpoint(This,ppBreakpoint);
}
FORCEINLINE HRESULT ICorDebugFunction_GetLocalVarSigToken(ICorDebugFunction* This,mdSignature *pmdSig) {
    return This->lpVtbl->GetLocalVarSigToken(This,pmdSig);
}
FORCEINLINE HRESULT ICorDebugFunction_GetCurrentVersionNumber(ICorDebugFunction* This,ULONG32 *pnCurrentVersion) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugUnmanagedCallback_QueryInterface(ICorDebugUnmanagedCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugUnmanagedCallback_AddRef(ICorDebugUnmanagedCallback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugUnmanagedCallback_Release(ICorDebugUnmanagedCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugUnmanagedCallback methods ***/
FORCEINLINE HRESULT ICorDebugUnmanagedCallback_DebugEvent(ICorDebugUnmanagedCallback* This,LPDEBUG_EVENT pDebugEvent,BOOL fOutOfBand) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugEditAndContinueErrorInfo_QueryInterface(ICorDebugEditAndContinueErrorInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugEditAndContinueErrorInfo_AddRef(ICorDebugEditAndContinueErrorInfo* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugEditAndContinueErrorInfo_Release(ICorDebugEditAndContinueErrorInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugEditAndContinueErrorInfo methods ***/
FORCEINLINE HRESULT ICorDebugEditAndContinueErrorInfo_GetModule(ICorDebugEditAndContinueErrorInfo* This,ICorDebugModule **ppModule) {
    return This->lpVtbl->GetModule(This,ppModule);
}
FORCEINLINE HRESULT ICorDebugEditAndContinueErrorInfo_GetToken(ICorDebugEditAndContinueErrorInfo* This,mdToken *pToken) {
    return This->lpVtbl->GetToken(This,pToken);
}
FORCEINLINE HRESULT ICorDebugEditAndContinueErrorInfo_GetErrorCode(ICorDebugEditAndContinueErrorInfo* This,HRESULT *pHr) {
    return This->lpVtbl->GetErrorCode(This,pHr);
}
FORCEINLINE HRESULT ICorDebugEditAndContinueErrorInfo_GetString(ICorDebugEditAndContinueErrorInfo* This,ULONG32 cchString,ULONG32 *pcchString,WCHAR szString[]) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugObjectValue_QueryInterface(ICorDebugObjectValue* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugObjectValue_AddRef(ICorDebugObjectValue* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugObjectValue_Release(ICorDebugObjectValue* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugValue methods ***/
FORCEINLINE HRESULT ICorDebugObjectValue_GetType(ICorDebugObjectValue* This,CorElementType *pType) {
    return This->lpVtbl->GetType(This,pType);
}
FORCEINLINE HRESULT ICorDebugObjectValue_GetSize(ICorDebugObjectValue* This,ULONG32 *pSize) {
    return This->lpVtbl->GetSize(This,pSize);
}
FORCEINLINE HRESULT ICorDebugObjectValue_GetAddress(ICorDebugObjectValue* This,CORDB_ADDRESS *pAddress) {
    return This->lpVtbl->GetAddress(This,pAddress);
}
FORCEINLINE HRESULT ICorDebugObjectValue_CreateBreakpoint(ICorDebugObjectValue* This,ICorDebugValueBreakpoint **ppBreakpoint) {
    return This->lpVtbl->CreateBreakpoint(This,ppBreakpoint);
}
/*** ICorDebugObjectValue methods ***/
FORCEINLINE HRESULT ICorDebugObjectValue_GetClass(ICorDebugObjectValue* This,ICorDebugClass **ppClass) {
    return This->lpVtbl->GetClass(This,ppClass);
}
FORCEINLINE HRESULT ICorDebugObjectValue_GetFieldValue(ICorDebugObjectValue* This,ICorDebugClass *pClass,mdFieldDef fieldDef,ICorDebugValue **ppValue) {
    return This->lpVtbl->GetFieldValue(This,pClass,fieldDef,ppValue);
}
FORCEINLINE HRESULT ICorDebugObjectValue_GetVirtualMethod(ICorDebugObjectValue* This,mdMemberRef memberRef,ICorDebugFunction **ppFunction) {
    return This->lpVtbl->GetVirtualMethod(This,memberRef,ppFunction);
}
FORCEINLINE HRESULT ICorDebugObjectValue_GetContext(ICorDebugObjectValue* This,ICorDebugContext **ppContext) {
    return This->lpVtbl->GetContext(This,ppContext);
}
FORCEINLINE HRESULT ICorDebugObjectValue_IsValueClass(ICorDebugObjectValue* This,BOOL *pbIsValueClass) {
    return This->lpVtbl->IsValueClass(This,pbIsValueClass);
}
FORCEINLINE HRESULT ICorDebugObjectValue_GetManagedCopy(ICorDebugObjectValue* This,IUnknown **ppObject) {
    return This->lpVtbl->GetManagedCopy(This,ppObject);
}
FORCEINLINE HRESULT ICorDebugObjectValue_SetFromManagedCopy(ICorDebugObjectValue* This,IUnknown *pObject) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugContext_QueryInterface(ICorDebugContext* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugContext_AddRef(ICorDebugContext* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugContext_Release(ICorDebugContext* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugValue methods ***/
FORCEINLINE HRESULT ICorDebugContext_GetType(ICorDebugContext* This,CorElementType *pType) {
    return This->lpVtbl->GetType(This,pType);
}
FORCEINLINE HRESULT ICorDebugContext_GetSize(ICorDebugContext* This,ULONG32 *pSize) {
    return This->lpVtbl->GetSize(This,pSize);
}
FORCEINLINE HRESULT ICorDebugContext_GetAddress(ICorDebugContext* This,CORDB_ADDRESS *pAddress) {
    return This->lpVtbl->GetAddress(This,pAddress);
}
FORCEINLINE HRESULT ICorDebugContext_CreateBreakpoint(ICorDebugContext* This,ICorDebugValueBreakpoint **ppBreakpoint) {
    return This->lpVtbl->CreateBreakpoint(This,ppBreakpoint);
}
/*** ICorDebugObjectValue methods ***/
FORCEINLINE HRESULT ICorDebugContext_GetClass(ICorDebugContext* This,ICorDebugClass **ppClass) {
    return This->lpVtbl->GetClass(This,ppClass);
}
FORCEINLINE HRESULT ICorDebugContext_GetFieldValue(ICorDebugContext* This,ICorDebugClass *pClass,mdFieldDef fieldDef,ICorDebugValue **ppValue) {
    return This->lpVtbl->GetFieldValue(This,pClass,fieldDef,ppValue);
}
FORCEINLINE HRESULT ICorDebugContext_GetVirtualMethod(ICorDebugContext* This,mdMemberRef memberRef,ICorDebugFunction **ppFunction) {
    return This->lpVtbl->GetVirtualMethod(This,memberRef,ppFunction);
}
FORCEINLINE HRESULT ICorDebugContext_GetContext(ICorDebugContext* This,ICorDebugContext **ppContext) {
    return This->lpVtbl->GetContext(This,ppContext);
}
FORCEINLINE HRESULT ICorDebugContext_IsValueClass(ICorDebugContext* This,BOOL *pbIsValueClass) {
    return This->lpVtbl->IsValueClass(This,pbIsValueClass);
}
FORCEINLINE HRESULT ICorDebugContext_GetManagedCopy(ICorDebugContext* This,IUnknown **ppObject) {
    return This->lpVtbl->GetManagedCopy(This,ppObject);
}
FORCEINLINE HRESULT ICorDebugContext_SetFromManagedCopy(ICorDebugContext* This,IUnknown *pObject) {
    return This->lpVtbl->SetFromManagedCopy(This,pObject);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugCode_QueryInterface(ICorDebugCode* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugCode_AddRef(ICorDebugCode* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugCode_Release(ICorDebugCode* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugCode methods ***/
FORCEINLINE HRESULT ICorDebugCode_IsIL(ICorDebugCode* This,BOOL *pbIL) {
    return This->lpVtbl->IsIL(This,pbIL);
}
FORCEINLINE HRESULT ICorDebugCode_GetFunction(ICorDebugCode* This,ICorDebugFunction **ppFunction) {
    return This->lpVtbl->GetFunction(This,ppFunction);
}
FORCEINLINE HRESULT ICorDebugCode_GetAddress(ICorDebugCode* This,CORDB_ADDRESS *pStart) {
    return This->lpVtbl->GetAddress(This,pStart);
}
FORCEINLINE HRESULT ICorDebugCode_GetSize(ICorDebugCode* This,ULONG32 *pcBytes) {
    return This->lpVtbl->GetSize(This,pcBytes);
}
FORCEINLINE HRESULT ICorDebugCode_CreateBreakpoint(ICorDebugCode* This,ULONG32 offset,ICorDebugFunctionBreakpoint **ppBreakpoint) {
    return This->lpVtbl->CreateBreakpoint(This,offset,ppBreakpoint);
}
FORCEINLINE HRESULT ICorDebugCode_GetCode(ICorDebugCode* This,ULONG32 startOffset,ULONG32 endOffset,ULONG32 cBufferAlloc,BYTE buffer[],ULONG32 *pcBufferSize) {
    return This->lpVtbl->GetCode(This,startOffset,endOffset,cBufferAlloc,buffer,pcBufferSize);
}
FORCEINLINE HRESULT ICorDebugCode_GetVersionNumber(ICorDebugCode* This,ULONG32 *nVersion) {
    return This->lpVtbl->GetVersionNumber(This,nVersion);
}
FORCEINLINE HRESULT ICorDebugCode_GetILToNativeMapping(ICorDebugCode* This,ULONG32 cMap,ULONG32 *pcMap,COR_DEBUG_IL_TO_NATIVE_MAP map[]) {
    return This->lpVtbl->GetILToNativeMapping(This,cMap,pcMap,map);
}
FORCEINLINE HRESULT ICorDebugCode_GetEnCRemapSequencePoints(ICorDebugCode* This,ULONG32 cMap,ULONG32 *pcMap,ULONG32 offsets[]) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ICorDebugMDA_QueryInterface(ICorDebugMDA* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ICorDebugMDA_AddRef(ICorDebugMDA* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ICorDebugMDA_Release(ICorDebugMDA* This) {
    return This->lpVtbl->Release(This);
}
/*** ICorDebugMDA methods ***/
FORCEINLINE HRESULT ICorDebugMDA_GetName(ICorDebugMDA* This,ULONG32 cchName,ULONG32 *pcchName,WCHAR szName[]) {
    return This->lpVtbl->GetName(This,cchName,pcchName,szName);
}
FORCEINLINE HRESULT ICorDebugMDA_GetDescription(ICorDebugMDA* This,ULONG32 cchName,ULONG32 *pcchName,WCHAR szName[]) {
    return This->lpVtbl->GetDescription(This,cchName,pcchName,szName);
}
FORCEINLINE HRESULT ICorDebugMDA_GetXML(ICorDebugMDA* This,ULONG32 cchName,ULONG32 *pcchName,WCHAR szName[]) {
    return This->lpVtbl->GetXML(This,cchName,pcchName,szName);
}
FORCEINLINE HRESULT ICorDebugMDA_GetFlags(ICorDebugMDA* This,CorDebugMDAFlags *pFlags) {
    return This->lpVtbl->GetFlags(This,pFlags);
}
FORCEINLINE HRESULT ICorDebugMDA_GetOSThreadId(ICorDebugMDA* This,DWORD *pOsTid) {
