/*** Autogenerated by WIDL <undefined version> from atliface.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IRegistrarBase_QueryInterface(IRegistrarBase* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IRegistrarBase_AddRef(IRegistrarBase* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IRegistrarBase_Release(IRegistrarBase* This) {
    return This->lpVtbl->Release(This);
}
/*** IRegistrarBase methods ***/
FORCEINLINE HRESULT IRegistrarBase_AddReplacement(IRegistrarBase* This,LPCOLESTR Key,LPCOLESTR item) {
    return This->lpVtbl->AddReplacement(This,Key,item);
}
FORCEINLINE HRESULT IRegistrarBase_ClearReplacements(IRegistrarBase* This) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IRegistrar_QueryInterface(IRegistrar* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IRegistrar_AddRef(IRegistrar* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IRegistrar_Release(IRegistrar* This) {
    return This->lpVtbl->Release(This);
}
/*** IRegistrarBase methods ***/
FORCEINLINE HRESULT IRegistrar_AddReplacement(IRegistrar* This,LPCOLESTR Key,LPCOLESTR item) {
    return This->lpVtbl->AddReplacement(This,Key,item);
}
FORCEINLINE HRESULT IRegistrar_ClearReplacements(IRegistrar* This) {
    return This->lpVtbl->ClearReplacements(This);
}
/*** IRegistrar methods ***/
FORCEINLINE HRESULT IRegistrar_ResourceRegisterSz(IRegistrar* This,LPCOLESTR resFileName,LPCOLESTR szID,LPCOLESTR szType) {
    return This->lpVtbl->ResourceRegisterSz(This,resFileName,szID,szType);
}
FORCEINLINE HRESULT IRegistrar_ResourceUnregisterSz(IRegistrar* This,LPCOLESTR resFileName,LPCOLESTR szID,LPCOLESTR szType) {
    return This->lpVtbl->ResourceUnregisterSz(This,resFileName,szID,szType);
}
FORCEINLINE HRESULT IRegistrar_FileRegister(IRegistrar* This,LPCOLESTR fileName) {
    return This->lpVtbl->FileRegister(This,fileName);
}
FORCEINLINE HRESULT IRegistrar_FileUnregister(IRegistrar* This,LPCOLESTR fileName) {
    return This->lpVtbl->FileUnregister(This,fileName);
}
FORCEINLINE HRESULT IRegistrar_StringRegister(IRegistrar* This,LPCOLESTR data) {
    return This->lpVtbl->StringRegister(This,data);
}
FORCEINLINE HRESULT IRegistrar_StringUnregister(IRegistrar* This,LPCOLESTR data) {
    return This->lpVtbl->StringUnregister(This,data);
}
FORCEINLINE HRESULT IRegistrar_ResourceRegister(IRegistrar* This,LPCOLESTR resFileName,UINT nID,LPCOLESTR szType) {
    return This->lpVtbl->ResourceRegister(This,resFileName,nID,szType);
}
FORCEINLINE HRESULT IRegistrar_ResourceUnregister(IRegistrar* This,LPCOLESTR resFileName,UINT nID,LPCOLESTR szType) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_QueryInterface(IDocHostUIHandlerDispatch* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IDocHostUIHandlerDispatch_AddRef(IDocHostUIHandlerDispatch* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IDocHostUIHandlerDispatch_Release(IDocHostUIHandlerDispatch* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_GetTypeInfoCount(IDocHostUIHandlerDispatch* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_GetTypeInfo(IDocHostUIHandlerDispatch* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_GetIDsOfNames(IDocHostUIHandlerDispatch* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_Invoke(IDocHostUIHandlerDispatch* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IDocHostUIHandlerDispatch methods ***/
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_ShowContextMenu(IDocHostUIHandlerDispatch* This,DWORD id,LONG x,LONG y,IUnknown *unkreserved,IDispatch *dispreserved,HRESULT *retval) {
    return This->lpVtbl->ShowContextMenu(This,id,x,y,unkreserved,dispreserved,retval);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_GetHostInfo(IDocHostUIHandlerDispatch* This,DWORD *flags,DWORD *doubleclick) {
    return This->lpVtbl->GetHostInfo(This,flags,doubleclick);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_ShowUI(IDocHostUIHandlerDispatch* This,DWORD id,IUnknown *activeobject,IUnknown *cmdtarget,IUnknown *frame,IUnknown *doc,HRESULT *retval) {
    return This->lpVtbl->ShowUI(This,id,activeobject,cmdtarget,frame,doc,retval);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_HideUI(IDocHostUIHandlerDispatch* This) {
    return This->lpVtbl->HideUI(This);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_UpdateUI(IDocHostUIHandlerDispatch* This) {
    return This->lpVtbl->UpdateUI(This);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_EnableModeless(IDocHostUIHandlerDispatch* This,VARIANT_BOOL enable) {
    return This->lpVtbl->EnableModeless(This,enable);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_OnDocWindowActivate(IDocHostUIHandlerDispatch* This,VARIANT_BOOL activate) {
    return This->lpVtbl->OnDocWindowActivate(This,activate);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_OnFrameWindowActivate(IDocHostUIHandlerDispatch* This,VARIANT_BOOL activate) {
    return This->lpVtbl->OnFrameWindowActivate(This,activate);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_ResizeBorder(IDocHostUIHandlerDispatch* This,LONG left,LONG top,LONG right,LONG bottom,IUnknown *window,VARIANT_BOOL framewindow) {
    return This->lpVtbl->ResizeBorder(This,left,top,right,bottom,window,framewindow);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_TranslateAccelerator(IDocHostUIHandlerDispatch* This,HWND hwnd,UINT msg,WPARAM wparam,LPARAM lparam,BSTR guid_cmd_group,HRESULT *retval) {
    return This->lpVtbl->TranslateAccelerator(This,hwnd,msg,wparam,lparam,guid_cmd_group,retval);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_GetOptionKeyPath(IDocHostUIHandlerDispatch* This,BSTR *key,DWORD reserved) {
    return This->lpVtbl->GetOptionKeyPath(This,key,reserved);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_GetDropTarget(IDocHostUIHandlerDispatch* This,IUnknown *droptarget,IUnknown **ret_droptarget) {
    return This->lpVtbl->GetDropTarget(This,droptarget,ret_droptarget);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_GetExternal(IDocHostUIHandlerDispatch* This,IDispatch **disp) {
    return This->lpVtbl->GetExternal(This,disp);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_TranslateUrl(IDocHostUIHandlerDispatch* This,DWORD reserved,BSTR url,BSTR *translated_url) {
    return This->lpVtbl->TranslateUrl(This,reserved,url,translated_url);
}
FORCEINLINE HRESULT IDocHostUIHandlerDispatch_FilterDataObject(IDocHostUIHandlerDispatch* This,IUnknown *dataobject,IUnknown **dataobject_ret) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IAxWinAmbientDispatch_QueryInterface(IAxWinAmbientDispatch* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IAxWinAmbientDispatch_AddRef(IAxWinAmbientDispatch* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IAxWinAmbientDispatch_Release(IAxWinAmbientDispatch* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT IAxWinAmbientDispatch_GetTypeInfoCount(IAxWinAmbientDispatch* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_GetTypeInfo(IAxWinAmbientDispatch* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_GetIDsOfNames(IAxWinAmbientDispatch* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_Invoke(IAxWinAmbientDispatch* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IAxWinAmbientDispatch methods ***/
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_AllowWindowlessActivation(IAxWinAmbientDispatch* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowWindowlessActivation(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_AllowWindowlessActivation(IAxWinAmbientDispatch* This,VARIANT_BOOL *allowed) {
    return This->lpVtbl->get_AllowWindowlessActivation(This,allowed);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_BackColor(IAxWinAmbientDispatch* This,OLE_COLOR color) {
    return This->lpVtbl->put_BackColor(This,color);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_BackColor(IAxWinAmbientDispatch* This,OLE_COLOR *color) {
    return This->lpVtbl->get_BackColor(This,color);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_ForeColor(IAxWinAmbientDispatch* This,OLE_COLOR color) {
    return This->lpVtbl->put_ForeColor(This,color);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_ForeColor(IAxWinAmbientDispatch* This,OLE_COLOR *color) {
    return This->lpVtbl->get_ForeColor(This,color);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_LocaleID(IAxWinAmbientDispatch* This,LCID lcid) {
    return This->lpVtbl->put_LocaleID(This,lcid);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_LocaleID(IAxWinAmbientDispatch* This,LCID *lcid) {
    return This->lpVtbl->get_LocaleID(This,lcid);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_UserMode(IAxWinAmbientDispatch* This,VARIANT_BOOL mode) {
    return This->lpVtbl->put_UserMode(This,mode);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_UserMode(IAxWinAmbientDispatch* This,VARIANT_BOOL *mode) {
    return This->lpVtbl->get_UserMode(This,mode);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_DisplayAsDefault(IAxWinAmbientDispatch* This,VARIANT_BOOL display) {
    return This->lpVtbl->put_DisplayAsDefault(This,display);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_DisplayAsDefault(IAxWinAmbientDispatch* This,VARIANT_BOOL *display) {
    return This->lpVtbl->get_DisplayAsDefault(This,display);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_Font(IAxWinAmbientDispatch* This,IFontDisp *font) {
    return This->lpVtbl->put_Font(This,font);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_Font(IAxWinAmbientDispatch* This,IFontDisp **font) {
    return This->lpVtbl->get_Font(This,font);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_MessageReflect(IAxWinAmbientDispatch* This,VARIANT_BOOL reflect) {
    return This->lpVtbl->put_MessageReflect(This,reflect);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_MessageReflect(IAxWinAmbientDispatch* This,VARIANT_BOOL *reflect) {
    return This->lpVtbl->get_MessageReflect(This,reflect);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_ShowGrabHandles(IAxWinAmbientDispatch* This,VARIANT_BOOL *show) {
    return This->lpVtbl->get_ShowGrabHandles(This,show);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_ShowHatching(IAxWinAmbientDispatch* This,VARIANT_BOOL *show) {
    return This->lpVtbl->get_ShowHatching(This,show);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_DocHostFlags(IAxWinAmbientDispatch* This,DWORD flags) {
    return This->lpVtbl->put_DocHostFlags(This,flags);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_DocHostFlags(IAxWinAmbientDispatch* This,DWORD *flags) {
    return This->lpVtbl->get_DocHostFlags(This,flags);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_DocHostDoubleClickFlags(IAxWinAmbientDispatch* This,DWORD flags) {
    return This->lpVtbl->put_DocHostDoubleClickFlags(This,flags);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_DocHostDoubleClickFlags(IAxWinAmbientDispatch* This,DWORD *flags) {
    return This->lpVtbl->get_DocHostDoubleClickFlags(This,flags);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_AllowContextMenu(IAxWinAmbientDispatch* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowContextMenu(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_AllowContextMenu(IAxWinAmbientDispatch* This,VARIANT_BOOL *allow) {
    return This->lpVtbl->get_AllowContextMenu(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_AllowShowUI(IAxWinAmbientDispatch* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowShowUI(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_AllowShowUI(IAxWinAmbientDispatch* This,VARIANT_BOOL *allow) {
    return This->lpVtbl->get_AllowShowUI(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_put_OptionKeyPath(IAxWinAmbientDispatch* This,BSTR path) {
    return This->lpVtbl->put_OptionKeyPath(This,path);
}
FORCEINLINE HRESULT IAxWinAmbientDispatch_get_OptionKeyPath(IAxWinAmbientDispatch* This,BSTR *path) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_QueryInterface(IAxWinAmbientDispatchEx* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IAxWinAmbientDispatchEx_AddRef(IAxWinAmbientDispatchEx* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IAxWinAmbientDispatchEx_Release(IAxWinAmbientDispatchEx* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_GetTypeInfoCount(IAxWinAmbientDispatchEx* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_GetTypeInfo(IAxWinAmbientDispatchEx* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_GetIDsOfNames(IAxWinAmbientDispatchEx* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_Invoke(IAxWinAmbientDispatchEx* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IAxWinAmbientDispatch methods ***/
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_AllowWindowlessActivation(IAxWinAmbientDispatchEx* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowWindowlessActivation(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_AllowWindowlessActivation(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *allowed) {
    return This->lpVtbl->get_AllowWindowlessActivation(This,allowed);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_BackColor(IAxWinAmbientDispatchEx* This,OLE_COLOR color) {
    return This->lpVtbl->put_BackColor(This,color);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_BackColor(IAxWinAmbientDispatchEx* This,OLE_COLOR *color) {
    return This->lpVtbl->get_BackColor(This,color);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_ForeColor(IAxWinAmbientDispatchEx* This,OLE_COLOR color) {
    return This->lpVtbl->put_ForeColor(This,color);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_ForeColor(IAxWinAmbientDispatchEx* This,OLE_COLOR *color) {
    return This->lpVtbl->get_ForeColor(This,color);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_LocaleID(IAxWinAmbientDispatchEx* This,LCID lcid) {
    return This->lpVtbl->put_LocaleID(This,lcid);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_LocaleID(IAxWinAmbientDispatchEx* This,LCID *lcid) {
    return This->lpVtbl->get_LocaleID(This,lcid);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_UserMode(IAxWinAmbientDispatchEx* This,VARIANT_BOOL mode) {
    return This->lpVtbl->put_UserMode(This,mode);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_UserMode(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *mode) {
    return This->lpVtbl->get_UserMode(This,mode);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_DisplayAsDefault(IAxWinAmbientDispatchEx* This,VARIANT_BOOL display) {
    return This->lpVtbl->put_DisplayAsDefault(This,display);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_DisplayAsDefault(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *display) {
    return This->lpVtbl->get_DisplayAsDefault(This,display);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_Font(IAxWinAmbientDispatchEx* This,IFontDisp *font) {
    return This->lpVtbl->put_Font(This,font);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_Font(IAxWinAmbientDispatchEx* This,IFontDisp **font) {
    return This->lpVtbl->get_Font(This,font);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_MessageReflect(IAxWinAmbientDispatchEx* This,VARIANT_BOOL reflect) {
    return This->lpVtbl->put_MessageReflect(This,reflect);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_MessageReflect(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *reflect) {
    return This->lpVtbl->get_MessageReflect(This,reflect);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_ShowGrabHandles(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *show) {
    return This->lpVtbl->get_ShowGrabHandles(This,show);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_ShowHatching(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *show) {
    return This->lpVtbl->get_ShowHatching(This,show);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_DocHostFlags(IAxWinAmbientDispatchEx* This,DWORD flags) {
    return This->lpVtbl->put_DocHostFlags(This,flags);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_DocHostFlags(IAxWinAmbientDispatchEx* This,DWORD *flags) {
    return This->lpVtbl->get_DocHostFlags(This,flags);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_DocHostDoubleClickFlags(IAxWinAmbientDispatchEx* This,DWORD flags) {
    return This->lpVtbl->put_DocHostDoubleClickFlags(This,flags);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_DocHostDoubleClickFlags(IAxWinAmbientDispatchEx* This,DWORD *flags) {
    return This->lpVtbl->get_DocHostDoubleClickFlags(This,flags);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_AllowContextMenu(IAxWinAmbientDispatchEx* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowContextMenu(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_AllowContextMenu(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *allow) {
    return This->lpVtbl->get_AllowContextMenu(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_AllowShowUI(IAxWinAmbientDispatchEx* This,VARIANT_BOOL allow) {
    return This->lpVtbl->put_AllowShowUI(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_AllowShowUI(IAxWinAmbientDispatchEx* This,VARIANT_BOOL *allow) {
    return This->lpVtbl->get_AllowShowUI(This,allow);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_put_OptionKeyPath(IAxWinAmbientDispatchEx* This,BSTR path) {
    return This->lpVtbl->put_OptionKeyPath(This,path);
}
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_get_OptionKeyPath(IAxWinAmbientDispatchEx* This,BSTR *path) {
    return This->lpVtbl->get_OptionKeyPath(This,path);
}
/*** IAxWinAmbientDispatchEx methods ***/
FORCEINLINE HRESULT IAxWinAmbientDispatchEx_SetAmbientDispatch(IAxWinAmbientDispatchEx* This,IDispatch *disp) {
