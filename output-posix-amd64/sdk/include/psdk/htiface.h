/*** Autogenerated by WIDL <undefined version> from htiface.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITargetFrame_QueryInterface(ITargetFrame* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITargetFrame_AddRef(ITargetFrame* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITargetFrame_Release(ITargetFrame* This) {
    return This->lpVtbl->Release(This);
}
/*** ITargetFrame methods ***/
FORCEINLINE HRESULT ITargetFrame_SetFrameName(ITargetFrame* This,LPCWSTR pszFrameName) {
    return This->lpVtbl->SetFrameName(This,pszFrameName);
}
FORCEINLINE HRESULT ITargetFrame_GetFrameName(ITargetFrame* This,LPWSTR *ppszFrameName) {
    return This->lpVtbl->GetFrameName(This,ppszFrameName);
}
FORCEINLINE HRESULT ITargetFrame_GetParentFrame(ITargetFrame* This,IUnknown **ppunkParent) {
    return This->lpVtbl->GetParentFrame(This,ppunkParent);
}
FORCEINLINE HRESULT ITargetFrame_FindFrame(ITargetFrame* This,LPCWSTR pszTargetName,IUnknown *ppunkContextFrame,DWORD dwFlags,IUnknown **ppunkTargetFrame) {
    return This->lpVtbl->FindFrame(This,pszTargetName,ppunkContextFrame,dwFlags,ppunkTargetFrame);
}
FORCEINLINE HRESULT ITargetFrame_SetFrameSrc(ITargetFrame* This,LPCWSTR pszFrameSrc) {
    return This->lpVtbl->SetFrameSrc(This,pszFrameSrc);
}
FORCEINLINE HRESULT ITargetFrame_GetFrameSrc(ITargetFrame* This,LPWSTR *ppszFrameSrc) {
    return This->lpVtbl->GetFrameSrc(This,ppszFrameSrc);
}
FORCEINLINE HRESULT ITargetFrame_GetFramesContainer(ITargetFrame* This,IOleContainer **ppContainer) {
    return This->lpVtbl->GetFramesContainer(This,ppContainer);
}
FORCEINLINE HRESULT ITargetFrame_SetFrameOptions(ITargetFrame* This,DWORD dwFlags) {
    return This->lpVtbl->SetFrameOptions(This,dwFlags);
}
FORCEINLINE HRESULT ITargetFrame_GetFrameOptions(ITargetFrame* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFrameOptions(This,pdwFlags);
}
FORCEINLINE HRESULT ITargetFrame_SetFrameMargins(ITargetFrame* This,DWORD dwWidth,DWORD dwHeight) {
    return This->lpVtbl->SetFrameMargins(This,dwWidth,dwHeight);
}
FORCEINLINE HRESULT ITargetFrame_GetFrameMargins(ITargetFrame* This,DWORD *pdwWidth,DWORD *pdwHeight) {
    return This->lpVtbl->GetFrameMargins(This,pdwWidth,pdwHeight);
}
FORCEINLINE HRESULT ITargetFrame_RemoteNavigate(ITargetFrame* This,ULONG cLength,ULONG *pulData) {
    return This->lpVtbl->RemoteNavigate(This,cLength,pulData);
}
FORCEINLINE HRESULT ITargetFrame_OnChildFrameActivate(ITargetFrame* This,IUnknown *pUnkChildFrame) {
    return This->lpVtbl->OnChildFrameActivate(This,pUnkChildFrame);
}
FORCEINLINE HRESULT ITargetFrame_OnChildFrameDeactivate(ITargetFrame* This,IUnknown *pUnkChildFrame) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITargetFramePriv_QueryInterface(ITargetFramePriv* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITargetFramePriv_AddRef(ITargetFramePriv* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITargetFramePriv_Release(ITargetFramePriv* This) {
    return This->lpVtbl->Release(This);
}
/*** ITargetFramePriv methods ***/
FORCEINLINE HRESULT ITargetFramePriv_FindFrameDownwards(ITargetFramePriv* This,LPCWSTR pszTargetName,DWORD dwFlags,IUnknown **ppunkTargetFrame) {
    return This->lpVtbl->FindFrameDownwards(This,pszTargetName,dwFlags,ppunkTargetFrame);
}
FORCEINLINE HRESULT ITargetFramePriv_FindFrameInContext(ITargetFramePriv* This,LPCWSTR pszTargetName,IUnknown *punkContextFrame,DWORD dwFlags,IUnknown **ppunkTargetFrame) {
    return This->lpVtbl->FindFrameInContext(This,pszTargetName,punkContextFrame,dwFlags,ppunkTargetFrame);
}
FORCEINLINE HRESULT ITargetFramePriv_OnChildFrameActivate(ITargetFramePriv* This,IUnknown *pUnkChildFrame) {
    return This->lpVtbl->OnChildFrameActivate(This,pUnkChildFrame);
}
FORCEINLINE HRESULT ITargetFramePriv_OnChildFrameDeactivate(ITargetFramePriv* This,IUnknown *pUnkChildFrame) {
    return This->lpVtbl->OnChildFrameDeactivate(This,pUnkChildFrame);
}
FORCEINLINE HRESULT ITargetFramePriv_NavigateHack(ITargetFramePriv* This,DWORD grfHLNF,LPBC pbc,IBindStatusCallback *pibsc,LPCWSTR pszTargetName,LPCWSTR pszUrl,LPCWSTR pszLocation) {
    return This->lpVtbl->NavigateHack(This,grfHLNF,pbc,pibsc,pszTargetName,pszUrl,pszLocation);
}
FORCEINLINE HRESULT ITargetFramePriv_FindBrowserByIndex(ITargetFramePriv* This,DWORD dwID,IUnknown **ppunkBrowser) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITargetFramePriv2_QueryInterface(ITargetFramePriv2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITargetFramePriv2_AddRef(ITargetFramePriv2* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITargetFramePriv2_Release(ITargetFramePriv2* This) {
    return This->lpVtbl->Release(This);
}
/*** ITargetFramePriv methods ***/
FORCEINLINE HRESULT ITargetFramePriv2_FindFrameDownwards(ITargetFramePriv2* This,LPCWSTR pszTargetName,DWORD dwFlags,IUnknown **ppunkTargetFrame) {
    return This->lpVtbl->FindFrameDownwards(This,pszTargetName,dwFlags,ppunkTargetFrame);
}
FORCEINLINE HRESULT ITargetFramePriv2_FindFrameInContext(ITargetFramePriv2* This,LPCWSTR pszTargetName,IUnknown *punkContextFrame,DWORD dwFlags,IUnknown **ppunkTargetFrame) {
    return This->lpVtbl->FindFrameInContext(This,pszTargetName,punkContextFrame,dwFlags,ppunkTargetFrame);
}
FORCEINLINE HRESULT ITargetFramePriv2_OnChildFrameActivate(ITargetFramePriv2* This,IUnknown *pUnkChildFrame) {
    return This->lpVtbl->OnChildFrameActivate(This,pUnkChildFrame);
}
FORCEINLINE HRESULT ITargetFramePriv2_OnChildFrameDeactivate(ITargetFramePriv2* This,IUnknown *pUnkChildFrame) {
    return This->lpVtbl->OnChildFrameDeactivate(This,pUnkChildFrame);
}
FORCEINLINE HRESULT ITargetFramePriv2_NavigateHack(ITargetFramePriv2* This,DWORD grfHLNF,LPBC pbc,IBindStatusCallback *pibsc,LPCWSTR pszTargetName,LPCWSTR pszUrl,LPCWSTR pszLocation) {
    return This->lpVtbl->NavigateHack(This,grfHLNF,pbc,pibsc,pszTargetName,pszUrl,pszLocation);
}
FORCEINLINE HRESULT ITargetFramePriv2_FindBrowserByIndex(ITargetFramePriv2* This,DWORD dwID,IUnknown **ppunkBrowser) {
    return This->lpVtbl->FindBrowserByIndex(This,dwID,ppunkBrowser);
}
/*** ITargetFramePriv2 methods ***/
FORCEINLINE HRESULT ITargetFramePriv2_AggregatedNavigation2(ITargetFramePriv2* This,DWORD grfHLNF,LPBC pbc,IBindStatusCallback *pibsc,LPCWSTR pszTargetName,IUri *pUri,LPCWSTR pszLocation) {
