/*** Autogenerated by WIDL <undefined version> from perhist.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IPersistHistory_QueryInterface(IPersistHistory* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IPersistHistory_AddRef(IPersistHistory* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IPersistHistory_Release(IPersistHistory* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
FORCEINLINE HRESULT IPersistHistory_GetClassID(IPersistHistory* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistHistory methods ***/
FORCEINLINE HRESULT IPersistHistory_LoadHistory(IPersistHistory* This,IStream *pStream,IBindCtx *pbc) {
    return This->lpVtbl->LoadHistory(This,pStream,pbc);
}
FORCEINLINE HRESULT IPersistHistory_SaveHistory(IPersistHistory* This,IStream *pStream) {
    return This->lpVtbl->SaveHistory(This,pStream);
}
FORCEINLINE HRESULT IPersistHistory_SetPositionCookie(IPersistHistory* This,DWORD dwPositioncookie) {
    return This->lpVtbl->SetPositionCookie(This,dwPositioncookie);
}
FORCEINLINE HRESULT IPersistHistory_GetPositionCookie(IPersistHistory* This,DWORD *pdwPositioncookie) {
