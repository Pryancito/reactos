/*** Autogenerated by WIDL <undefined version> from pstore.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IEnumPStoreItems_QueryInterface(IEnumPStoreItems* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IEnumPStoreItems_AddRef(IEnumPStoreItems* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IEnumPStoreItems_Release(IEnumPStoreItems* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumPStoreItems methods ***/
FORCEINLINE HRESULT IEnumPStoreItems_Clone(IEnumPStoreItems* This,IEnumPStoreItems **ppenum) {
    return This->lpVtbl->Clone(This,ppenum);
}
FORCEINLINE HRESULT IEnumPStoreItems_Next(IEnumPStoreItems* This,DWORD celt,LPWSTR *rgelt,DWORD *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgelt,pceltFetched);
}
FORCEINLINE HRESULT IEnumPStoreItems_Reset(IEnumPStoreItems* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IEnumPStoreItems_Skip(IEnumPStoreItems* This,DWORD celt) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IEnumPStoreTypes_QueryInterface(IEnumPStoreTypes* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IEnumPStoreTypes_AddRef(IEnumPStoreTypes* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IEnumPStoreTypes_Release(IEnumPStoreTypes* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumPStoreTypes methods ***/
FORCEINLINE HRESULT IEnumPStoreTypes_Clone(IEnumPStoreTypes* This,IEnumPStoreTypes **ppenum) {
    return This->lpVtbl->Clone(This,ppenum);
}
FORCEINLINE HRESULT IEnumPStoreTypes_Next(IEnumPStoreTypes* This,DWORD celt,LPWSTR *rgelt,DWORD *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgelt,pceltFetched);
}
FORCEINLINE HRESULT IEnumPStoreTypes_Reset(IEnumPStoreTypes* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IEnumPStoreTypes_Skip(IEnumPStoreTypes* This,DWORD celt) {
    return This->lpVtbl->Skip(This,celt);
}
#endif
#endif
...
#define IPStore_OpenItem(This,Key,pItemType,pItemSubtype,szItemName,ModeFlags,pProomptInfo,dwFlags) (This)->lpVtbl->OpenItem(This,Key,pItemType,pItemSubtype,szItemName,ModeFlags,pProomptInfo,dwFlags)
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IPStore_QueryInterface(IPStore* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IPStore_AddRef(IPStore* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IPStore_Release(IPStore* This) {
    return This->lpVtbl->Release(This);
}
/*** IPStore methods ***/
FORCEINLINE HRESULT IPStore_GetInfo(IPStore* This,PPST_PROVIDERINFO *ppProperties) {
    return This->lpVtbl->GetInfo(This,ppProperties);
}
FORCEINLINE HRESULT IPStore_GetProvParam(IPStore* This,DWORD dwParam,DWORD *pcbData,BYTE **ppbData,DWORD dwFlags) {
    return This->lpVtbl->GetProvParam(This,dwParam,pcbData,ppbData,dwFlags);
}
FORCEINLINE HRESULT IPStore_SetProvParam(IPStore* This,DWORD dwParam,DWORD cbData,BYTE *pbData,DWORD *dwFlags) {
    return This->lpVtbl->SetProvParam(This,dwParam,cbData,pbData,dwFlags);
}
FORCEINLINE HRESULT IPStore_CreateType(IPStore* This,PST_KEY Key,const GUID *pType,PPST_TYPEINFO pInfo,DWORD dwFlags) {
    return This->lpVtbl->CreateType(This,Key,pType,pInfo,dwFlags);
}
FORCEINLINE HRESULT IPStore_GetTypeInfo(IPStore* This,PST_KEY Key,const GUID *pType,PPST_TYPEINFO **ppInfo,DWORD dwFlags) {
    return This->lpVtbl->GetTypeInfo(This,Key,pType,ppInfo,dwFlags);
}
FORCEINLINE HRESULT IPStore_DeleteType(IPStore* This,PST_KEY Key,const GUID *pType,DWORD dwFlags) {
    return This->lpVtbl->DeleteType(This,Key,pType,dwFlags);
}
FORCEINLINE HRESULT IPStore_CreateSubtype(IPStore* This,PST_KEY Key,const GUID *pType,const GUID *pSubtype,PPST_TYPEINFO pInfo,PPST_ACCESSRULESET pRules,DWORD dwFlags) {
    return This->lpVtbl->CreateSubtype(This,Key,pType,pSubtype,pInfo,pRules,dwFlags);
}
FORCEINLINE HRESULT IPStore_GetSubtypeInfo(IPStore* This,PST_KEY Key,const GUID *pType,const GUID *pSubtype,PPST_TYPEINFO **ppInfo,DWORD dwFlags) {
    return This->lpVtbl->GetSubtypeInfo(This,Key,pType,pSubtype,ppInfo,dwFlags);
}
FORCEINLINE HRESULT IPStore_DeleteSubtype(IPStore* This,PST_KEY Key,const GUID *pType,const GUID *pSubtype,DWORD dwFlags) {
    return This->lpVtbl->DeleteSubtype(This,Key,pType,pSubtype,dwFlags);
}
FORCEINLINE HRESULT IPStore_ReadAccessRuleset(IPStore* This,PST_KEY Key,const GUID *pType,const GUID *pSubtype,PPST_TYPEINFO pInfo,PPST_ACCESSRULESET **ppRules,DWORD dwFlags) {
    return This->lpVtbl->ReadAccessRuleset(This,Key,pType,pSubtype,pInfo,ppRules,dwFlags);
}
FORCEINLINE HRESULT IPStore_WriteAccessRuleset(IPStore* This,PST_KEY Key,const GUID *pType,const GUID *pSubtype,PPST_TYPEINFO pInfo,PPST_ACCESSRULESET pRules,DWORD dwFlags) {
    return This->lpVtbl->WriteAccessRuleset(This,Key,pType,pSubtype,pInfo,pRules,dwFlags);
}
FORCEINLINE HRESULT IPStore_EnumTypes(IPStore* This,PST_KEY Key,DWORD dwFlags,IEnumPStoreTypes **ppenum) {
    return This->lpVtbl->EnumTypes(This,Key,dwFlags,ppenum);
}
FORCEINLINE HRESULT IPStore_EnumSubtypes(IPStore* This,PST_KEY Key,const GUID *pType,DWORD dwFlags,IEnumPStoreTypes **ppenum) {
    return This->lpVtbl->EnumSubtypes(This,Key,pType,dwFlags,ppenum);
}
FORCEINLINE HRESULT IPStore_DeleteItem(IPStore* This,PST_KEY Key,const GUID *pItemType,const GUID *pItemSubType,LPCWSTR szItemName,PPST_PROMPTINFO pPromptInfo,DWORD dwFlags) {
    return This->lpVtbl->DeleteItem(This,Key,pItemType,pItemSubType,szItemName,pPromptInfo,dwFlags);
}
FORCEINLINE HRESULT IPStore_ReadItem(IPStore* This,PST_KEY Key,const GUID *pItemType,const GUID *pItemSubtype,LPCWSTR szItemName,DWORD *cbData,BYTE **pbData,PPST_PROMPTINFO pPromptInfo,DWORD dwFlags) {
    return This->lpVtbl->ReadItem(This,Key,pItemType,pItemSubtype,szItemName,cbData,pbData,pPromptInfo,dwFlags);
}
FORCEINLINE HRESULT IPStore_WriteItem(IPStore* This,PST_KEY Key,const GUID *pItemType,const GUID *pItemSubtype,LPCWSTR szItemName,DWORD cbData,BYTE *ppbData,PPST_PROMPTINFO pPromptInfo,DWORD dwDefaultConfirmationStyle,DWORD dwFlags) {
...
FORCEINLINE HRESULT IPStore_OpenItem(IPStore* This,PST_KEY Key,const GUID *pItemType,const GUID *pItemSubtype,LPCWSTR szItemName,PST_ACCESSMODE ModeFlags,PPST_PROMPTINFO pProomptInfo,DWORD dwFlags) {
    return This->lpVtbl->OpenItem(This,Key,pItemType,pItemSubtype,szItemName,ModeFlags,pProomptInfo,dwFlags);
}
FORCEINLINE HRESULT IPStore_CloseItem(IPStore* This,PST_KEY Key,const GUID *pItemType,const GUID *pItemSubtype,LPCWSTR *szItemName,DWORD dwFlags) {
    return This->lpVtbl->CloseItem(This,Key,pItemType,pItemSubtype,szItemName,dwFlags);
}
FORCEINLINE HRESULT IPStore_EnumItems(IPStore* This,PST_KEY Key,const GUID *pItemType,const GUID *pItemSubtype,DWORD dwFlags,IEnumPStoreItems **ppenum) {
