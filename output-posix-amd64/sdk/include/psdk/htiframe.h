/*** Autogenerated by WIDL <undefined version> from htiframe.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITargetNotify_QueryInterface(ITargetNotify* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITargetNotify_AddRef(ITargetNotify* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITargetNotify_Release(ITargetNotify* This) {
    return This->lpVtbl->Release(This);
}
/*** ITargetNotify methods ***/
FORCEINLINE HRESULT ITargetNotify_OnCreate(ITargetNotify* This,IUnknown *pUnkDestination,ULONG cbCookie) {
    return This->lpVtbl->OnCreate(This,pUnkDestination,cbCookie);
}
FORCEINLINE HRESULT ITargetNotify_OnReuse(ITargetNotify* This,IUnknown *pUnkDestination) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITargetNotify2_QueryInterface(ITargetNotify2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITargetNotify2_AddRef(ITargetNotify2* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITargetNotify2_Release(ITargetNotify2* This) {
    return This->lpVtbl->Release(This);
}
/*** ITargetNotify methods ***/
FORCEINLINE HRESULT ITargetNotify2_OnCreate(ITargetNotify2* This,IUnknown *pUnkDestination,ULONG cbCookie) {
    return This->lpVtbl->OnCreate(This,pUnkDestination,cbCookie);
}
FORCEINLINE HRESULT ITargetNotify2_OnReuse(ITargetNotify2* This,IUnknown *pUnkDestination) {
    return This->lpVtbl->OnReuse(This,pUnkDestination);
}
/*** ITargetNotify2 methods ***/
FORCEINLINE HRESULT ITargetNotify2_GetOptionString(ITargetNotify2* This,BSTR *pbstrOptions) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITargetFrame2_QueryInterface(ITargetFrame2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITargetFrame2_AddRef(ITargetFrame2* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITargetFrame2_Release(ITargetFrame2* This) {
    return This->lpVtbl->Release(This);
}
/*** ITargetFrame2 methods ***/
FORCEINLINE HRESULT ITargetFrame2_SetFrameName(ITargetFrame2* This,LPCWSTR pszFrameName) {
    return This->lpVtbl->SetFrameName(This,pszFrameName);
}
FORCEINLINE HRESULT ITargetFrame2_GetFrameName(ITargetFrame2* This,LPWSTR *ppszFrameName) {
    return This->lpVtbl->GetFrameName(This,ppszFrameName);
}
FORCEINLINE HRESULT ITargetFrame2_GetParentFrame(ITargetFrame2* This,IUnknown **ppunkParent) {
    return This->lpVtbl->GetParentFrame(This,ppunkParent);
}
FORCEINLINE HRESULT ITargetFrame2_SetFrameSrc(ITargetFrame2* This,LPCWSTR pszFrameSrc) {
    return This->lpVtbl->SetFrameSrc(This,pszFrameSrc);
}
FORCEINLINE HRESULT ITargetFrame2_GetFrameSrc(ITargetFrame2* This,LPWSTR *ppszFrameSrc) {
    return This->lpVtbl->GetFrameSrc(This,ppszFrameSrc);
}
FORCEINLINE HRESULT ITargetFrame2_GetFramesContainer(ITargetFrame2* This,IOleContainer **ppContainer) {
    return This->lpVtbl->GetFramesContainer(This,ppContainer);
}
FORCEINLINE HRESULT ITargetFrame2_SetFrameOptions(ITargetFrame2* This,DWORD dwFlags) {
    return This->lpVtbl->SetFrameOptions(This,dwFlags);
}
FORCEINLINE HRESULT ITargetFrame2_GetFrameOptions(ITargetFrame2* This,DWORD *pdwFlags) {
    return This->lpVtbl->GetFrameOptions(This,pdwFlags);
}
FORCEINLINE HRESULT ITargetFrame2_SetFrameMargins(ITargetFrame2* This,DWORD dwWidth,DWORD dwHeight) {
    return This->lpVtbl->SetFrameMargins(This,dwWidth,dwHeight);
}
FORCEINLINE HRESULT ITargetFrame2_GetFrameMargins(ITargetFrame2* This,DWORD *pdwWidth,DWORD *pdwHeight) {
    return This->lpVtbl->GetFrameMargins(This,pdwWidth,pdwHeight);
}
FORCEINLINE HRESULT ITargetFrame2_FindFrame(ITargetFrame2* This,LPCWSTR pszTargetName,DWORD dwFlags,IUnknown **ppunkTargetFrame) {
    return This->lpVtbl->FindFrame(This,pszTargetName,dwFlags,ppunkTargetFrame);
}
FORCEINLINE HRESULT ITargetFrame2_GetTargetAlias(ITargetFrame2* This,LPCWSTR pszTargetName,LPWSTR *ppszTargetAlias) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITargetContainer_QueryInterface(ITargetContainer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITargetContainer_AddRef(ITargetContainer* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITargetContainer_Release(ITargetContainer* This) {
    return This->lpVtbl->Release(This);
}
/*** ITargetContainer methods ***/
FORCEINLINE HRESULT ITargetContainer_GetFrameUrl(ITargetContainer* This,LPWSTR *ppszFrameSrc) {
    return This->lpVtbl->GetFrameUrl(This,ppszFrameSrc);
}
FORCEINLINE HRESULT ITargetContainer_GetFramesContainer(ITargetContainer* This,IOleContainer **ppContainer) {
    return This->lpVtbl->GetFramesContainer(This,ppContainer);
}
#endif
#endif
