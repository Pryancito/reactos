/*** Autogenerated by WIDL <undefined version> from imnxport.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITransportCallbackService_QueryInterface(ITransportCallbackService* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITransportCallbackService_AddRef(ITransportCallbackService* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITransportCallbackService_Release(ITransportCallbackService* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransportCallbackService methods ***/
FORCEINLINE HRESULT ITransportCallbackService_GetParentWindow(ITransportCallbackService* This,DWORD dwReserved,HWND *phwndParent) {
    return This->lpVtbl->GetParentWindow(This,dwReserved,phwndParent);
}
FORCEINLINE HRESULT ITransportCallbackService_GetAccount(ITransportCallbackService* This,LPDWORD pdwServerType,IImnAccount **ppAccount) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ITransportCallback_QueryInterface(ITransportCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ITransportCallback_AddRef(ITransportCallback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ITransportCallback_Release(ITransportCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransportCallback methods ***/
FORCEINLINE HRESULT ITransportCallback_OnTimeout(ITransportCallback* This,DWORD *pdwTimeout,IInternetTransport *pTransport) {
    return This->lpVtbl->OnTimeout(This,pdwTimeout,pTransport);
}
FORCEINLINE HRESULT ITransportCallback_OnLogonPrompt(ITransportCallback* This,LPINETSERVER pInetServer,IInternetTransport *pTransport) {
    return This->lpVtbl->OnLogonPrompt(This,pInetServer,pTransport);
}
FORCEINLINE INT ITransportCallback_OnPrompt(ITransportCallback* This,HRESULT hrError,LPCSTR pszText,LPCSTR pszCaption,UINT uType,IInternetTransport *pTransport) {
    return This->lpVtbl->OnPrompt(This,hrError,pszText,pszCaption,uType,pTransport);
}
FORCEINLINE HRESULT ITransportCallback_OnStatus(ITransportCallback* This,IXPSTATUS ixpstatus,IInternetTransport *pTransport) {
    return This->lpVtbl->OnStatus(This,ixpstatus,pTransport);
}
FORCEINLINE HRESULT ITransportCallback_OnError(ITransportCallback* This,IXPSTATUS ixpstatus,LPIXPRESULT pResult,IInternetTransport *pTransport) {
    return This->lpVtbl->OnError(This,ixpstatus,pResult,pTransport);
}
FORCEINLINE HRESULT ITransportCallback_OnCommand(ITransportCallback* This,CMDTYPE cmdtype,LPSTR pszLine,HRESULT hrResponse,IInternetTransport *pTransport) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IInternetTransport_QueryInterface(IInternetTransport* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IInternetTransport_AddRef(IInternetTransport* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IInternetTransport_Release(IInternetTransport* This) {
    return This->lpVtbl->Release(This);
}
/*** IInternetTransport methods ***/
FORCEINLINE HRESULT IInternetTransport_GetServerInfo(IInternetTransport* This,LPINETSERVER pInetServer) {
    return This->lpVtbl->GetServerInfo(This,pInetServer);
}
FORCEINLINE IXPTYPE IInternetTransport_GetIXPType(IInternetTransport* This) {
    return This->lpVtbl->GetIXPType(This);
}
FORCEINLINE HRESULT IInternetTransport_IsState(IInternetTransport* This,IXPISSTATE isstate) {
    return This->lpVtbl->IsState(This,isstate);
}
FORCEINLINE HRESULT IInternetTransport_InetServerFromAccount(IInternetTransport* This,IImnAccount *pAccount,LPINETSERVER pInetServer) {
    return This->lpVtbl->InetServerFromAccount(This,pAccount,pInetServer);
}
FORCEINLINE HRESULT IInternetTransport_Connect(IInternetTransport* This,LPINETSERVER pInetServer,boolean fAuthenticate,boolean fCommandLogging) {
    return This->lpVtbl->Connect(This,pInetServer,fAuthenticate,fCommandLogging);
}
FORCEINLINE HRESULT IInternetTransport_HandsOffCallback(IInternetTransport* This) {
    return This->lpVtbl->HandsOffCallback(This);
}
FORCEINLINE HRESULT IInternetTransport_Disconnect(IInternetTransport* This) {
    return This->lpVtbl->Disconnect(This);
}
FORCEINLINE HRESULT IInternetTransport_DropConnection(IInternetTransport* This) {
    return This->lpVtbl->DropConnection(This);
}
FORCEINLINE HRESULT IInternetTransport_GetStatus(IInternetTransport* This,IXPSTATUS *pCurrentStatus) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ISMTPCallback_QueryInterface(ISMTPCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ISMTPCallback_AddRef(ISMTPCallback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ISMTPCallback_Release(ISMTPCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransportCallback methods ***/
FORCEINLINE HRESULT ISMTPCallback_OnTimeout(ISMTPCallback* This,DWORD *pdwTimeout,IInternetTransport *pTransport) {
    return This->lpVtbl->OnTimeout(This,pdwTimeout,pTransport);
}
FORCEINLINE HRESULT ISMTPCallback_OnLogonPrompt(ISMTPCallback* This,LPINETSERVER pInetServer,IInternetTransport *pTransport) {
    return This->lpVtbl->OnLogonPrompt(This,pInetServer,pTransport);
}
FORCEINLINE INT ISMTPCallback_OnPrompt(ISMTPCallback* This,HRESULT hrError,LPCSTR pszText,LPCSTR pszCaption,UINT uType,IInternetTransport *pTransport) {
    return This->lpVtbl->OnPrompt(This,hrError,pszText,pszCaption,uType,pTransport);
}
FORCEINLINE HRESULT ISMTPCallback_OnStatus(ISMTPCallback* This,IXPSTATUS ixpstatus,IInternetTransport *pTransport) {
    return This->lpVtbl->OnStatus(This,ixpstatus,pTransport);
}
FORCEINLINE HRESULT ISMTPCallback_OnError(ISMTPCallback* This,IXPSTATUS ixpstatus,LPIXPRESULT pResult,IInternetTransport *pTransport) {
    return This->lpVtbl->OnError(This,ixpstatus,pResult,pTransport);
}
FORCEINLINE HRESULT ISMTPCallback_OnCommand(ISMTPCallback* This,CMDTYPE cmdtype,LPSTR pszLine,HRESULT hrResponse,IInternetTransport *pTransport) {
    return This->lpVtbl->OnCommand(This,cmdtype,pszLine,hrResponse,pTransport);
}
/*** ISMTPCallback methods ***/
FORCEINLINE HRESULT ISMTPCallback_OnResponse(ISMTPCallback* This,LPSMTPRESPONSE pResponse) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ISMTPTransport_QueryInterface(ISMTPTransport* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ISMTPTransport_AddRef(ISMTPTransport* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ISMTPTransport_Release(ISMTPTransport* This) {
    return This->lpVtbl->Release(This);
}
/*** IInternetTransport methods ***/
FORCEINLINE HRESULT ISMTPTransport_GetServerInfo(ISMTPTransport* This,LPINETSERVER pInetServer) {
    return This->lpVtbl->GetServerInfo(This,pInetServer);
}
FORCEINLINE IXPTYPE ISMTPTransport_GetIXPType(ISMTPTransport* This) {
    return This->lpVtbl->GetIXPType(This);
}
FORCEINLINE HRESULT ISMTPTransport_IsState(ISMTPTransport* This,IXPISSTATE isstate) {
    return This->lpVtbl->IsState(This,isstate);
}
FORCEINLINE HRESULT ISMTPTransport_InetServerFromAccount(ISMTPTransport* This,IImnAccount *pAccount,LPINETSERVER pInetServer) {
    return This->lpVtbl->InetServerFromAccount(This,pAccount,pInetServer);
}
FORCEINLINE HRESULT ISMTPTransport_Connect(ISMTPTransport* This,LPINETSERVER pInetServer,boolean fAuthenticate,boolean fCommandLogging) {
    return This->lpVtbl->Connect(This,pInetServer,fAuthenticate,fCommandLogging);
}
FORCEINLINE HRESULT ISMTPTransport_HandsOffCallback(ISMTPTransport* This) {
    return This->lpVtbl->HandsOffCallback(This);
}
FORCEINLINE HRESULT ISMTPTransport_Disconnect(ISMTPTransport* This) {
    return This->lpVtbl->Disconnect(This);
}
FORCEINLINE HRESULT ISMTPTransport_DropConnection(ISMTPTransport* This) {
    return This->lpVtbl->DropConnection(This);
}
FORCEINLINE HRESULT ISMTPTransport_GetStatus(ISMTPTransport* This,IXPSTATUS *pCurrentStatus) {
    return This->lpVtbl->GetStatus(This,pCurrentStatus);
}
/*** ISMTPTransport methods ***/
FORCEINLINE HRESULT ISMTPTransport_InitNew(ISMTPTransport* This,LPSTR pszLogFilePath,ISMTPCallback *pCallback) {
    return This->lpVtbl->InitNew(This,pszLogFilePath,pCallback);
}
FORCEINLINE HRESULT ISMTPTransport_SendMessage(ISMTPTransport* This,LPSMTPMESSAGE pMessage) {
    return This->lpVtbl->SendMessage(This,pMessage);
}
FORCEINLINE HRESULT ISMTPTransport_CommandMAIL(ISMTPTransport* This,LPSTR pszEmailFrom) {
    return This->lpVtbl->CommandMAIL(This,pszEmailFrom);
}
FORCEINLINE HRESULT ISMTPTransport_CommandRCPT(ISMTPTransport* This,LPSTR pszEmailTo) {
    return This->lpVtbl->CommandRCPT(This,pszEmailTo);
}
FORCEINLINE HRESULT ISMTPTransport_CommandEHLO(ISMTPTransport* This) {
    return This->lpVtbl->CommandEHLO(This);
}
FORCEINLINE HRESULT ISMTPTransport_CommandHELO(ISMTPTransport* This) {
    return This->lpVtbl->CommandHELO(This);
}
FORCEINLINE HRESULT ISMTPTransport_CommandAUTH(ISMTPTransport* This,LPSTR pszAuthType) {
    return This->lpVtbl->CommandAUTH(This,pszAuthType);
}
FORCEINLINE HRESULT ISMTPTransport_CommandQUIT(ISMTPTransport* This) {
    return This->lpVtbl->CommandQUIT(This);
}
FORCEINLINE HRESULT ISMTPTransport_CommandRSET(ISMTPTransport* This) {
    return This->lpVtbl->CommandRSET(This);
}
FORCEINLINE HRESULT ISMTPTransport_CommandDATA(ISMTPTransport* This) {
    return This->lpVtbl->CommandDATA(This);
}
FORCEINLINE HRESULT ISMTPTransport_CommandDOT(ISMTPTransport* This) {
    return This->lpVtbl->CommandDOT(This);
}
FORCEINLINE HRESULT ISMTPTransport_SendDataStream(ISMTPTransport* This,IStream *pStream,ULONG cbSize) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT ISMTPTransport2_QueryInterface(ISMTPTransport2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG ISMTPTransport2_AddRef(ISMTPTransport2* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG ISMTPTransport2_Release(ISMTPTransport2* This) {
    return This->lpVtbl->Release(This);
}
/*** IInternetTransport methods ***/
FORCEINLINE HRESULT ISMTPTransport2_GetServerInfo(ISMTPTransport2* This,LPINETSERVER pInetServer) {
    return This->lpVtbl->GetServerInfo(This,pInetServer);
}
FORCEINLINE IXPTYPE ISMTPTransport2_GetIXPType(ISMTPTransport2* This) {
    return This->lpVtbl->GetIXPType(This);
}
FORCEINLINE HRESULT ISMTPTransport2_IsState(ISMTPTransport2* This,IXPISSTATE isstate) {
    return This->lpVtbl->IsState(This,isstate);
}
FORCEINLINE HRESULT ISMTPTransport2_InetServerFromAccount(ISMTPTransport2* This,IImnAccount *pAccount,LPINETSERVER pInetServer) {
    return This->lpVtbl->InetServerFromAccount(This,pAccount,pInetServer);
}
FORCEINLINE HRESULT ISMTPTransport2_Connect(ISMTPTransport2* This,LPINETSERVER pInetServer,boolean fAuthenticate,boolean fCommandLogging) {
    return This->lpVtbl->Connect(This,pInetServer,fAuthenticate,fCommandLogging);
}
FORCEINLINE HRESULT ISMTPTransport2_HandsOffCallback(ISMTPTransport2* This) {
    return This->lpVtbl->HandsOffCallback(This);
}
FORCEINLINE HRESULT ISMTPTransport2_Disconnect(ISMTPTransport2* This) {
    return This->lpVtbl->Disconnect(This);
}
FORCEINLINE HRESULT ISMTPTransport2_DropConnection(ISMTPTransport2* This) {
    return This->lpVtbl->DropConnection(This);
}
FORCEINLINE HRESULT ISMTPTransport2_GetStatus(ISMTPTransport2* This,IXPSTATUS *pCurrentStatus) {
    return This->lpVtbl->GetStatus(This,pCurrentStatus);
}
/*** ISMTPTransport methods ***/
FORCEINLINE HRESULT ISMTPTransport2_InitNew(ISMTPTransport2* This,LPSTR pszLogFilePath,ISMTPCallback *pCallback) {
    return This->lpVtbl->InitNew(This,pszLogFilePath,pCallback);
}
FORCEINLINE HRESULT ISMTPTransport2_SendMessage(ISMTPTransport2* This,LPSMTPMESSAGE pMessage) {
    return This->lpVtbl->SendMessage(This,pMessage);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandMAIL(ISMTPTransport2* This,LPSTR pszEmailFrom) {
    return This->lpVtbl->CommandMAIL(This,pszEmailFrom);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandRCPT(ISMTPTransport2* This,LPSTR pszEmailTo) {
    return This->lpVtbl->CommandRCPT(This,pszEmailTo);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandEHLO(ISMTPTransport2* This) {
    return This->lpVtbl->CommandEHLO(This);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandHELO(ISMTPTransport2* This) {
    return This->lpVtbl->CommandHELO(This);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandAUTH(ISMTPTransport2* This,LPSTR pszAuthType) {
    return This->lpVtbl->CommandAUTH(This,pszAuthType);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandQUIT(ISMTPTransport2* This) {
    return This->lpVtbl->CommandQUIT(This);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandRSET(ISMTPTransport2* This) {
    return This->lpVtbl->CommandRSET(This);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandDATA(ISMTPTransport2* This) {
    return This->lpVtbl->CommandDATA(This);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandDOT(ISMTPTransport2* This) {
    return This->lpVtbl->CommandDOT(This);
}
FORCEINLINE HRESULT ISMTPTransport2_SendDataStream(ISMTPTransport2* This,IStream *pStream,ULONG cbSize) {
    return This->lpVtbl->SendDataStream(This,pStream,cbSize);
}
/*** ISMTPTransport2 methods ***/
FORCEINLINE HRESULT ISMTPTransport2_SetWindow(ISMTPTransport2* This) {
    return This->lpVtbl->SetWindow(This);
}
FORCEINLINE HRESULT ISMTPTransport2_ResetWindow(ISMTPTransport2* This) {
    return This->lpVtbl->ResetWindow(This);
}
FORCEINLINE HRESULT ISMTPTransport2_SendMessage2(ISMTPTransport2* This,LPSMTPMESSAGE2 pMessage) {
    return This->lpVtbl->SendMessage2(This,pMessage);
}
FORCEINLINE HRESULT ISMTPTransport2_CommandRCPT2(ISMTPTransport2* This,LPSTR pszEmailTo,INETADDRTYPE atDSN) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IPOP3Callback_QueryInterface(IPOP3Callback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IPOP3Callback_AddRef(IPOP3Callback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IPOP3Callback_Release(IPOP3Callback* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransportCallback methods ***/
FORCEINLINE HRESULT IPOP3Callback_OnTimeout(IPOP3Callback* This,DWORD *pdwTimeout,IInternetTransport *pTransport) {
    return This->lpVtbl->OnTimeout(This,pdwTimeout,pTransport);
}
FORCEINLINE HRESULT IPOP3Callback_OnLogonPrompt(IPOP3Callback* This,LPINETSERVER pInetServer,IInternetTransport *pTransport) {
    return This->lpVtbl->OnLogonPrompt(This,pInetServer,pTransport);
}
FORCEINLINE INT IPOP3Callback_OnPrompt(IPOP3Callback* This,HRESULT hrError,LPCSTR pszText,LPCSTR pszCaption,UINT uType,IInternetTransport *pTransport) {
    return This->lpVtbl->OnPrompt(This,hrError,pszText,pszCaption,uType,pTransport);
}
FORCEINLINE HRESULT IPOP3Callback_OnStatus(IPOP3Callback* This,IXPSTATUS ixpstatus,IInternetTransport *pTransport) {
    return This->lpVtbl->OnStatus(This,ixpstatus,pTransport);
}
FORCEINLINE HRESULT IPOP3Callback_OnError(IPOP3Callback* This,IXPSTATUS ixpstatus,LPIXPRESULT pResult,IInternetTransport *pTransport) {
    return This->lpVtbl->OnError(This,ixpstatus,pResult,pTransport);
}
FORCEINLINE HRESULT IPOP3Callback_OnCommand(IPOP3Callback* This,CMDTYPE cmdtype,LPSTR pszLine,HRESULT hrResponse,IInternetTransport *pTransport) {
    return This->lpVtbl->OnCommand(This,cmdtype,pszLine,hrResponse,pTransport);
}
/*** IPOP3Callback methods ***/
FORCEINLINE HRESULT IPOP3Callback_OnResponse(IPOP3Callback* This,LPPOP3RESPONSE pResponse) {
    return This->lpVtbl->OnResponse(This,pResponse);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IPOP3Transport_QueryInterface(IPOP3Transport* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IPOP3Transport_AddRef(IPOP3Transport* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IPOP3Transport_Release(IPOP3Transport* This) {
    return This->lpVtbl->Release(This);
}
/*** IInternetTransport methods ***/
FORCEINLINE HRESULT IPOP3Transport_GetServerInfo(IPOP3Transport* This,LPINETSERVER pInetServer) {
    return This->lpVtbl->GetServerInfo(This,pInetServer);
}
FORCEINLINE IXPTYPE IPOP3Transport_GetIXPType(IPOP3Transport* This) {
    return This->lpVtbl->GetIXPType(This);
}
FORCEINLINE HRESULT IPOP3Transport_IsState(IPOP3Transport* This,IXPISSTATE isstate) {
    return This->lpVtbl->IsState(This,isstate);
}
FORCEINLINE HRESULT IPOP3Transport_InetServerFromAccount(IPOP3Transport* This,IImnAccount *pAccount,LPINETSERVER pInetServer) {
    return This->lpVtbl->InetServerFromAccount(This,pAccount,pInetServer);
}
FORCEINLINE HRESULT IPOP3Transport_Connect(IPOP3Transport* This,LPINETSERVER pInetServer,boolean fAuthenticate,boolean fCommandLogging) {
    return This->lpVtbl->Connect(This,pInetServer,fAuthenticate,fCommandLogging);
}
FORCEINLINE HRESULT IPOP3Transport_HandsOffCallback(IPOP3Transport* This) {
    return This->lpVtbl->HandsOffCallback(This);
}
FORCEINLINE HRESULT IPOP3Transport_Disconnect(IPOP3Transport* This) {
    return This->lpVtbl->Disconnect(This);
}
FORCEINLINE HRESULT IPOP3Transport_DropConnection(IPOP3Transport* This) {
    return This->lpVtbl->DropConnection(This);
}
FORCEINLINE HRESULT IPOP3Transport_GetStatus(IPOP3Transport* This,IXPSTATUS *pCurrentStatus) {
    return This->lpVtbl->GetStatus(This,pCurrentStatus);
}
/*** IPOP3Transport methods ***/
FORCEINLINE HRESULT IPOP3Transport_InitNew(IPOP3Transport* This,LPSTR pszLogFilePath,IPOP3Callback *pCallback) {
    return This->lpVtbl->InitNew(This,pszLogFilePath,pCallback);
}
FORCEINLINE HRESULT IPOP3Transport_MarkItem(IPOP3Transport* This,POP3MARKTYPE marktype,DWORD dwPopId,boolean fMarked) {
    return This->lpVtbl->MarkItem(This,marktype,dwPopId,fMarked);
}
FORCEINLINE HRESULT IPOP3Transport_CommandAUTH(IPOP3Transport* This,LPSTR pszAuthType) {
    return This->lpVtbl->CommandAUTH(This,pszAuthType);
}
FORCEINLINE HRESULT IPOP3Transport_CommandUSER(IPOP3Transport* This,LPSTR pszUserName) {
    return This->lpVtbl->CommandUSER(This,pszUserName);
}
FORCEINLINE HRESULT IPOP3Transport_CommandPASS(IPOP3Transport* This,LPSTR pszPassword) {
    return This->lpVtbl->CommandPASS(This,pszPassword);
}
FORCEINLINE HRESULT IPOP3Transport_CommandLIST(IPOP3Transport* This,POP3CMDTYPE cmdtype,DWORD dwPopId) {
    return This->lpVtbl->CommandLIST(This,cmdtype,dwPopId);
}
FORCEINLINE HRESULT IPOP3Transport_CommandTOP(IPOP3Transport* This,POP3CMDTYPE cmdtype,DWORD dwPopId,DWORD cPreviewLines) {
    return This->lpVtbl->CommandTOP(This,cmdtype,dwPopId,cPreviewLines);
}
FORCEINLINE HRESULT IPOP3Transport_CommandQUIT(IPOP3Transport* This) {
    return This->lpVtbl->CommandQUIT(This);
}
FORCEINLINE HRESULT IPOP3Transport_CommandSTAT(IPOP3Transport* This) {
    return This->lpVtbl->CommandSTAT(This);
}
FORCEINLINE HRESULT IPOP3Transport_CommandNOOP(IPOP3Transport* This) {
    return This->lpVtbl->CommandNOOP(This);
}
FORCEINLINE HRESULT IPOP3Transport_CommandRSET(IPOP3Transport* This) {
    return This->lpVtbl->CommandRSET(This);
}
FORCEINLINE HRESULT IPOP3Transport_CommandUIDL(IPOP3Transport* This,POP3CMDTYPE cmdtype,DWORD dwPopId) {
    return This->lpVtbl->CommandUIDL(This,cmdtype,dwPopId);
}
FORCEINLINE HRESULT IPOP3Transport_CommandDELE(IPOP3Transport* This,POP3CMDTYPE cmdtype,DWORD dwPopId) {
    return This->lpVtbl->CommandDELE(This,cmdtype,dwPopId);
}
FORCEINLINE HRESULT IPOP3Transport_CommandRETR(IPOP3Transport* This,POP3CMDTYPE cmdtype,DWORD dwPopId) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IRangeList_QueryInterface(IRangeList* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IRangeList_AddRef(IRangeList* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IRangeList_Release(IRangeList* This) {
    return This->lpVtbl->Release(This);
}
/*** IRangeList methods ***/
FORCEINLINE HRESULT IRangeList_Clear(IRangeList* This) {
    return This->lpVtbl->Clear(This);
}
FORCEINLINE HRESULT IRangeList_IsInRange(IRangeList* This,const ULONG value) {
    return This->lpVtbl->IsInRange(This,value);
}
FORCEINLINE HRESULT IRangeList_Min(IRangeList* This,ULONG *pulMin) {
    return This->lpVtbl->Min(This,pulMin);
}
FORCEINLINE HRESULT IRangeList_Max(IRangeList* This,ULONG *pulMax) {
    return This->lpVtbl->Max(This,pulMax);
}
FORCEINLINE HRESULT IRangeList_Save(IRangeList* This,byte **ppbDestination,ULONG *pulSizeOfDestination) {
    return This->lpVtbl->Save(This,ppbDestination,pulSizeOfDestination);
}
FORCEINLINE HRESULT IRangeList_Load(IRangeList* This,byte *pbSource,const ULONG ulSizeOfSource) {
    return This->lpVtbl->Load(This,pbSource,ulSizeOfSource);
}
FORCEINLINE HRESULT IRangeList_AddRange(IRangeList* This,const ULONG low,const ULONG high) {
    return This->lpVtbl->AddRange(This,low,high);
}
FORCEINLINE HRESULT IRangeList_AddSingleValue(IRangeList* This,const ULONG value) {
    return This->lpVtbl->AddSingleValue(This,value);
}
FORCEINLINE HRESULT IRangeList_AddRangeList(IRangeList* This,const IRangeList *prl) {
    return This->lpVtbl->AddRangeList(This,prl);
}
FORCEINLINE HRESULT IRangeList_DeleteRange(IRangeList* This,const ULONG low,const ULONG high) {
    return This->lpVtbl->DeleteRange(This,low,high);
}
FORCEINLINE HRESULT IRangeList_DeleteSingleValue(IRangeList* This,const ULONG value) {
    return This->lpVtbl->DeleteSingleValue(This,value);
}
FORCEINLINE HRESULT IRangeList_DeleteRangeList(IRangeList* This,const IRangeList *prl) {
    return This->lpVtbl->DeleteRangeList(This,prl);
}
FORCEINLINE HRESULT IRangeList_MinOfRange(IRangeList* This,const ULONG value,ULONG *pulMinOfRange) {
    return This->lpVtbl->MinOfRange(This,value,pulMinOfRange);
}
FORCEINLINE HRESULT IRangeList_MaxOfRange(IRangeList* This,const ULONG value,ULONG *pulMaxOfRange) {
    return This->lpVtbl->MaxOfRange(This,value,pulMaxOfRange);
}
FORCEINLINE HRESULT IRangeList_RangeToIMAPString(IRangeList* This,LPSTR *ppszDestination,LPDWORD pdwLengthOfDestination) {
    return This->lpVtbl->RangeToIMAPString(This,ppszDestination,pdwLengthOfDestination);
}
FORCEINLINE HRESULT IRangeList_Next(IRangeList* This,const ULONG current,ULONG *pulNext) {
    return This->lpVtbl->Next(This,current,pulNext);
}
FORCEINLINE HRESULT IRangeList_Prev(IRangeList* This,const ULONG current,ULONG *pulPrev) {
    return This->lpVtbl->Prev(This,current,pulPrev);
}
FORCEINLINE HRESULT IRangeList_Cardinality(IRangeList* This,ULONG *pulCardinality) {
    return This->lpVtbl->Cardinality(This,pulCardinality);
}
FORCEINLINE HRESULT IRangeList_CardinalityFrom(IRangeList* This,const ULONG ulStartPoint,ULONG *pulCardinalityFrom) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IIMAPCallback_QueryInterface(IIMAPCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IIMAPCallback_AddRef(IIMAPCallback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IIMAPCallback_Release(IIMAPCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransportCallback methods ***/
FORCEINLINE HRESULT IIMAPCallback_OnTimeout(IIMAPCallback* This,DWORD *pdwTimeout,IInternetTransport *pTransport) {
    return This->lpVtbl->OnTimeout(This,pdwTimeout,pTransport);
}
FORCEINLINE HRESULT IIMAPCallback_OnLogonPrompt(IIMAPCallback* This,LPINETSERVER pInetServer,IInternetTransport *pTransport) {
    return This->lpVtbl->OnLogonPrompt(This,pInetServer,pTransport);
}
FORCEINLINE INT IIMAPCallback_OnPrompt(IIMAPCallback* This,HRESULT hrError,LPCSTR pszText,LPCSTR pszCaption,UINT uType,IInternetTransport *pTransport) {
    return This->lpVtbl->OnPrompt(This,hrError,pszText,pszCaption,uType,pTransport);
}
FORCEINLINE HRESULT IIMAPCallback_OnStatus(IIMAPCallback* This,IXPSTATUS ixpstatus,IInternetTransport *pTransport) {
    return This->lpVtbl->OnStatus(This,ixpstatus,pTransport);
}
FORCEINLINE HRESULT IIMAPCallback_OnError(IIMAPCallback* This,IXPSTATUS ixpstatus,LPIXPRESULT pResult,IInternetTransport *pTransport) {
    return This->lpVtbl->OnError(This,ixpstatus,pResult,pTransport);
}
FORCEINLINE HRESULT IIMAPCallback_OnCommand(IIMAPCallback* This,CMDTYPE cmdtype,LPSTR pszLine,HRESULT hrResponse,IInternetTransport *pTransport) {
    return This->lpVtbl->OnCommand(This,cmdtype,pszLine,hrResponse,pTransport);
}
/*** IIMAPCallback methods ***/
FORCEINLINE HRESULT IIMAPCallback_OnResponse(IIMAPCallback* This,const IMAP_RESPONSE *pirIMAPResponse) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IIMAPTransport_QueryInterface(IIMAPTransport* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IIMAPTransport_AddRef(IIMAPTransport* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IIMAPTransport_Release(IIMAPTransport* This) {
    return This->lpVtbl->Release(This);
}
/*** IInternetTransport methods ***/
FORCEINLINE HRESULT IIMAPTransport_GetServerInfo(IIMAPTransport* This,LPINETSERVER pInetServer) {
    return This->lpVtbl->GetServerInfo(This,pInetServer);
}
FORCEINLINE IXPTYPE IIMAPTransport_GetIXPType(IIMAPTransport* This) {
    return This->lpVtbl->GetIXPType(This);
}
FORCEINLINE HRESULT IIMAPTransport_IsState(IIMAPTransport* This,IXPISSTATE isstate) {
    return This->lpVtbl->IsState(This,isstate);
}
FORCEINLINE HRESULT IIMAPTransport_InetServerFromAccount(IIMAPTransport* This,IImnAccount *pAccount,LPINETSERVER pInetServer) {
    return This->lpVtbl->InetServerFromAccount(This,pAccount,pInetServer);
}
FORCEINLINE HRESULT IIMAPTransport_Connect(IIMAPTransport* This,LPINETSERVER pInetServer,boolean fAuthenticate,boolean fCommandLogging) {
    return This->lpVtbl->Connect(This,pInetServer,fAuthenticate,fCommandLogging);
}
FORCEINLINE HRESULT IIMAPTransport_HandsOffCallback(IIMAPTransport* This) {
    return This->lpVtbl->HandsOffCallback(This);
}
FORCEINLINE HRESULT IIMAPTransport_Disconnect(IIMAPTransport* This) {
    return This->lpVtbl->Disconnect(This);
}
FORCEINLINE HRESULT IIMAPTransport_DropConnection(IIMAPTransport* This) {
    return This->lpVtbl->DropConnection(This);
}
FORCEINLINE HRESULT IIMAPTransport_GetStatus(IIMAPTransport* This,IXPSTATUS *pCurrentStatus) {
    return This->lpVtbl->GetStatus(This,pCurrentStatus);
}
/*** IIMAPTransport methods ***/
FORCEINLINE HRESULT IIMAPTransport_InitNew(IIMAPTransport* This,LPSTR pszLogFilePath,IIMAPCallback *pCBHandler) {
    return This->lpVtbl->InitNew(This,pszLogFilePath,pCBHandler);
}
FORCEINLINE HRESULT IIMAPTransport_NewIRangeList(IIMAPTransport* This,IRangeList **pprlNewRangeList) {
    return This->lpVtbl->NewIRangeList(This,pprlNewRangeList);
}
FORCEINLINE HRESULT IIMAPTransport_Capability(IIMAPTransport* This,DWORD *pdwCapabilityFlags) {
    return This->lpVtbl->Capability(This,pdwCapabilityFlags);
}
FORCEINLINE HRESULT IIMAPTransport_Select(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxName) {
    return This->lpVtbl->Select(This,wParam,lParam,pCBHandler,lpszMailboxName);
}
FORCEINLINE HRESULT IIMAPTransport_Examine(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxName) {
    return This->lpVtbl->Examine(This,wParam,lParam,pCBHandler,lpszMailboxName);
}
FORCEINLINE HRESULT IIMAPTransport_Create(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxName) {
    return This->lpVtbl->Create(This,wParam,lParam,pCBHandler,lpszMailboxName);
}
FORCEINLINE HRESULT IIMAPTransport_Delete(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxName) {
    return This->lpVtbl->Delete(This,wParam,lParam,pCBHandler,lpszMailboxName);
}
FORCEINLINE HRESULT IIMAPTransport_Rename(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxName,LPSTR lpszNewMailboxName) {
    return This->lpVtbl->Rename(This,wParam,lParam,pCBHandler,lpszMailboxName,lpszNewMailboxName);
}
FORCEINLINE HRESULT IIMAPTransport_Subscribe(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxName) {
    return This->lpVtbl->Subscribe(This,wParam,lParam,pCBHandler,lpszMailboxName);
}
FORCEINLINE HRESULT IIMAPTransport_Unsubscribe(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxName) {
    return This->lpVtbl->Unsubscribe(This,wParam,lParam,pCBHandler,lpszMailboxName);
}
FORCEINLINE HRESULT IIMAPTransport_List(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxNameReference,LPSTR lpszMailboxNamePattern) {
    return This->lpVtbl->List(This,wParam,lParam,pCBHandler,lpszMailboxNameReference,lpszMailboxNamePattern);
}
FORCEINLINE HRESULT IIMAPTransport_Lsub(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxNameReference,LPSTR lpszMailboxNamePattern) {
    return This->lpVtbl->Lsub(This,wParam,lParam,pCBHandler,lpszMailboxNameReference,lpszMailboxNamePattern);
}
FORCEINLINE HRESULT IIMAPTransport_Append(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszMailboxName,LPSTR lpszMessageFlags,FILETIME ftMessageDateTime,LPSTREAM lpstmMessageToSave) {
...
FORCEINLINE HRESULT IIMAPTransport_Close(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler) {
    return This->lpVtbl->Close(This,wParam,lParam,pCBHandler);
}
FORCEINLINE HRESULT IIMAPTransport_Expunge(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler) {
    return This->lpVtbl->Expunge(This,wParam,lParam,pCBHandler);
}
FORCEINLINE HRESULT IIMAPTransport_Search(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR lpszSearchCriteria,boolean bReturnUIDs,IRangeList *pMsgRange,boolean bUIDRangeList) {
    return This->lpVtbl->Search(This,wParam,lParam,pCBHandler,lpszSearchCriteria,bReturnUIDs,pMsgRange,bUIDRangeList);
}
FORCEINLINE HRESULT IIMAPTransport_Fetch(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,IRangeList *pMsgRange,boolean bUIDMsgRange,LPSTR lpszFetchArgs) {
    return This->lpVtbl->Fetch(This,wParam,lParam,pCBHandler,pMsgRange,bUIDMsgRange,lpszFetchArgs);
}
FORCEINLINE HRESULT IIMAPTransport_Store(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,IRangeList *pMsgRange,boolean bUIDRangeList,LPSTR lpszStoreArgs) {
    return This->lpVtbl->Store(This,wParam,lParam,pCBHandler,pMsgRange,bUIDRangeList,lpszStoreArgs);
}
FORCEINLINE HRESULT IIMAPTransport_Copy(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,IRangeList *pMsgRange,boolean bUIDRangeList,LPSTR lpszMailboxName) {
    return This->lpVtbl->Copy(This,wParam,lParam,pCBHandler,pMsgRange,bUIDRangeList,lpszMailboxName);
}
FORCEINLINE HRESULT IIMAPTransport_Noop(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler) {
    return This->lpVtbl->Noop(This,wParam,lParam,pCBHandler);
}
FORCEINLINE HRESULT IIMAPTransport_ResizeMsgSeqNumTable(IIMAPTransport* This,DWORD dwSizeOfMbox) {
    return This->lpVtbl->ResizeMsgSeqNumTable(This,dwSizeOfMbox);
}
FORCEINLINE HRESULT IIMAPTransport_UpdateSeqNumToUID(IIMAPTransport* This,DWORD dwMsgSeqNum,DWORD dwUID) {
    return This->lpVtbl->UpdateSeqNumToUID(This,dwMsgSeqNum,dwUID);
}
FORCEINLINE HRESULT IIMAPTransport_RemoveSequenceNum(IIMAPTransport* This,DWORD dwDeletedMsgSeqNum) {
    return This->lpVtbl->RemoveSequenceNum(This,dwDeletedMsgSeqNum);
}
FORCEINLINE HRESULT IIMAPTransport_MsgSeqNumToUID(IIMAPTransport* This,DWORD dwMsgSeqNum,DWORD *pdwUID) {
    return This->lpVtbl->MsgSeqNumToUID(This,dwMsgSeqNum,pdwUID);
}
FORCEINLINE HRESULT IIMAPTransport_GetMsgSeqNumToUIDArray(IIMAPTransport* This,DWORD **ppdwMsgSeqNumToUIDArray,DWORD *pdwNumberOfElements) {
    return This->lpVtbl->GetMsgSeqNumToUIDArray(This,ppdwMsgSeqNumToUIDArray,pdwNumberOfElements);
}
FORCEINLINE HRESULT IIMAPTransport_GetHighestMsgSeqNum(IIMAPTransport* This,DWORD *pdwHighestMSN) {
    return This->lpVtbl->GetHighestMsgSeqNum(This,pdwHighestMSN);
}
FORCEINLINE HRESULT IIMAPTransport_ResetMsgSeqNumToUID(IIMAPTransport* This) {
    return This->lpVtbl->ResetMsgSeqNumToUID(This);
}
FORCEINLINE HRESULT IIMAPTransport_SetDefaultCBHandler(IIMAPTransport* This,IIMAPCallback *pCBHandler) {
    return This->lpVtbl->SetDefaultCBHandler(This,pCBHandler);
}
FORCEINLINE HRESULT IIMAPTransport_Status(IIMAPTransport* This,WPARAM wParam,LPARAM lParam,IIMAPCallback *pCBHandler,LPSTR pszMailboxName,LPSTR pszStatusCmdArgs) {
