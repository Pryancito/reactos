/*** Autogenerated by WIDL <undefined version> from ieautomation.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IInternetExplorerManager_QueryInterface(IInternetExplorerManager* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IInternetExplorerManager_AddRef(IInternetExplorerManager* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IInternetExplorerManager_Release(IInternetExplorerManager* This) {
    return This->lpVtbl->Release(This);
}
/*** IInternetExplorerManager methods ***/
FORCEINLINE HRESULT IInternetExplorerManager_CreateObject(IInternetExplorerManager* This,DWORD config,LPCWSTR url,REFIID riid,void **ppv) {
