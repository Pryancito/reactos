/*** Autogenerated by WIDL <undefined version> from netcon.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetConnection_QueryInterface(INetConnection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetConnection_AddRef(INetConnection* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetConnection_Release(INetConnection* This) {
    return This->lpVtbl->Release(This);
}
/*** INetConnection methods ***/
FORCEINLINE HRESULT INetConnection_Connect(INetConnection* This) {
    return This->lpVtbl->Connect(This);
}
FORCEINLINE HRESULT INetConnection_Disconnect(INetConnection* This) {
    return This->lpVtbl->Disconnect(This);
}
FORCEINLINE HRESULT INetConnection_Delete(INetConnection* This) {
    return This->lpVtbl->Delete(This);
}
FORCEINLINE HRESULT INetConnection_Duplicate(INetConnection* This,LPCWSTR pszwDuplicateName,INetConnection **ppCon) {
    return This->lpVtbl->Duplicate(This,pszwDuplicateName,ppCon);
}
FORCEINLINE HRESULT INetConnection_GetProperties(INetConnection* This,NETCON_PROPERTIES **ppProps) {
    return This->lpVtbl->GetProperties(This,ppProps);
}
FORCEINLINE HRESULT INetConnection_GetUiObjectClassId(INetConnection* This,CLSID *pclsid) {
    return This->lpVtbl->GetUiObjectClassId(This,pclsid);
}
FORCEINLINE HRESULT INetConnection_Rename(INetConnection* This,LPCWSTR pszwNewName) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetSharingPortMappingProps_QueryInterface(INetSharingPortMappingProps* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetSharingPortMappingProps_AddRef(INetSharingPortMappingProps* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetSharingPortMappingProps_Release(INetSharingPortMappingProps* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT INetSharingPortMappingProps_GetTypeInfoCount(INetSharingPortMappingProps* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_GetTypeInfo(INetSharingPortMappingProps* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_GetIDsOfNames(INetSharingPortMappingProps* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_Invoke(INetSharingPortMappingProps* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** INetSharingPortMappingProps methods ***/
FORCEINLINE HRESULT INetSharingPortMappingProps_get_Name(INetSharingPortMappingProps* This,BSTR *pbstrName) {
    return This->lpVtbl->get_Name(This,pbstrName);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_get_IPProtocol(INetSharingPortMappingProps* This,UCHAR *pucIPProt) {
    return This->lpVtbl->get_IPProtocol(This,pucIPProt);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_get_ExternalPort(INetSharingPortMappingProps* This,LONG *pusPort) {
    return This->lpVtbl->get_ExternalPort(This,pusPort);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_get_InternalPort(INetSharingPortMappingProps* This,LONG *pusPort) {
    return This->lpVtbl->get_InternalPort(This,pusPort);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_get_Options(INetSharingPortMappingProps* This,LONG *pdwOptions) {
    return This->lpVtbl->get_Options(This,pdwOptions);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_get_TargetName(INetSharingPortMappingProps* This,BSTR *pbstrTargetName) {
    return This->lpVtbl->get_TargetName(This,pbstrTargetName);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_get_TargetIPAddress(INetSharingPortMappingProps* This,BSTR *pbstrTargetIPAddress) {
    return This->lpVtbl->get_TargetIPAddress(This,pbstrTargetIPAddress);
}
FORCEINLINE HRESULT INetSharingPortMappingProps_get_Enabled(INetSharingPortMappingProps* This,VARIANT_BOOL *pbool) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetSharingPortMapping_QueryInterface(INetSharingPortMapping* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetSharingPortMapping_AddRef(INetSharingPortMapping* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetSharingPortMapping_Release(INetSharingPortMapping* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT INetSharingPortMapping_GetTypeInfoCount(INetSharingPortMapping* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT INetSharingPortMapping_GetTypeInfo(INetSharingPortMapping* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT INetSharingPortMapping_GetIDsOfNames(INetSharingPortMapping* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT INetSharingPortMapping_Invoke(INetSharingPortMapping* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** INetSharingPortMapping methods ***/
FORCEINLINE HRESULT INetSharingPortMapping_Disable(INetSharingPortMapping* This) {
    return This->lpVtbl->Disable(This);
}
FORCEINLINE HRESULT INetSharingPortMapping_Enable(INetSharingPortMapping* This) {
    return This->lpVtbl->Enable(This);
}
FORCEINLINE HRESULT INetSharingPortMapping_get_Properties(INetSharingPortMapping* This,INetSharingPortMappingProps **ppNSPMP) {
    return This->lpVtbl->get_Properties(This,ppNSPMP);
}
FORCEINLINE HRESULT INetSharingPortMapping_Delete(INetSharingPortMapping* This) {
    return This->lpVtbl->Delete(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetSharingPortMappingCollection_QueryInterface(INetSharingPortMappingCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetSharingPortMappingCollection_AddRef(INetSharingPortMappingCollection* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetSharingPortMappingCollection_Release(INetSharingPortMappingCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT INetSharingPortMappingCollection_GetTypeInfoCount(INetSharingPortMappingCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT INetSharingPortMappingCollection_GetTypeInfo(INetSharingPortMappingCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT INetSharingPortMappingCollection_GetIDsOfNames(INetSharingPortMappingCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT INetSharingPortMappingCollection_Invoke(INetSharingPortMappingCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** INetSharingPortMappingCollection methods ***/
FORCEINLINE HRESULT INetSharingPortMappingCollection_get__NewEnum(INetSharingPortMappingCollection* This,IUnknown **pVal) {
    return This->lpVtbl->get__NewEnum(This,pVal);
}
FORCEINLINE HRESULT INetSharingPortMappingCollection_get_Count(INetSharingPortMappingCollection* This,LONG *pVal) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetSharingConfiguration_QueryInterface(INetSharingConfiguration* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetSharingConfiguration_AddRef(INetSharingConfiguration* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetSharingConfiguration_Release(INetSharingConfiguration* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT INetSharingConfiguration_GetTypeInfoCount(INetSharingConfiguration* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT INetSharingConfiguration_GetTypeInfo(INetSharingConfiguration* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT INetSharingConfiguration_GetIDsOfNames(INetSharingConfiguration* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT INetSharingConfiguration_Invoke(INetSharingConfiguration* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** INetSharingConfiguration methods ***/
FORCEINLINE HRESULT INetSharingConfiguration_get_SharingEnabled(INetSharingConfiguration* This,VARIANT_BOOL *pbEnabled) {
    return This->lpVtbl->get_SharingEnabled(This,pbEnabled);
}
FORCEINLINE HRESULT INetSharingConfiguration_get_SharingConnectionType(INetSharingConfiguration* This,SHARINGCONNECTIONTYPE *pType) {
    return This->lpVtbl->get_SharingConnectionType(This,pType);
}
FORCEINLINE HRESULT INetSharingConfiguration_DisableSharing(INetSharingConfiguration* This) {
    return This->lpVtbl->DisableSharing(This);
}
FORCEINLINE HRESULT INetSharingConfiguration_EnableSharing(INetSharingConfiguration* This,SHARINGCONNECTIONTYPE Type) {
    return This->lpVtbl->EnableSharing(This,Type);
}
FORCEINLINE HRESULT INetSharingConfiguration_get_InternetFirewallEnabled(INetSharingConfiguration* This,VARIANT_BOOL *pbEnabled) {
    return This->lpVtbl->get_InternetFirewallEnabled(This,pbEnabled);
}
FORCEINLINE HRESULT INetSharingConfiguration_DisableInternetFirewall(INetSharingConfiguration* This) {
    return This->lpVtbl->DisableInternetFirewall(This);
}
FORCEINLINE HRESULT INetSharingConfiguration_EnableInternetFirewall(INetSharingConfiguration* This) {
    return This->lpVtbl->EnableInternetFirewall(This);
}
FORCEINLINE HRESULT INetSharingConfiguration_get_EnumPortMappings(INetSharingConfiguration* This,SHARINGCONNECTION_ENUM_FLAGS Flags,INetSharingPortMappingCollection **ppColl) {
    return This->lpVtbl->get_EnumPortMappings(This,Flags,ppColl);
}
FORCEINLINE HRESULT INetSharingConfiguration_AddPortMapping(INetSharingConfiguration* This,BSTR bstrName,UCHAR ucIPProtocol,USHORT usExternalPort,USHORT usInternalPort,DWORD dwOptions,BSTR bstrTargetNameOrIPAddress,ICS_TARGETTYPE eTargetType,INetSharingPortMapping **ppMapping) {
...
FORCEINLINE HRESULT INetSharingConfiguration_RemovePortMapping(INetSharingConfiguration* This,INetSharingPortMapping *pMapping) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IEnumNetSharingPublicConnection_QueryInterface(IEnumNetSharingPublicConnection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IEnumNetSharingPublicConnection_AddRef(IEnumNetSharingPublicConnection* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IEnumNetSharingPublicConnection_Release(IEnumNetSharingPublicConnection* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumNetSharingPublicConnection methods ***/
FORCEINLINE HRESULT IEnumNetSharingPublicConnection_Next(IEnumNetSharingPublicConnection* This,ULONG celt,VARIANT *rgVar,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgVar,pceltFetched);
}
FORCEINLINE HRESULT IEnumNetSharingPublicConnection_Skip(IEnumNetSharingPublicConnection* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT IEnumNetSharingPublicConnection_Reset(IEnumNetSharingPublicConnection* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IEnumNetSharingPublicConnection_Clone(IEnumNetSharingPublicConnection* This,IEnumNetSharingPublicConnection **ppenum) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IEnumNetSharingPrivateConnection_QueryInterface(IEnumNetSharingPrivateConnection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IEnumNetSharingPrivateConnection_AddRef(IEnumNetSharingPrivateConnection* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IEnumNetSharingPrivateConnection_Release(IEnumNetSharingPrivateConnection* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumNetSharingPrivateConnection methods ***/
FORCEINLINE HRESULT IEnumNetSharingPrivateConnection_Next(IEnumNetSharingPrivateConnection* This,ULONG celt,VARIANT *rgVar,ULONG *pCeltFetched) {
    return This->lpVtbl->Next(This,celt,rgVar,pCeltFetched);
}
FORCEINLINE HRESULT IEnumNetSharingPrivateConnection_Skip(IEnumNetSharingPrivateConnection* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT IEnumNetSharingPrivateConnection_Reset(IEnumNetSharingPrivateConnection* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IEnumNetSharingPrivateConnection_Clone(IEnumNetSharingPrivateConnection* This,IEnumNetSharingPrivateConnection **ppenum) {
    return This->lpVtbl->Clone(This,ppenum);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetConnectionProps_QueryInterface(INetConnectionProps* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetConnectionProps_AddRef(INetConnectionProps* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetConnectionProps_Release(INetConnectionProps* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT INetConnectionProps_GetTypeInfoCount(INetConnectionProps* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT INetConnectionProps_GetTypeInfo(INetConnectionProps* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT INetConnectionProps_GetIDsOfNames(INetConnectionProps* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT INetConnectionProps_Invoke(INetConnectionProps* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** INetConnectionProps methods ***/
FORCEINLINE HRESULT INetConnectionProps_get_Guid(INetConnectionProps* This,BSTR *pbstrGuid) {
    return This->lpVtbl->get_Guid(This,pbstrGuid);
}
FORCEINLINE HRESULT INetConnectionProps_get_Name(INetConnectionProps* This,BSTR *pbstrName) {
    return This->lpVtbl->get_Name(This,pbstrName);
}
FORCEINLINE HRESULT INetConnectionProps_get_DeviceName(INetConnectionProps* This,BSTR *pbstrDeviceName) {
    return This->lpVtbl->get_DeviceName(This,pbstrDeviceName);
}
FORCEINLINE HRESULT INetConnectionProps_get_Status(INetConnectionProps* This,NETCON_STATUS *pStatus) {
    return This->lpVtbl->get_Status(This,pStatus);
}
FORCEINLINE HRESULT INetConnectionProps_get_MediaType(INetConnectionProps* This,NETCON_MEDIATYPE *pMediaType) {
    return This->lpVtbl->get_MediaType(This,pMediaType);
}
FORCEINLINE HRESULT INetConnectionProps_get_Characteristics(INetConnectionProps* This,DWORD *pdwFlags) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetSharingPublicConnectionCollection_QueryInterface(INetSharingPublicConnectionCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetSharingPublicConnectionCollection_AddRef(INetSharingPublicConnectionCollection* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetSharingPublicConnectionCollection_Release(INetSharingPublicConnectionCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT INetSharingPublicConnectionCollection_GetTypeInfoCount(INetSharingPublicConnectionCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT INetSharingPublicConnectionCollection_GetTypeInfo(INetSharingPublicConnectionCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT INetSharingPublicConnectionCollection_GetIDsOfNames(INetSharingPublicConnectionCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT INetSharingPublicConnectionCollection_Invoke(INetSharingPublicConnectionCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** INetSharingPublicConnectionCollection methods ***/
FORCEINLINE HRESULT INetSharingPublicConnectionCollection_get__NewEnum(INetSharingPublicConnectionCollection* This,IUnknown **pVal) {
    return This->lpVtbl->get__NewEnum(This,pVal);
}
FORCEINLINE HRESULT INetSharingPublicConnectionCollection_get_Count(INetSharingPublicConnectionCollection* This,LONG *pVal) {
    return This->lpVtbl->get_Count(This,pVal);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetSharingEveryConnectionCollection_QueryInterface(INetSharingEveryConnectionCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetSharingEveryConnectionCollection_AddRef(INetSharingEveryConnectionCollection* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetSharingEveryConnectionCollection_Release(INetSharingEveryConnectionCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT INetSharingEveryConnectionCollection_GetTypeInfoCount(INetSharingEveryConnectionCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT INetSharingEveryConnectionCollection_GetTypeInfo(INetSharingEveryConnectionCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT INetSharingEveryConnectionCollection_GetIDsOfNames(INetSharingEveryConnectionCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT INetSharingEveryConnectionCollection_Invoke(INetSharingEveryConnectionCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** INetSharingEveryConnectionCollection methods ***/
FORCEINLINE HRESULT INetSharingEveryConnectionCollection_get__NewEnum(INetSharingEveryConnectionCollection* This,IUnknown **pVal) {
    return This->lpVtbl->get__NewEnum(This,pVal);
}
FORCEINLINE HRESULT INetSharingEveryConnectionCollection_get_Count(INetSharingEveryConnectionCollection* This,LONG *pVal) {
    return This->lpVtbl->get_Count(This,pVal);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetSharingPrivateConnectionCollection_QueryInterface(INetSharingPrivateConnectionCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetSharingPrivateConnectionCollection_AddRef(INetSharingPrivateConnectionCollection* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetSharingPrivateConnectionCollection_Release(INetSharingPrivateConnectionCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT INetSharingPrivateConnectionCollection_GetTypeInfoCount(INetSharingPrivateConnectionCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT INetSharingPrivateConnectionCollection_GetTypeInfo(INetSharingPrivateConnectionCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT INetSharingPrivateConnectionCollection_GetIDsOfNames(INetSharingPrivateConnectionCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT INetSharingPrivateConnectionCollection_Invoke(INetSharingPrivateConnectionCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** INetSharingPrivateConnectionCollection methods ***/
FORCEINLINE HRESULT INetSharingPrivateConnectionCollection_get__NewEnum(INetSharingPrivateConnectionCollection* This,IUnknown **pVal) {
    return This->lpVtbl->get__NewEnum(This,pVal);
}
FORCEINLINE HRESULT INetSharingPrivateConnectionCollection_get_Count(INetSharingPrivateConnectionCollection* This,LONG *pVal) {
    return This->lpVtbl->get_Count(This,pVal);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT INetSharingManager_QueryInterface(INetSharingManager* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG INetSharingManager_AddRef(INetSharingManager* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG INetSharingManager_Release(INetSharingManager* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT INetSharingManager_GetTypeInfoCount(INetSharingManager* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT INetSharingManager_GetTypeInfo(INetSharingManager* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT INetSharingManager_GetIDsOfNames(INetSharingManager* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT INetSharingManager_Invoke(INetSharingManager* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** INetSharingManager methods ***/
FORCEINLINE HRESULT INetSharingManager_get_SharingInstalled(INetSharingManager* This,VARIANT_BOOL *pbInstalled) {
    return This->lpVtbl->get_SharingInstalled(This,pbInstalled);
}
FORCEINLINE HRESULT INetSharingManager_get_EnumPublicConnections(INetSharingManager* This,SHARINGCONNECTION_ENUM_FLAGS Flags,INetSharingPublicConnectionCollection **ppColl) {
    return This->lpVtbl->get_EnumPublicConnections(This,Flags,ppColl);
}
FORCEINLINE HRESULT INetSharingManager_get_EnumPrivateConnections(INetSharingManager* This,SHARINGCONNECTION_ENUM_FLAGS Flags,INetSharingPrivateConnectionCollection **ppColl) {
    return This->lpVtbl->get_EnumPrivateConnections(This,Flags,ppColl);
}
FORCEINLINE HRESULT INetSharingManager_get_INetSharingConfigurationForINetConnection(INetSharingManager* This,INetConnection *pNetConnection,INetSharingConfiguration **ppNetSharingConfiguration) {
    return This->lpVtbl->get_INetSharingConfigurationForINetConnection(This,pNetConnection,ppNetSharingConfiguration);
}
FORCEINLINE HRESULT INetSharingManager_get_EnumEveryConnection(INetSharingManager* This,INetSharingEveryConnectionCollection **ppColl) {
    return This->lpVtbl->get_EnumEveryConnection(This,ppColl);
}
FORCEINLINE HRESULT INetSharingManager_get_NetConnectionProps(INetSharingManager* This,INetConnection *pNetConnection,INetConnectionProps **ppProps) {
