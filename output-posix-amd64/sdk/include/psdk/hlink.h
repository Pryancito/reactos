/*** Autogenerated by WIDL <undefined version> from hlink.idl - Do not edit ***/
...
typedef enum __WIDL_hlink_generated_name_00000010 {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IHlink_QueryInterface(IHlink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IHlink_AddRef(IHlink* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IHlink_Release(IHlink* This) {
    return This->lpVtbl->Release(This);
}
/*** IHlink methods ***/
FORCEINLINE HRESULT IHlink_SetHlinkSite(IHlink* This,IHlinkSite *pihlSite,DWORD dwSiteData) {
    return This->lpVtbl->SetHlinkSite(This,pihlSite,dwSiteData);
}
FORCEINLINE HRESULT IHlink_GetHlinkSite(IHlink* This,IHlinkSite **ppihlSite,DWORD *pdwSiteData) {
    return This->lpVtbl->GetHlinkSite(This,ppihlSite,pdwSiteData);
}
FORCEINLINE HRESULT IHlink_SetMonikerReference(IHlink* This,DWORD grfHLSETF,IMoniker *pimkTarget,LPCWSTR pwzLocation) {
    return This->lpVtbl->SetMonikerReference(This,grfHLSETF,pimkTarget,pwzLocation);
}
FORCEINLINE HRESULT IHlink_GetMonikerReference(IHlink* This,DWORD dwWhichRef,IMoniker **ppimkTarget,LPWSTR *ppwzLocation) {
    return This->lpVtbl->GetMonikerReference(This,dwWhichRef,ppimkTarget,ppwzLocation);
}
FORCEINLINE HRESULT IHlink_SetStringReference(IHlink* This,DWORD grfHLSETF,LPCWSTR pwzTarget,LPCWSTR pwzLocation) {
    return This->lpVtbl->SetStringReference(This,grfHLSETF,pwzTarget,pwzLocation);
}
FORCEINLINE HRESULT IHlink_GetStringReference(IHlink* This,DWORD dwWhichRef,LPWSTR *ppwzTarget,LPWSTR *ppwzLocation) {
    return This->lpVtbl->GetStringReference(This,dwWhichRef,ppwzTarget,ppwzLocation);
}
FORCEINLINE HRESULT IHlink_SetFriendlyName(IHlink* This,LPCWSTR pwzFriendlyName) {
    return This->lpVtbl->SetFriendlyName(This,pwzFriendlyName);
}
FORCEINLINE HRESULT IHlink_GetFriendlyName(IHlink* This,DWORD grfHLFNAMEF,LPWSTR *ppwzFriendlyName) {
    return This->lpVtbl->GetFriendlyName(This,grfHLFNAMEF,ppwzFriendlyName);
}
FORCEINLINE HRESULT IHlink_SetTargetFrameName(IHlink* This,LPCWSTR pwzTargetFrameName) {
    return This->lpVtbl->SetTargetFrameName(This,pwzTargetFrameName);
}
FORCEINLINE HRESULT IHlink_GetTargetFrameName(IHlink* This,LPWSTR *ppwzTargetFrameName) {
    return This->lpVtbl->GetTargetFrameName(This,ppwzTargetFrameName);
}
FORCEINLINE HRESULT IHlink_GetMiscStatus(IHlink* This,DWORD *pdwStatus) {
    return This->lpVtbl->GetMiscStatus(This,pdwStatus);
}
FORCEINLINE HRESULT IHlink_Navigate(IHlink* This,DWORD grfHLNF,LPBC pibc,IBindStatusCallback *pibsc,IHlinkBrowseContext *pihlbc) {
    return This->lpVtbl->Navigate(This,grfHLNF,pibc,pibsc,pihlbc);
}
FORCEINLINE HRESULT IHlink_SetAdditionalParams(IHlink* This,LPCWSTR pwzAdditionalParams) {
    return This->lpVtbl->SetAdditionalParams(This,pwzAdditionalParams);
}
FORCEINLINE HRESULT IHlink_GetAdditionalParams(IHlink* This,LPWSTR *ppwzAdditionalParams) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IHlinkSite_QueryInterface(IHlinkSite* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IHlinkSite_AddRef(IHlinkSite* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IHlinkSite_Release(IHlinkSite* This) {
    return This->lpVtbl->Release(This);
}
/*** IHlinkSite methods ***/
FORCEINLINE HRESULT IHlinkSite_QueryService(IHlinkSite* This,DWORD dwSiteData,REFGUID guidService,REFIID riid,IUnknown **ppiunk) {
    return This->lpVtbl->QueryService(This,dwSiteData,guidService,riid,ppiunk);
}
FORCEINLINE HRESULT IHlinkSite_GetMoniker(IHlinkSite* This,DWORD dwSiteData,DWORD dwAssign,DWORD dwWhich,IMoniker **ppimk) {
    return This->lpVtbl->GetMoniker(This,dwSiteData,dwAssign,dwWhich,ppimk);
}
FORCEINLINE HRESULT IHlinkSite_ReadyToNavigate(IHlinkSite* This,DWORD dwSiteData,DWORD dwReserved) {
    return This->lpVtbl->ReadyToNavigate(This,dwSiteData,dwReserved);
}
FORCEINLINE HRESULT IHlinkSite_OnNavigationComplete(IHlinkSite* This,DWORD dwSiteData,DWORD dwreserved,HRESULT hrError,LPCWSTR pwzError) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IEnumHLITEM_QueryInterface(IEnumHLITEM* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IEnumHLITEM_AddRef(IEnumHLITEM* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IEnumHLITEM_Release(IEnumHLITEM* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumHLITEM methods ***/
FORCEINLINE HRESULT IEnumHLITEM_Next(IEnumHLITEM* This,ULONG celt,HLITEM *rgelt,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgelt,pceltFetched);
}
FORCEINLINE HRESULT IEnumHLITEM_Skip(IEnumHLITEM* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
FORCEINLINE HRESULT IEnumHLITEM_Reset(IEnumHLITEM* This) {
    return This->lpVtbl->Reset(This);
}
FORCEINLINE HRESULT IEnumHLITEM_Clone(IEnumHLITEM* This,IEnumHLITEM **ppienumhlitem) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IHlinkBrowseContext_QueryInterface(IHlinkBrowseContext* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IHlinkBrowseContext_AddRef(IHlinkBrowseContext* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IHlinkBrowseContext_Release(IHlinkBrowseContext* This) {
    return This->lpVtbl->Release(This);
}
/*** IHlinkBrowseContext methods ***/
FORCEINLINE HRESULT IHlinkBrowseContext_Register(IHlinkBrowseContext* This,DWORD reserved,IUnknown *piunk,IMoniker *pimk,DWORD *pdwRegister) {
    return This->lpVtbl->Register(This,reserved,piunk,pimk,pdwRegister);
}
FORCEINLINE HRESULT IHlinkBrowseContext_GetObject(IHlinkBrowseContext* This,IMoniker *pimk,BOOL fBindIfRootRegistered,IUnknown **ppiunk) {
    return This->lpVtbl->GetObject(This,pimk,fBindIfRootRegistered,ppiunk);
}
FORCEINLINE HRESULT IHlinkBrowseContext_Revoke(IHlinkBrowseContext* This,DWORD dwRegister) {
    return This->lpVtbl->Revoke(This,dwRegister);
}
FORCEINLINE HRESULT IHlinkBrowseContext_SetBrowseWindowInfo(IHlinkBrowseContext* This,HLBWINFO *phlbwi) {
    return This->lpVtbl->SetBrowseWindowInfo(This,phlbwi);
}
FORCEINLINE HRESULT IHlinkBrowseContext_GetBrowseWindowInfo(IHlinkBrowseContext* This,HLBWINFO *phlbwi) {
    return This->lpVtbl->GetBrowseWindowInfo(This,phlbwi);
}
FORCEINLINE HRESULT IHlinkBrowseContext_SetInitialHlink(IHlinkBrowseContext* This,IMoniker *pimkTarget,LPCWSTR pwzLocation,LPCWSTR pwzFriendlyName) {
    return This->lpVtbl->SetInitialHlink(This,pimkTarget,pwzLocation,pwzFriendlyName);
}
FORCEINLINE HRESULT IHlinkBrowseContext_OnNavigateHlink(IHlinkBrowseContext* This,DWORD grfHLNF,IMoniker *pimkTarget,LPCWSTR pwzLocation,LPCWSTR pwzFriendlyName,ULONG *puHLID) {
    return This->lpVtbl->OnNavigateHlink(This,grfHLNF,pimkTarget,pwzLocation,pwzFriendlyName,puHLID);
}
FORCEINLINE HRESULT IHlinkBrowseContext_UpdateHlink(IHlinkBrowseContext* This,ULONG uHLID,IMoniker *pimkTarget,LPCWSTR pwzLocation,LPCWSTR pwzFriendlyName) {
    return This->lpVtbl->UpdateHlink(This,uHLID,pimkTarget,pwzLocation,pwzFriendlyName);
}
FORCEINLINE HRESULT IHlinkBrowseContext_EnumNavigationStack(IHlinkBrowseContext* This,DWORD dwReserved,DWORD grfHLFNAMEF,IEnumHLITEM **ppienumhlitem) {
    return This->lpVtbl->EnumNavigationStack(This,dwReserved,grfHLFNAMEF,ppienumhlitem);
}
FORCEINLINE HRESULT IHlinkBrowseContext_QueryHlink(IHlinkBrowseContext* This,DWORD grfHLQF,ULONG uHLID) {
    return This->lpVtbl->QueryHlink(This,grfHLQF,uHLID);
}
FORCEINLINE HRESULT IHlinkBrowseContext_GetHlink(IHlinkBrowseContext* This,ULONG uHLID,IHlink **ppihl) {
    return This->lpVtbl->GetHlink(This,uHLID,ppihl);
}
FORCEINLINE HRESULT IHlinkBrowseContext_SetCurrentHlink(IHlinkBrowseContext* This,ULONG uHLID) {
    return This->lpVtbl->SetCurrentHlink(This,uHLID);
}
FORCEINLINE HRESULT IHlinkBrowseContext_Clone(IHlinkBrowseContext* This,IUnknown *piunkOuter,REFIID riid,IUnknown **ppiunkObj) {
    return This->lpVtbl->Clone(This,piunkOuter,riid,ppiunkObj);
}
FORCEINLINE HRESULT IHlinkBrowseContext_Close(IHlinkBrowseContext* This,DWORD reserved) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IHlinkTarget_QueryInterface(IHlinkTarget* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IHlinkTarget_AddRef(IHlinkTarget* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IHlinkTarget_Release(IHlinkTarget* This) {
    return This->lpVtbl->Release(This);
}
/*** IHlinkTarget methods ***/
FORCEINLINE HRESULT IHlinkTarget_SetBrowseContext(IHlinkTarget* This,IHlinkBrowseContext *pihlbc) {
    return This->lpVtbl->SetBrowseContext(This,pihlbc);
}
FORCEINLINE HRESULT IHlinkTarget_GetBrowseContext(IHlinkTarget* This,IHlinkBrowseContext **ppihlbc) {
    return This->lpVtbl->GetBrowseContext(This,ppihlbc);
}
FORCEINLINE HRESULT IHlinkTarget_Navigate(IHlinkTarget* This,DWORD grfHLNF,LPCWSTR pwzJumpLocation) {
    return This->lpVtbl->Navigate(This,grfHLNF,pwzJumpLocation);
}
FORCEINLINE HRESULT IHlinkTarget_GetMoniker(IHlinkTarget* This,LPCWSTR pwzLocation,DWORD dwAssign,IMoniker **ppimkLocation) {
    return This->lpVtbl->GetMoniker(This,pwzLocation,dwAssign,ppimkLocation);
}
FORCEINLINE HRESULT IHlinkTarget_GetFriendlyName(IHlinkTarget* This,LPCWSTR pwzLocation,LPWSTR *ppwzFriendlyName) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IHlinkFrame_QueryInterface(IHlinkFrame* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IHlinkFrame_AddRef(IHlinkFrame* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IHlinkFrame_Release(IHlinkFrame* This) {
    return This->lpVtbl->Release(This);
}
/*** IHlinkFrame methods ***/
FORCEINLINE HRESULT IHlinkFrame_SetBrowseContext(IHlinkFrame* This,IHlinkBrowseContext *pihlbc) {
    return This->lpVtbl->SetBrowseContext(This,pihlbc);
}
FORCEINLINE HRESULT IHlinkFrame_GetBrowseContext(IHlinkFrame* This,IHlinkBrowseContext **ppihlbc) {
    return This->lpVtbl->GetBrowseContext(This,ppihlbc);
}
FORCEINLINE HRESULT IHlinkFrame_Navigate(IHlinkFrame* This,DWORD grfHLNF,LPBC pbc,IBindStatusCallback *pibsc,IHlink *pihlNavigate) {
    return This->lpVtbl->Navigate(This,grfHLNF,pbc,pibsc,pihlNavigate);
}
FORCEINLINE HRESULT IHlinkFrame_OnNavigate(IHlinkFrame* This,DWORD grfHLNF,IMoniker *pimkTarget,LPCWSTR pwzLocation,LPCWSTR pwzFriendlyName,DWORD dwreserved) {
    return This->lpVtbl->OnNavigate(This,grfHLNF,pimkTarget,pwzLocation,pwzFriendlyName,dwreserved);
}
FORCEINLINE HRESULT IHlinkFrame_UpdateHlink(IHlinkFrame* This,ULONG uHLID,IMoniker *pimkTarget,LPCWSTR pwzLocation,LPCWSTR pwzFriendlyName) {
    return This->lpVtbl->UpdateHlink(This,uHLID,pimkTarget,pwzLocation,pwzFriendlyName);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IExtensionServices_QueryInterface(IExtensionServices* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IExtensionServices_AddRef(IExtensionServices* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IExtensionServices_Release(IExtensionServices* This) {
    return This->lpVtbl->Release(This);
}
/*** IExtensionServices methods ***/
FORCEINLINE HRESULT IExtensionServices_SetAdditionalHeaders(IExtensionServices* This,LPCWSTR pwzAdditionalHeaders) {
    return This->lpVtbl->SetAdditionalHeaders(This,pwzAdditionalHeaders);
}
FORCEINLINE HRESULT IExtensionServices_SetAuthenticateData(IExtensionServices* This,HWND phwnd,LPCWSTR pwzUsername,LPCWSTR pwzPassword) {
