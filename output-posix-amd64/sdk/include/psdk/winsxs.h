/*** Autogenerated by WIDL <undefined version> from winsxs.idl - Do not edit ***/
...
/*** IAssemblyCache methods ***/
FORCEINLINE HRESULT IAssemblyCache_UninstallAssembly(IAssemblyCache* This,DWORD flags,LPCWSTR name,LPCFUSION_INSTALL_REFERENCE ref,ULONG *disp) {
    return This->lpVtbl->UninstallAssembly(This,flags,name,ref,disp);
}
FORCEINLINE HRESULT IAssemblyCache_QueryAssemblyInfo(IAssemblyCache* This,DWORD flags,LPCWSTR name,ASSEMBLY_INFO *info) {
    return This->lpVtbl->QueryAssemblyInfo(This,flags,name,info);
}
FORCEINLINE HRESULT IAssemblyCache_CreateAssemblyCacheItem(IAssemblyCache* This,DWORD flags,PVOID reserved,IAssemblyCacheItem **item,LPCWSTR name) {
    return This->lpVtbl->CreateAssemblyCacheItem(This,flags,reserved,item,name);
}
FORCEINLINE HRESULT IAssemblyCache_Reserved(IAssemblyCache* This,IUnknown **reserved) {
    return This->lpVtbl->Reserved(This,reserved);
}
FORCEINLINE HRESULT IAssemblyCache_InstallAssembly(IAssemblyCache* This,DWORD flags,LPCWSTR path,LPCFUSION_INSTALL_REFERENCE ref) {
...
/*** IAssemblyCacheItem methods ***/
FORCEINLINE HRESULT IAssemblyCacheItem_CreateStream(IAssemblyCacheItem* This,DWORD flags,LPCWSTR name,DWORD format,DWORD format_flags,IStream **stream,ULARGE_INTEGER *max_size) {
    return This->lpVtbl->CreateStream(This,flags,name,format,format_flags,stream,max_size);
}
FORCEINLINE HRESULT IAssemblyCacheItem_Commit(IAssemblyCacheItem* This,DWORD flags,ULONG *disp) {
...
/*** IAssemblyName methods ***/
FORCEINLINE HRESULT IAssemblyName_SetProperty(IAssemblyName* This,DWORD id,LPVOID property,DWORD size) {
    return This->lpVtbl->SetProperty(This,id,property,size);
}
FORCEINLINE HRESULT IAssemblyName_GetProperty(IAssemblyName* This,DWORD id,LPVOID buffer,LPDWORD buflen) {
...
FORCEINLINE HRESULT IAssemblyName_GetDisplayName(IAssemblyName* This,LPWSTR buffer,LPDWORD buflen,DWORD flags) {
    return This->lpVtbl->GetDisplayName(This,buffer,buflen,flags);
}
FORCEINLINE HRESULT IAssemblyName_Reserved(IAssemblyName* This,REFIID riid,IUnknown *pUnkReserved1,IUnknown *pUnkReserved2,LPCOLESTR szReserved,LONGLONG llReserved,LPVOID pvReserved,DWORD cbReserved,LPVOID *ppReserved) {
    return This->lpVtbl->Reserved(This,riid,pUnkReserved1,pUnkReserved2,szReserved,llReserved,pvReserved,cbReserved,ppReserved);
}
FORCEINLINE HRESULT IAssemblyName_GetName(IAssemblyName* This,LPDWORD buflen,LPWSTR buffer) {
    return This->lpVtbl->GetName(This,buflen,buffer);
}
FORCEINLINE HRESULT IAssemblyName_GetVersion(IAssemblyName* This,LPDWORD hi,LPDWORD low) {
    return This->lpVtbl->GetVersion(This,hi,low);
}
FORCEINLINE HRESULT IAssemblyName_IsEqual(IAssemblyName* This,IAssemblyName *name,DWORD flags) {
    return This->lpVtbl->IsEqual(This,name,flags);
}
FORCEINLINE HRESULT IAssemblyName_Clone(IAssemblyName* This,IAssemblyName **name) {
