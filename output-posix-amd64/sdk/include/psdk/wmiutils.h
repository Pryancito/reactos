/*** Autogenerated by WIDL <undefined version> from wmiutils.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IWbemPathKeyList_QueryInterface(IWbemPathKeyList* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IWbemPathKeyList_AddRef(IWbemPathKeyList* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IWbemPathKeyList_Release(IWbemPathKeyList* This) {
    return This->lpVtbl->Release(This);
}
/*** IWbemPathKeyList methods ***/
FORCEINLINE HRESULT IWbemPathKeyList_GetCount(IWbemPathKeyList* This,ULONG *puKeyCount) {
    return This->lpVtbl->GetCount(This,puKeyCount);
}
FORCEINLINE HRESULT IWbemPathKeyList_SetKey(IWbemPathKeyList* This,LPCWSTR wszName,ULONG uFlags,ULONG uCimType,LPVOID pKeyVal) {
    return This->lpVtbl->SetKey(This,wszName,uFlags,uCimType,pKeyVal);
}
FORCEINLINE HRESULT IWbemPathKeyList_SetKey2(IWbemPathKeyList* This,LPCWSTR wszName,ULONG uFlags,ULONG uCimType,VARIANT *pKeyVal) {
    return This->lpVtbl->SetKey2(This,wszName,uFlags,uCimType,pKeyVal);
}
FORCEINLINE HRESULT IWbemPathKeyList_GetKey(IWbemPathKeyList* This,ULONG uKeyIx,ULONG uFlags,ULONG *puNameBufSize,LPWSTR pszKeyName,ULONG *puKeyValBufSize,LPVOID pKeyVal,ULONG *puApparentCimType) {
    return This->lpVtbl->GetKey(This,uKeyIx,uFlags,puNameBufSize,pszKeyName,puKeyValBufSize,pKeyVal,puApparentCimType);
}
FORCEINLINE HRESULT IWbemPathKeyList_GetKey2(IWbemPathKeyList* This,ULONG uKeyIx,ULONG uFlags,ULONG *puNameBufSize,LPWSTR pszKeyName,VARIANT *pKeyValue,ULONG *puApparentCimType) {
    return This->lpVtbl->GetKey2(This,uKeyIx,uFlags,puNameBufSize,pszKeyName,pKeyValue,puApparentCimType);
}
FORCEINLINE HRESULT IWbemPathKeyList_RemoveKey(IWbemPathKeyList* This,LPCWSTR wszName,ULONG uFlags) {
    return This->lpVtbl->RemoveKey(This,wszName,uFlags);
}
FORCEINLINE HRESULT IWbemPathKeyList_RemoveAllKeys(IWbemPathKeyList* This,ULONG uFlags) {
    return This->lpVtbl->RemoveAllKeys(This,uFlags);
}
FORCEINLINE HRESULT IWbemPathKeyList_MakeSingleton(IWbemPathKeyList* This,boolean bSet) {
    return This->lpVtbl->MakeSingleton(This,bSet);
}
FORCEINLINE HRESULT IWbemPathKeyList_GetInfo(IWbemPathKeyList* This,ULONG uRequestedInfo,ULONGLONG *puResponse) {
    return This->lpVtbl->GetInfo(This,uRequestedInfo,puResponse);
}
FORCEINLINE HRESULT IWbemPathKeyList_GetText(IWbemPathKeyList* This,LONG lFlags,ULONG *puBuffLength,LPWSTR pszText) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IWbemPath_QueryInterface(IWbemPath* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IWbemPath_AddRef(IWbemPath* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IWbemPath_Release(IWbemPath* This) {
    return This->lpVtbl->Release(This);
}
/*** IWbemPath methods ***/
FORCEINLINE HRESULT IWbemPath_SetText(IWbemPath* This,ULONG uMode,LPCWSTR pszPath) {
    return This->lpVtbl->SetText(This,uMode,pszPath);
}
FORCEINLINE HRESULT IWbemPath_GetText(IWbemPath* This,LONG lFlags,ULONG *puBuffLength,LPWSTR pszText) {
    return This->lpVtbl->GetText(This,lFlags,puBuffLength,pszText);
}
FORCEINLINE HRESULT IWbemPath_GetInfo(IWbemPath* This,ULONG uRequestedInfo,ULONGLONG *puResponse) {
    return This->lpVtbl->GetInfo(This,uRequestedInfo,puResponse);
}
FORCEINLINE HRESULT IWbemPath_SetServer(IWbemPath* This,LPCWSTR Name) {
    return This->lpVtbl->SetServer(This,Name);
}
FORCEINLINE HRESULT IWbemPath_GetServer(IWbemPath* This,ULONG *puNameBufLength,LPWSTR pName) {
    return This->lpVtbl->GetServer(This,puNameBufLength,pName);
}
FORCEINLINE HRESULT IWbemPath_GetNamespaceCount(IWbemPath* This,ULONG *puCount) {
    return This->lpVtbl->GetNamespaceCount(This,puCount);
}
FORCEINLINE HRESULT IWbemPath_SetNamespaceAt(IWbemPath* This,ULONG uIndex,LPCWSTR pszName) {
    return This->lpVtbl->SetNamespaceAt(This,uIndex,pszName);
}
FORCEINLINE HRESULT IWbemPath_GetNamespaceAt(IWbemPath* This,ULONG uIndex,ULONG *puNameBufLength,LPWSTR pName) {
    return This->lpVtbl->GetNamespaceAt(This,uIndex,puNameBufLength,pName);
}
FORCEINLINE HRESULT IWbemPath_RemoveNamespaceAt(IWbemPath* This,ULONG uIndex) {
    return This->lpVtbl->RemoveNamespaceAt(This,uIndex);
}
FORCEINLINE HRESULT IWbemPath_RemoveAllNamespaces(IWbemPath* This) {
    return This->lpVtbl->RemoveAllNamespaces(This);
}
FORCEINLINE HRESULT IWbemPath_GetScopeCount(IWbemPath* This,ULONG *puCount) {
    return This->lpVtbl->GetScopeCount(This,puCount);
}
FORCEINLINE HRESULT IWbemPath_SetScope(IWbemPath* This,ULONG uIndex,LPWSTR pszClass) {
    return This->lpVtbl->SetScope(This,uIndex,pszClass);
}
FORCEINLINE HRESULT IWbemPath_SetScopeFromText(IWbemPath* This,ULONG uIndex,LPWSTR pszText) {
    return This->lpVtbl->SetScopeFromText(This,uIndex,pszText);
}
FORCEINLINE HRESULT IWbemPath_GetScope(IWbemPath* This,ULONG uIndex,ULONG *puClassNameBufSize,LPWSTR pszClass,IWbemPathKeyList **pKeyList) {
    return This->lpVtbl->GetScope(This,uIndex,puClassNameBufSize,pszClass,pKeyList);
}
FORCEINLINE HRESULT IWbemPath_GetScopeAsText(IWbemPath* This,ULONG uIndex,ULONG *puTextBufSize,LPWSTR pszText) {
    return This->lpVtbl->GetScopeAsText(This,uIndex,puTextBufSize,pszText);
}
FORCEINLINE HRESULT IWbemPath_RemoveScope(IWbemPath* This,ULONG uIndex) {
    return This->lpVtbl->RemoveScope(This,uIndex);
}
FORCEINLINE HRESULT IWbemPath_RemoveAllScopes(IWbemPath* This) {
    return This->lpVtbl->RemoveAllScopes(This);
}
FORCEINLINE HRESULT IWbemPath_SetClassName(IWbemPath* This,LPCWSTR Name) {
    return This->lpVtbl->SetClassName(This,Name);
}
FORCEINLINE HRESULT IWbemPath_GetClassName(IWbemPath* This,ULONG *puBuffLength,LPWSTR pszName) {
    return This->lpVtbl->GetClassName(This,puBuffLength,pszName);
}
FORCEINLINE HRESULT IWbemPath_GetKeyList(IWbemPath* This,IWbemPathKeyList **pOut) {
    return This->lpVtbl->GetKeyList(This,pOut);
}
FORCEINLINE HRESULT IWbemPath_CreateClassPart(IWbemPath* This,LONG lFlags,LPCWSTR Name) {
    return This->lpVtbl->CreateClassPart(This,lFlags,Name);
}
FORCEINLINE HRESULT IWbemPath_DeleteClassPart(IWbemPath* This,LONG lFlags) {
    return This->lpVtbl->DeleteClassPart(This,lFlags);
}
FORCEINLINE BOOL IWbemPath_IsRelative(IWbemPath* This,LPWSTR wszMachine,LPWSTR wszNamespace) {
    return This->lpVtbl->IsRelative(This,wszMachine,wszNamespace);
}
FORCEINLINE BOOL IWbemPath_IsRelativeOrChild(IWbemPath* This,LPWSTR wszMachine,LPWSTR wszNamespace,LONG lFlags) {
    return This->lpVtbl->IsRelativeOrChild(This,wszMachine,wszNamespace,lFlags);
}
FORCEINLINE BOOL IWbemPath_IsLocal(IWbemPath* This,LPCWSTR wszMachine) {
    return This->lpVtbl->IsLocal(This,wszMachine);
}
FORCEINLINE BOOL IWbemPath_IsSameClassName(IWbemPath* This,LPCWSTR wszClass) {
