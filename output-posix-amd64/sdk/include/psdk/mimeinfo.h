/*** Autogenerated by WIDL <undefined version> from mimeinfo.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IMimeInfo_QueryInterface(IMimeInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IMimeInfo_AddRef(IMimeInfo* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IMimeInfo_Release(IMimeInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeInfo methods ***/
FORCEINLINE HRESULT IMimeInfo_GetMimeCLSIDMapping(IMimeInfo* This,UINT *pcTypes,LPCSTR **ppszTypes,CLSID **ppclsID) {
