/*** Autogenerated by WIDL <undefined version> from imnact.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IImnAdviseAccount_QueryInterface(IImnAdviseAccount* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IImnAdviseAccount_AddRef(IImnAdviseAccount* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IImnAdviseAccount_Release(IImnAdviseAccount* This) {
    return This->lpVtbl->Release(This);
}
/*** IImnAdviseAccount methods ***/
FORCEINLINE HRESULT IImnAdviseAccount_AdviseAccount(IImnAdviseAccount* This,DWORD dwAdviseType,ACTX *pAcctCtx) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IImnAdviseMigrateServer_QueryInterface(IImnAdviseMigrateServer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IImnAdviseMigrateServer_AddRef(IImnAdviseMigrateServer* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IImnAdviseMigrateServer_Release(IImnAdviseMigrateServer* This) {
    return This->lpVtbl->Release(This);
}
/*** IImnAdviseMigrateServer methods ***/
FORCEINLINE HRESULT IImnAdviseMigrateServer_MigrateServer(IImnAdviseMigrateServer* This,DWORD dwSrvType,IImnAccount *pAccount) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IImnEnumAccounts_QueryInterface(IImnEnumAccounts* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IImnEnumAccounts_AddRef(IImnEnumAccounts* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IImnEnumAccounts_Release(IImnEnumAccounts* This) {
    return This->lpVtbl->Release(This);
}
/*** IImnEnumAccounts methods ***/
FORCEINLINE HRESULT IImnEnumAccounts_GetCount(IImnEnumAccounts* This,ULONG *pcItems) {
    return This->lpVtbl->GetCount(This,pcItems);
}
FORCEINLINE HRESULT IImnEnumAccounts_SortByAccountName(IImnEnumAccounts* This) {
    return This->lpVtbl->SortByAccountName(This);
}
FORCEINLINE HRESULT IImnEnumAccounts_GetNext(IImnEnumAccounts* This,IImnAccount **ppAccount) {
    return This->lpVtbl->GetNext(This,ppAccount);
}
FORCEINLINE HRESULT IImnEnumAccounts_Reset(IImnEnumAccounts* This) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IImnAccountManager_QueryInterface(IImnAccountManager* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IImnAccountManager_AddRef(IImnAccountManager* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IImnAccountManager_Release(IImnAccountManager* This) {
    return This->lpVtbl->Release(This);
}
/*** IImnAccountManager methods ***/
FORCEINLINE HRESULT IImnAccountManager_Init(IImnAccountManager* This,IImnAdviseMigrateServer *pAdviseMigrateServer) {
    return This->lpVtbl->Init(This,pAdviseMigrateServer);
}
FORCEINLINE HRESULT IImnAccountManager_CreateAccountObject(IImnAccountManager* This,ACCTTYPE AcctType,IImnAccount **ppAccount) {
    return This->lpVtbl->CreateAccountObject(This,AcctType,ppAccount);
}
FORCEINLINE HRESULT IImnAccountManager_Enumerate(IImnAccountManager* This,DWORD dwSrvTypes,IImnEnumAccounts **ppEnumAccounts) {
    return This->lpVtbl->Enumerate(This,dwSrvTypes,ppEnumAccounts);
}
FORCEINLINE HRESULT IImnAccountManager_GetAccountCount(IImnAccountManager* This,ACCTTYPE AcctType,ULONG *pcServers) {
    return This->lpVtbl->GetAccountCount(This,AcctType,pcServers);
}
FORCEINLINE HRESULT IImnAccountManager_FindAccount(IImnAccountManager* This,DWORD dwPropTag,LPCSTR pszSearchData,IImnAccount **ppAccount) {
    return This->lpVtbl->FindAccount(This,dwPropTag,pszSearchData,ppAccount);
}
FORCEINLINE HRESULT IImnAccountManager_GetDefaultAccountName(IImnAccountManager* This,ACCTTYPE AcctType,LPSTR pszAccount,ULONG cchMax) {
    return This->lpVtbl->GetDefaultAccountName(This,AcctType,pszAccount,cchMax);
}
FORCEINLINE HRESULT IImnAccountManager_ProcessNotification(IImnAccountManager* This,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->ProcessNotification(This,uMsg,wParam,lParam);
}
FORCEINLINE HRESULT IImnAccountManager_ValidateDefaultSendAccount(IImnAccountManager* This) {
    return This->lpVtbl->ValidateDefaultSendAccount(This);
}
FORCEINLINE HRESULT IImnAccountManager_AccountListDialog(IImnAccountManager* This,HWND hwnd,ACCTLISTINFO *pinfo) {
    return This->lpVtbl->AccountListDialog(This,hwnd,pinfo);
}
FORCEINLINE HRESULT IImnAccountManager_Advise(IImnAccountManager* This,IImnAdviseAccount *pAdviseAccount,DWORD *pdwConnection) {
    return This->lpVtbl->Advise(This,pAdviseAccount,pdwConnection);
}
FORCEINLINE HRESULT IImnAccountManager_Unadvise(IImnAccountManager* This,DWORD dwConnection) {
    return This->lpVtbl->Unadvise(This,dwConnection);
}
FORCEINLINE HRESULT IImnAccountManager_GetUniqueAccountName(IImnAccountManager* This,LPSTR szName,UINT cch) {
    return This->lpVtbl->GetUniqueAccountName(This,szName,cch);
}
FORCEINLINE HRESULT IImnAccountManager_InitEx(IImnAccountManager* This,IImnAdviseMigrateServer *pAdviseMigrateServer,DWORD dwFlags) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IImnAccountManager2_QueryInterface(IImnAccountManager2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IImnAccountManager2_AddRef(IImnAccountManager2* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IImnAccountManager2_Release(IImnAccountManager2* This) {
    return This->lpVtbl->Release(This);
}
/*** IImnAccountManager methods ***/
FORCEINLINE HRESULT IImnAccountManager2_Init(IImnAccountManager2* This,IImnAdviseMigrateServer *pAdviseMigrateServer) {
    return This->lpVtbl->Init(This,pAdviseMigrateServer);
}
FORCEINLINE HRESULT IImnAccountManager2_CreateAccountObject(IImnAccountManager2* This,ACCTTYPE AcctType,IImnAccount **ppAccount) {
    return This->lpVtbl->CreateAccountObject(This,AcctType,ppAccount);
}
FORCEINLINE HRESULT IImnAccountManager2_Enumerate(IImnAccountManager2* This,DWORD dwSrvTypes,IImnEnumAccounts **ppEnumAccounts) {
    return This->lpVtbl->Enumerate(This,dwSrvTypes,ppEnumAccounts);
}
FORCEINLINE HRESULT IImnAccountManager2_GetAccountCount(IImnAccountManager2* This,ACCTTYPE AcctType,ULONG *pcServers) {
    return This->lpVtbl->GetAccountCount(This,AcctType,pcServers);
}
FORCEINLINE HRESULT IImnAccountManager2_FindAccount(IImnAccountManager2* This,DWORD dwPropTag,LPCSTR pszSearchData,IImnAccount **ppAccount) {
    return This->lpVtbl->FindAccount(This,dwPropTag,pszSearchData,ppAccount);
}
FORCEINLINE HRESULT IImnAccountManager2_GetDefaultAccountName(IImnAccountManager2* This,ACCTTYPE AcctType,LPSTR pszAccount,ULONG cchMax) {
    return This->lpVtbl->GetDefaultAccountName(This,AcctType,pszAccount,cchMax);
}
FORCEINLINE HRESULT IImnAccountManager2_ProcessNotification(IImnAccountManager2* This,UINT uMsg,WPARAM wParam,LPARAM lParam) {
    return This->lpVtbl->ProcessNotification(This,uMsg,wParam,lParam);
}
FORCEINLINE HRESULT IImnAccountManager2_ValidateDefaultSendAccount(IImnAccountManager2* This) {
    return This->lpVtbl->ValidateDefaultSendAccount(This);
}
FORCEINLINE HRESULT IImnAccountManager2_AccountListDialog(IImnAccountManager2* This,HWND hwnd,ACCTLISTINFO *pinfo) {
    return This->lpVtbl->AccountListDialog(This,hwnd,pinfo);
}
FORCEINLINE HRESULT IImnAccountManager2_Advise(IImnAccountManager2* This,IImnAdviseAccount *pAdviseAccount,DWORD *pdwConnection) {
    return This->lpVtbl->Advise(This,pAdviseAccount,pdwConnection);
}
FORCEINLINE HRESULT IImnAccountManager2_Unadvise(IImnAccountManager2* This,DWORD dwConnection) {
    return This->lpVtbl->Unadvise(This,dwConnection);
}
FORCEINLINE HRESULT IImnAccountManager2_GetUniqueAccountName(IImnAccountManager2* This,LPSTR szName,UINT cch) {
    return This->lpVtbl->GetUniqueAccountName(This,szName,cch);
}
FORCEINLINE HRESULT IImnAccountManager2_InitEx(IImnAccountManager2* This,IImnAdviseMigrateServer *pAdviseMigrateServer,DWORD dwFlags) {
    return This->lpVtbl->InitEx(This,pAdviseMigrateServer,dwFlags);
}
/*** IImnAccountManager2 methods ***/
FORCEINLINE HRESULT IImnAccountManager2_InitUser(IImnAccountManager2* This,IImnAdviseMigrateServer *pAdviseMigrateServer,REFGUID rguidID,DWORD dwFlags) {
    return This->lpVtbl->InitUser(This,pAdviseMigrateServer,rguidID,dwFlags);
}
FORCEINLINE HRESULT IImnAccountManager2_GetIncompleteAccount(IImnAccountManager2* This,ACCTTYPE AcctType,LPSTR pszAccountId,ULONG cchMax) {
    return This->lpVtbl->GetIncompleteAccount(This,AcctType,pszAccountId,cchMax);
}
FORCEINLINE HRESULT IImnAccountManager2_SetIncompleteAccount(IImnAccountManager2* This,ACCTTYPE AcctType,LPCSTR pszAccountId) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IPropertyContainer_QueryInterface(IPropertyContainer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IPropertyContainer_AddRef(IPropertyContainer* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IPropertyContainer_Release(IPropertyContainer* This) {
    return This->lpVtbl->Release(This);
}
/*** IPropertyContainer methods ***/
FORCEINLINE HRESULT IPropertyContainer_GetProp(IPropertyContainer* This,DWORD dwPropTag,BYTE *pb,ULONG *pcb) {
    return This->lpVtbl->GetProp(This,dwPropTag,pb,pcb);
}
FORCEINLINE HRESULT IPropertyContainer_GetPropDw(IPropertyContainer* This,DWORD dwPropTag,DWORD *pdw) {
    return This->lpVtbl->GetPropDw(This,dwPropTag,pdw);
}
FORCEINLINE HRESULT IPropertyContainer_GetPropSz(IPropertyContainer* This,DWORD dwPropTag,LPSTR psz,ULONG cchMax) {
    return This->lpVtbl->GetPropSz(This,dwPropTag,psz,cchMax);
}
FORCEINLINE HRESULT IPropertyContainer_SetProp(IPropertyContainer* This,DWORD dwPropTag,BYTE *pb,ULONG cb) {
    return This->lpVtbl->SetProp(This,dwPropTag,pb,cb);
}
FORCEINLINE HRESULT IPropertyContainer_SetPropDw(IPropertyContainer* This,DWORD dwPropTag,DWORD dw) {
    return This->lpVtbl->SetPropDw(This,dwPropTag,dw);
}
FORCEINLINE HRESULT IPropertyContainer_SetPropSz(IPropertyContainer* This,DWORD dwPropTag,LPSTR psz) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IImnAccount_QueryInterface(IImnAccount* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IImnAccount_AddRef(IImnAccount* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IImnAccount_Release(IImnAccount* This) {
    return This->lpVtbl->Release(This);
}
/*** IPropertyContainer methods ***/
FORCEINLINE HRESULT IImnAccount_GetProp(IImnAccount* This,DWORD dwPropTag,BYTE *pb,ULONG *pcb) {
    return This->lpVtbl->GetProp(This,dwPropTag,pb,pcb);
}
FORCEINLINE HRESULT IImnAccount_GetPropDw(IImnAccount* This,DWORD dwPropTag,DWORD *pdw) {
    return This->lpVtbl->GetPropDw(This,dwPropTag,pdw);
}
FORCEINLINE HRESULT IImnAccount_GetPropSz(IImnAccount* This,DWORD dwPropTag,LPSTR psz,ULONG cchMax) {
    return This->lpVtbl->GetPropSz(This,dwPropTag,psz,cchMax);
}
FORCEINLINE HRESULT IImnAccount_SetProp(IImnAccount* This,DWORD dwPropTag,BYTE *pb,ULONG cb) {
    return This->lpVtbl->SetProp(This,dwPropTag,pb,cb);
}
FORCEINLINE HRESULT IImnAccount_SetPropDw(IImnAccount* This,DWORD dwPropTag,DWORD dw) {
    return This->lpVtbl->SetPropDw(This,dwPropTag,dw);
}
FORCEINLINE HRESULT IImnAccount_SetPropSz(IImnAccount* This,DWORD dwPropTag,LPSTR psz) {
    return This->lpVtbl->SetPropSz(This,dwPropTag,psz);
}
/*** IImnAccount methods ***/
FORCEINLINE HRESULT IImnAccount_Exist(IImnAccount* This) {
    return This->lpVtbl->Exist(This);
}
FORCEINLINE HRESULT IImnAccount_SetAsDefault(IImnAccount* This) {
    return This->lpVtbl->SetAsDefault(This);
}
FORCEINLINE HRESULT IImnAccount_Delete(IImnAccount* This) {
    return This->lpVtbl->Delete(This);
}
FORCEINLINE HRESULT IImnAccount_SaveChanges(IImnAccount* This) {
    return This->lpVtbl->SaveChanges(This);
}
FORCEINLINE HRESULT IImnAccount_GetAccountType(IImnAccount* This,ACCTTYPE *pAcctType) {
    return This->lpVtbl->GetAccountType(This,pAcctType);
}
FORCEINLINE HRESULT IImnAccount_GetServerTypes(IImnAccount* This,DWORD *pdwSrvTypes) {
    return This->lpVtbl->GetServerTypes(This,pdwSrvTypes);
}
FORCEINLINE HRESULT IImnAccount_ShowProperties(IImnAccount* This,HWND hwnd,DWORD dwFlags) {
    return This->lpVtbl->ShowProperties(This,hwnd,dwFlags);
}
FORCEINLINE HRESULT IImnAccount_ValidateProperty(IImnAccount* This,DWORD dwPropTag,BYTE *pb,ULONG cb) {
    return This->lpVtbl->ValidateProperty(This,dwPropTag,pb,cb);
}
FORCEINLINE HRESULT IImnAccount_DoWizard(IImnAccount* This,HWND hwnd,DWORD dwFlags) {
    return This->lpVtbl->DoWizard(This,hwnd,dwFlags);
}
FORCEINLINE HRESULT IImnAccount_DoImportWizard(IImnAccount* This,HWND hwnd,CLSID clsid,DWORD dwFlags) {
