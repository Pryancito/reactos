/*** Autogenerated by WIDL <undefined version> from asptlb.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IRequestDictionary_QueryInterface(IRequestDictionary* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IRequestDictionary_AddRef(IRequestDictionary* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IRequestDictionary_Release(IRequestDictionary* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT IRequestDictionary_GetTypeInfoCount(IRequestDictionary* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT IRequestDictionary_GetTypeInfo(IRequestDictionary* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT IRequestDictionary_GetIDsOfNames(IRequestDictionary* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT IRequestDictionary_Invoke(IRequestDictionary* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IRequestDictionary methods ***/
FORCEINLINE HRESULT IRequestDictionary_get_Item(IRequestDictionary* This,VARIANT Var,VARIANT *pVariantReturn) {
    return This->lpVtbl->get_Item(This,Var,pVariantReturn);
}
FORCEINLINE HRESULT IRequestDictionary_get__NewEnum(IRequestDictionary* This,IUnknown **ppEnumReturn) {
    return This->lpVtbl->get__NewEnum(This,ppEnumReturn);
}
FORCEINLINE HRESULT IRequestDictionary_get_Count(IRequestDictionary* This,int *count) {
    return This->lpVtbl->get_Count(This,count);
}
FORCEINLINE HRESULT IRequestDictionary_get_Key(IRequestDictionary* This,VARIANT key,VARIANT *value) {
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IResponse_QueryInterface(IResponse* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IResponse_AddRef(IResponse* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IResponse_Release(IResponse* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
FORCEINLINE HRESULT IResponse_GetTypeInfoCount(IResponse* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
FORCEINLINE HRESULT IResponse_GetTypeInfo(IResponse* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
FORCEINLINE HRESULT IResponse_GetIDsOfNames(IResponse* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
FORCEINLINE HRESULT IResponse_Invoke(IResponse* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IResponse methods ***/
FORCEINLINE HRESULT IResponse_get_Buffer(IResponse* This,VARIANT_BOOL *is_buffering) {
    return This->lpVtbl->get_Buffer(This,is_buffering);
}
FORCEINLINE HRESULT IResponse_put_Buffer(IResponse* This,VARIANT_BOOL is_buffering) {
    return This->lpVtbl->put_Buffer(This,is_buffering);
}
FORCEINLINE HRESULT IResponse_get_ContentType(IResponse* This,BSTR *content_type) {
    return This->lpVtbl->get_ContentType(This,content_type);
}
FORCEINLINE HRESULT IResponse_put_ContentType(IResponse* This,BSTR content_type) {
    return This->lpVtbl->put_ContentType(This,content_type);
}
FORCEINLINE HRESULT IResponse_get_Expires(IResponse* This,VARIANT *minutes) {
    return This->lpVtbl->get_Expires(This,minutes);
}
FORCEINLINE HRESULT IResponse_put_Expires(IResponse* This,LONG minutes) {
    return This->lpVtbl->put_Expires(This,minutes);
}
FORCEINLINE HRESULT IResponse_get_ExpiresAbsolute(IResponse* This,VARIANT *expires) {
    return This->lpVtbl->get_ExpiresAbsolute(This,expires);
}
FORCEINLINE HRESULT IResponse_put_ExpiresAbsolute(IResponse* This,DATE expires) {
    return This->lpVtbl->put_ExpiresAbsolute(This,expires);
}
FORCEINLINE HRESULT IResponse_get_Cookies(IResponse* This,IRequestDictionary **cookies) {
    return This->lpVtbl->get_Cookies(This,cookies);
}
FORCEINLINE HRESULT IResponse_get_Status(IResponse* This,BSTR *status) {
    return This->lpVtbl->get_Status(This,status);
}
FORCEINLINE HRESULT IResponse_put_Status(IResponse* This,BSTR status) {
    return This->lpVtbl->put_Status(This,status);
}
FORCEINLINE HRESULT IResponse_Add(IResponse* This,BSTR value,BSTR name) {
    return This->lpVtbl->Add(This,value,name);
}
FORCEINLINE HRESULT IResponse_AddHeader(IResponse* This,BSTR name,BSTR value) {
    return This->lpVtbl->AddHeader(This,name,value);
}
FORCEINLINE HRESULT IResponse_AppendToLog(IResponse* This,BSTR log_entry) {
    return This->lpVtbl->AppendToLog(This,log_entry);
}
FORCEINLINE HRESULT IResponse_BinaryWrite(IResponse* This,VARIANT input) {
    return This->lpVtbl->BinaryWrite(This,input);
}
FORCEINLINE HRESULT IResponse_Clear(IResponse* This) {
    return This->lpVtbl->Clear(This);
}
FORCEINLINE HRESULT IResponse_End(IResponse* This) {
    return This->lpVtbl->End(This);
}
FORCEINLINE HRESULT IResponse_Flush(IResponse* This) {
    return This->lpVtbl->Flush(This);
}
FORCEINLINE HRESULT IResponse_Redirect(IResponse* This,BSTR url) {
    return This->lpVtbl->Redirect(This,url);
}
FORCEINLINE HRESULT IResponse_Write(IResponse* This,VARIANT text) {
    return This->lpVtbl->Write(This,text);
}
FORCEINLINE HRESULT IResponse_WriteBlock(IResponse* This,short block_number) {
    return This->lpVtbl->WriteBlock(This,block_number);
}
FORCEINLINE HRESULT IResponse_IsClientConnected(IResponse* This,VARIANT_BOOL *is_connected) {
    return This->lpVtbl->IsClientConnected(This,is_connected);
}
FORCEINLINE HRESULT IResponse_get_CharSet(IResponse* This,BSTR *charset) {
    return This->lpVtbl->get_CharSet(This,charset);
}
FORCEINLINE HRESULT IResponse_put_CharSet(IResponse* This,BSTR charset) {
    return This->lpVtbl->put_CharSet(This,charset);
}
FORCEINLINE HRESULT IResponse_Pics(IResponse* This,BSTR value) {
    return This->lpVtbl->Pics(This,value);
}
FORCEINLINE HRESULT IResponse_get_CacheControl(IResponse* This,BSTR *cache_control) {
    return This->lpVtbl->get_CacheControl(This,cache_control);
}
FORCEINLINE HRESULT IResponse_put_CacheControl(IResponse* This,BSTR cache_control) {
    return This->lpVtbl->put_CacheControl(This,cache_control);
}
FORCEINLINE HRESULT IResponse_get_CodePage(IResponse* This,LONG *codepage) {
    return This->lpVtbl->get_CodePage(This,codepage);
}
FORCEINLINE HRESULT IResponse_put_CodePage(IResponse* This,LONG codepage) {
    return This->lpVtbl->put_CodePage(This,codepage);
}
FORCEINLINE HRESULT IResponse_get_LCID(IResponse* This,LONG *lcid) {
    return This->lpVtbl->get_LCID(This,lcid);
}
FORCEINLINE HRESULT IResponse_put_LCID(IResponse* This,LONG lcid) {
