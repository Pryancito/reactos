/*** Autogenerated by WIDL <undefined version> from ctxtcall.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
FORCEINLINE HRESULT IContextCallback_QueryInterface(IContextCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
FORCEINLINE ULONG IContextCallback_AddRef(IContextCallback* This) {
    return This->lpVtbl->AddRef(This);
}
FORCEINLINE ULONG IContextCallback_Release(IContextCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** IContextCallback methods ***/
FORCEINLINE HRESULT IContextCallback_ContextCallback(IContextCallback* This,HRESULT (__stdcall * pCallback)(ComCallData *pParam),ComCallData *pParam,REFIID riid,int iMethod,IUnknown *pUnk) {
